...
//   var categoryMenuBtn = document.querySelector(".category-menu-toggle-btn");
//   var megaMenuWrap = document.querySelector(".megamenu-wrap");

//   // Show megamenu on hover (mouseenter and mouseleave)
    ...
    $.get({
      ...
      success: function (data) {
        ...
        $(".search-result-product").on("mouseover", function () {
          ...
          $(".header-type-set").val($(this).data("type"));
        });
      },
      complete: function () {
        $("#loading").hide();
