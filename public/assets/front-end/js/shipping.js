...
function shipping_method_select(get_value){
    ...
    $('#latitude').val(shipping_value.latitude);
    $('#longitude').val(shipping_value.longitude);
...
function billing_method_select(get_billing_value){
    ...
    $('#billing_state').val(billing_value.state);
    $('#billing_latitude').val(billing_value.latitude);
    $('#billing_longitude').val(billing_value.longitude);
