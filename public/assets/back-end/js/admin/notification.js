...
$(".select-user-type").on("change", function () {
  ...
  if (type === "customer") {
    ...
    $(".puja_view").addClass("d-none");
    $(".counselling_view").addClass("d-none");
    $(".offlinepuja_view").addClass("d-none");
  } else if (type === "seller") {
    ...
    $(".customer_view").addClass("d-none");
    $(".puja_view").addClass("d-none");
    $(".counselling_view").removeClass("d-none");
    $(".offlinepuja_view").addClass("d-none");
  } else if (type === "offlinepuja") {
    $(".seller_view").addClass("d-none");
    $(".delivery_man_view").addClass("d-none");
    $(".customer_view").addClass("d-none");
    $(".puja_view").addClass("d-none");
    $(".counselling_view").addClass("d-none");
    $(".offlinepuja_view").removeClass("d-none");
  }
});
