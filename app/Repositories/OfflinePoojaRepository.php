...
class OfflinePoojaRepository implements OfflinePoojaRepositoryInterface
{
    public function __construct(
        private readonly PoojaOffline      $pooja,
    ...
    {
        $query = $this->pooja->with($relations)->when($searchValue, function ($query) use($searchValue){
