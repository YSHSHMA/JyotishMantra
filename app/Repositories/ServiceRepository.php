...
class ServiceRepository implements ServiceRepositoryInterface
{
    ...
    public function addServiceTags(object $request, object $service): void
    {
        $tagIds = [];
    ...
    {
        return $this->service->withoutGlobalScope('translate')->with($relations)->where($params)->first();
    }
    public function getFirstWhereActive(array $params, array $relations = []): ?Model
    {
        return $this->service->active()->where($params)->with($relations)->first();
    }

    public function getFirstWhereWithoutGlobalScope(array $params, array $relations = []): ?Model
    {
        return $this->service->withoutGlobalScopes()->where($params)->with($relations)->first();
    }

    public function getList(array $orderBy = [], array $relations = [], int|string $dataLimit = DEFAULT_DATA_LIMIT, int $offset = null): Collection|LengthAwarePaginator
    {
        $query = $this->service->with($relations)
    ...
    {
        $query = $this->service->with('categories')->with('pandit')
    ...
    {
        $this->service->where($params)->delete();
        return true;
    }
