...
class OfflinePoojaCategoryService
{
    ...
    public function getAddOfflinePoojaCategoryData(object $request, string $addedBy): array
    {   
        return [
            'name' => $request['name'][array_search('en', $request['lang'])],
            'image' => $this->upload('offlinepooja/category/', 'webp', $request->file('image')),
        ];
    }
    // Update Service GET
    public function getUpdateServiceData(object $request, object $offlinePooja, string $updateBy): array
    {
        $image = $request->file('image') ? $this->update('offlinepooja/category/', $offlinePooja['image'], 'webp', $request->file('image')) : $offlinePooja['image'];
        $dataArray = [
            'name' => $request['name'][array_search('en', $request['lang'])],
            'image' => $image,
        ];
