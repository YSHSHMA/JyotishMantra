...
interface RepositoryInterface
{
     ...
     * @param array $catdata Data value must be in key and value pair structure, ex: params = ['name'=>'John Doe']
     * @return string|object
     */
    public function add(array $data): string|object;

    // public function addAstrologerCategoryData(array $catdata): string|object;
