...
class TransactionReportController extends Controller
{
    public function order_transaction_list(Request $request)
    {
        ...
        $transactions = $transactions->latest('updated_at')->paginate(10)->appends($query_param);
        ...
        return view('vendor-views.transaction.order-list', compact(
            'customers',
            'transactions',
            'product_data',
            'search',
    ...
    public function expense_transaction_list(Request $request)
    {
        ...
        return view('vendor-views.transaction.expense-list', compact(
