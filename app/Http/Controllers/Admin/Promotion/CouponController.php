...
class CouponController extends BaseController
{
    ...
    {
        $coupons = $this->couponRepo->getListWhere(searchValue: $request['searchValue'], orderBy: ['id' => "desc"], filters: ['added_by' => 'admin'], dataLimit: getWebConfig(name: 'pagination_limit'));
    ...
    public function update(CouponUpdateRequest $request, string|int $id, CouponService $couponService): RedirectResponse
    {
        ...
        Helpers::editDeleteLogs('Offers & Deals', 'Coupon', 'Update');
        return redirect()->route(Coupon::ADD[ROUTE]);
    }
    ...
    public function delete(string|int $id): RedirectResponse
    {
        ...
        Helpers::editDeleteLogs('Offers & Deals', 'Coupon', 'Delete');
        return redirect()->back();
    }
