...
class BusinessSettingsController extends BaseController
{
    ...
    public function getView(): View
    {
        ...
        $businessSetting = [
            ...
            'company_gst' => $this->getSettings(object: $web, type: 'company_gst')->value ?? '',
            'company_pan' => $this->getSettings(object: $web, type: 'company_pan')->value ?? '',
        ];
    ...
    public function updateSettings(BusinessSettingRequest $request, BusinessSettingService $businessSettingService): RedirectResponse
    {
        ...
        $this->businessSettingRepo->updateOrInsert(type: 'company_gst', value: $request['company_gst']);
        $this->businessSettingRepo->updateOrInsert(type: 'company_pan', value: $request['company_pan']);
