...
class EventOrganizeAddRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ifsc_code' =>'required',
            'account_no' =>'required',
            'pan_card_image' =>'required|file|mimes:jpg,jpeg,png,webp,pdf',
            'cancelled_cheque_image' =>'required|file|mimes:jpg,jpeg,png,webp,pdf',
            ];
    }
