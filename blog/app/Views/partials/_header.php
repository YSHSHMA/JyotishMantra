...
<link href="<?= base_url('assets/css/style-4.4.min.css'); ?>" rel="stylesheet"/>
<?php if ($darkMode == 1) : ?>
<link href="<?= base_url('assets/css/dark-4.4.min.css'); ?>" rel="stylesheet"/>
<?php endif;
if ($activeLang->text_direction == "rtl"): ?>
<script>var rtl = true;</script>
<link href="<?= base_url('assets/css/rtl-4.4.min.css'); ?>" rel="stylesheet"/>
<?php else: ?>
...
<body>
<header id="header">
<nav class="navbar navbar-inverse" style="background: #fe9802;">
...
<button type="submit" id="btn_modal_newsletter" class="btn btn-custom" aria-label="subscribe"><?= trans("subscribe"); ?></button>
</div>
</div>
<input type="text" name="url">
<div id="modal_newsletter_response" class="text-center modal-newsletter-response">
<div class="form-group text-center m-b-0 text-close">
<button type="button" class="text-close" data-dismiss="modal" aria-label="no thanks"><?= trans("no_thanks"); ?></button>
</div>
</div>
</form>
</div>
