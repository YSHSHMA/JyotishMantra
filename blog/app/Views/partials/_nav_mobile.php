...
<a href="https://mahakal.com/" aria-label="logo"><img src="<?= getMobileLogo($generalSettings); ?>" alt="logo" width="<?= $generalSettings->logo_mobile_width; ?>" height="<?= $generalSettings->logo_mobile_height; ?>"></a>
</div>
...
<a href="https://mahakal.com/" aria-label="logo"><img src="<?= getLogo($generalSettings); ?>" alt="logo" width="<?= $generalSettings->logo_desktop_width; ?>" height="<?= $generalSettings->logo_desktop_height; ?>"></a>
</div>
...
<div class="col-sm-12">
<ul class="navbar-nav">
<li class="nav-item"><a href="https://mahakal.com/" class="nav-link"><?= trans("home"); ?></a></li>
