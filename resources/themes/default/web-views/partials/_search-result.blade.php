<ul class="list-group list-group-flush">
    @foreach($products as $product)
        <li class="list-group-item px-0 overflow-hidden">
            <button type="submit" class="search-result-product btn p-0 m-0 search-result-product-button align-items-baseline text-start" data-product-name="{{ $product['name']??'' }}" data-type="{{ $product['type']??'' }}">
