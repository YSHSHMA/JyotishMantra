...
@php
    $activeRoutes = [
        ...
        'account-order-tour*',
        'account-order-darshan*',
        'account-vehicle-booking-order*',
    ];
            ...
            <div class="widget-title">
                ...
                <div class="collapse" id="submenu1" aria-expanded="false">
                    <ul class="flex-column pl-2 nav">
                        ...
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-darshan') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span class="aside-link">
                                    {{ translate('VIP_darshan_order') }}
                                    ({{ \App\Models\DarshanOrder::where(['user_id' => auth('customer')->id()])->where('status', 1)->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-vehicle-booking-order') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('vehicle_booking') }}
                                    ({{ \App\Models\SelfVehicleOrder::where('status', 1)->where(['user_id' => auth('customer')->id()])->count() }})</span></a>
                        </li>
