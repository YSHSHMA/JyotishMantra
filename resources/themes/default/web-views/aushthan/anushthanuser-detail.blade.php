...
@section('content')
    ...
    <div class="container mt-3  px-0 px-md-3 text-align-direction">
        <h2 class="mt-4 mb-3 text-center text-lg-left mobile-fs-20 fs-18 font-bold">
            <span class="text font-bold px-3">{{ translate('Enter_details_for_your_pooja') }}</span>
        </h2>
        <div class="row">
            <div class="col-md-5">
                    ...
                    <div class="d-flex">
                        <div class="d-flex align-items-center justify-content-center p-3">
                            <div class="flash-deals-background-image image-default-bg-color">
                                ...
                                class="__img-125px" alt="Anushthan">
                                </div>
                        </div>
            ...
            <div class="col-md-7">
                <div class="login-card">
                    <div class="mx-auto __max-w-760">
                        ...
                        <form class="needs-validation" id="anushthanpooja_check"
                            action="{{ route('anushthan.user.store') }}" method="post">
                            @csrf
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control text-align-direction" type="text" name="members[]"
                                            value="" placeholder="{{ translate('Family_Member') }}" required
                            ...
                            <div class="col-sm-12">
                                <div class="rtl">
                                    <label class="custom-control custom-checkbox m-0 d-flex">
                                        ...
                                        <span class="custom-control-label">{{ translate('I_do_not_know_my_gotra') }}</span>
                                    </label>
                                </div>
                            </div>
                            <hr class="my-2">
                            ...
                            <div class="row hideable-div mt-3">
                                <input type="hidden" name="booking_date" value="{{ $orderDetails->booking_date }}"
                                    id="booking-date">
                                <input type="hidden" name="type" value="anushthan" id="type">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control text-align-direction" type="text" name="landmark"
                                            placeholder="{{ translate('landmark(Compulsory)') }}" id="landmark"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <input class="form-control text-align-direction areaValidation" type="text"
                                        name="area" id="google-search" value="" placeholder="Your Address"
                                        autocomplete="off">
    ...
    <div class="button-sticky bg-white d-sm-none">
        <div class="d-flex flex-column gap-1 p-2">
            <div class="d-flex gap-3 justify-content-center" role="button">
                <button class="w-100 btn btn--primary" id="" type="submit"
                    onclick="snakalpSubmit(this)">{{ translate('Proceed_to_book') }}
                </button>
            </div>
        </div>
    </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            $('#anushthanpooja_check').submit(function(event) {
                if ($('#is_prashad').val() == '1') {
                    let isValid = true;
    ...
    <script>
        function snakalpSubmit(button) {
            var form = $('#anushthanpooja_check')[0];
            if (form.checkValidity()) {
                $('#anushthanpooja_check').submit();
            } else {
