                                ...
                                @foreach ($payment_gateways_list as $payment_gateway)
                                    <form method="post" class="digital_payment" id="{{ $payment_gateway->key_name }}_form"
                                        ...
                                        <div class="Details">
                                            ...
                                            <input type="hidden" name="external_redirect_link" value="{{ url('/') . '/chadhava-web-payment' }}">
                                            ...
                                            @php
                                                $paymentAmount = $customer->wallet_balance < $finalAmount
                                                    ? $finalAmount - $customer->wallet_balance
                                                    : 0.0;
                                            @endphp
