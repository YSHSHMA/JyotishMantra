                            ...
                            <div class="details __h-100">
                                ...
                                <div class="flex flex-col">
                                    <div class="flex items-center space-x-1 pt-2">
                                        <span class="text-16">
                                            <i class="fa fa-map-marker" style="color:#fe9802;"></i>
                                            {{ $epooja->pooja_venue }}
                                        </span>
                                    </div>
                                    <div class="flex items-center space-x-1 pt-2">
                                        @if ($epooja->pooja_type == '0')
                                            <span class="text-16 mb-2"> <i class="fa fa-calendar" aria-hidden="true"  style="color: var(--primary-clr);"></i>
                                            </span> {{date('d', strtotime($nextDate)) }},
                                            {{ translate(date('F', strtotime($nextDate))) }} ,
                                            {{ translate(date('l', strtotime($nextDate))) }}
                                         
                                        @else
                                            <span class="text-16 mb-2"> <i class="fa fa-calendar" aria-hidden="true"
                                                    style="color: var(--primary-clr);"></i></span>
                                            <?php if ($earliestDate !== null): ?> {{ date('d', strtotime($earliestDate)) }},
                                            {{ translate(date('F', strtotime($earliestDate))) }}
                                            <?php else: ?> <?php endif; ?>
                                            {{ translate(date('l', strtotime($earliestDate))) }},{{ date('h:i:s A', strtotime($earliestTime)) }}
                                ...
                                <!-- Timere Section -->
                                <div class="flex flex-col">
                                    <div class="mt-2"><strong> {{ translate('Pooja_Booking_will_be_closed') }}:
                                            @if ($epooja->pooja_type == '0')
                                ...
                                <div id="" role="button">
                                    <a href="#packages" id="pujaPackageButton"
                                        ...
                                        <span class="font-bold">{{ translate('Select_pooja_package') }}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <form class="needs-validation_" id="QueryForm"
                                        ...
                                        @if ($epooja->pooja_type == '0')
                                            <input type="hidden" name="booking_date" id="poojaBook"
                                                value="{{ date('Y-m-d', strtotime($nextDate)) }}"
                                                placeholder="Pooja Weekly">
                                        @else
                                            <input type="hidden" name="booking_date" id="poojaBook"
                                                value="{{ date('Y-m-d', strtotime($earliestDate)) }}"
                                                placeholder="Events">
                                        @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" id="otp-input-div" style="display: none;">
                                                <div class="form-group text-center">
                                                    <div id="masked-number">{{ translate('An_OTP_has_been_sent_to')}} ********<span
                                                            id="number"></span></div>
                                                    {{--                                                
                                        ...
                                        <div class="text-center mt-3" id="resend-div" style="display: none;">
                                            <p id="resend-otp-timer-text" style="display: none">{{ translate('Resend_OTP_in') }} <span
                                                    id="resend-otp-timer"></span></p>
                                            <p id="resend-otp-btn-text" style="display: none">{{ translate('Did_not_get_the_code?') }}
                                                <a href="javascript:0" id="resend-otp-btn" style="color: blue;">{{ translate('Resend_OTP')}}</a>
                                            </p>
                                            <br>
