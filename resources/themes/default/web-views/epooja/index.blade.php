...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/front-end/css/poojafilter/poojadetails.css?v=1') }}">
...
{{-- 
    ...
    <input type="hidden" id="fullTime" value="{{ date('H:i:s', strtotime($epooja->pooja_time)) }}">
...
@push('script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var timeGet = $('#fullTime').val() || "00:00:00";
    ...
    <script>
        $(document).ready(function() {
            ...
            let firstCard = $('.package-card').first();
            if (firstCard.length) {
