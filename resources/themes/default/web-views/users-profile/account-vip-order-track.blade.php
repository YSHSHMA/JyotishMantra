            ...
            <section class="col-lg-9">
                ...
                <div class="card border-0">
                    <div class="card-body" style="text-align: center;">
                        <div>
                            <h4 style="font-size: 14px;">Pooja Tracking Status</h4>
                            <p style="font-size: 12px; color: #555;">Track the status of your VIP pooja seamlessly and stay
                                        ...
                                        <li class="nav-item">
                                            <div
                                                ...
                                                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="text-sm-center">
                                                            <h6 class="media-tab-title text-nowrap mb-0 fs-14">Pooja Video
                                                                Complete</h6>
                                                            <img src="{{ asset('/public/assets/front-end/img/track-order/clock.png') }}"
                                                                width="14" alt="">
                                                            <span
                ...
                <div class="card border-0">
                    @if (!empty($prashad) && isset($prashad['pooja_status']) && $prashad['pooja_status'] == 1)
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 style="font-size: 14px;">Prashad Tracking Status</h4>
                                    <p style="font-size: 12px; color: #666;">Track the status of your VIP Prashad order and
                                        stay updated with real-time information.</p>
                                </div>
                                <div class="col-md-6">
                    ...
                    @else
                        <div class="card-body" style="text-align: center;">
                            <div>
                                ...
                                <p style="font-size: 12px; color: #555;">Track the status of your VIP pooja seamlessly and
