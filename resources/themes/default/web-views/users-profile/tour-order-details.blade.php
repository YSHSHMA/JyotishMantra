                            ...
                            <div class="bg-white border-lg rounded mobile-full">
                                <div class="p-lg-3 p-0">
                                    <div class="card border-sm">
                                        <div class="p-lg-3">
                                            <div>
                                                <a href="{{ route('tour.tour-pdf-invoice', [$tourOrders['id']]) }}"
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <div class="fs-12">
                                                                        ...
                                                                        <?php if ($tourOrders['amount_status'] == 1) { ?>
                                                                            <span
                                                                                class="text-success text-capitalize">{{ translate('paid') }}{{ $tourOrders['part_payment'] == 'part' ? ' / partially' : '' }}{{ $tourOrders['part_payment'] == 'custom' ? ' / Custom Pay' : '' }}</span>
                                                                        <?php } else { ?>
                                                                            <span
                                                                                class="text-success text-capitalize">{{ translate('unpaid') }}
                                                                                {{ $tourOrders['part_payment'] == 'part' ? ' / partially' : '' }} {{ $tourOrders['part_payment'] == 'custom' ? ' / Custom Pay' : '' }}</span>
                                                                        <?php }
                                                                        if ($tourOrders['part_payment'] == 'part') { ?>
                                                                            <a class="btn btn-sm btn--primary" onclick="pay_now_order()">pay now</a>
                                                                        <?php } elseif ($tourOrders['part_payment'] == 'custom') { ?>
                                                                            <a class="btn btn-sm btn--primary" onclick="pay_now_order()">pay now</a>
                                                                        <?php } ?>
                                                                    </div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="">
                                                                                    ...
                                                                                    <?php } elseif ($val['type'] == 'cab' || $val['type'] == 'per_head' || ($val['type'] == 'transport')) { ?>
                                                                                        <span class="fs-15 font-semibold">
                                                        ...
                                                        <tbody class="totals">
                                                            ...
                                                            <tr class="border-top">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="text-end">
                                                                        <span
                                                                            class="fs-15 font-semibold">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: (float) $tourOrders['gst_amount']??0), currencyCode: getCurrencyCode()) }}</span>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            @endif
                                                            ...
                                                            <tr class="border-top">
                                                                <td>
                                                                    <div class="text-start">
                                                                        <span
                                                                            class="product-qty">{{ translate('Total_amount') }}</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <div class="text-end">
                                                                        <span
                                                                            class="fs-15 font-semibold">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: (float) $tourOrders['order_amount'] ?? 0), currencyCode: getCurrencyCode()) }}</span>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr class="border-top">
            ...
            <div class="modal-body px-5">
                <form action="{{ route('tour.add_remaining_amount', [$tourOrders['id']]) }}" method="post">
                    ...
                    <div class="">
                        ...
                        @if($tourOrders['part_payment'] == 'custom')
                        <input type="hidden" value="{{ (($tourOrders['order_amount']??0) - ($tourOrders['amount']??0)) }}" name="payment_amount" required placeholder="{{ translate('ex') }}: {{ webCurrencyConverter(amount: (($tourOrders['order_amount']??0) - ($tourOrders['amount']??0))) }}">
                        @else 
