                                    ...
                                    <div class="media gap-3 align-items-center">
                                       ...
                                       <div class="media-body">
                                          ...
                                          <div class="d-flex flex-wrap gap-2 mt-2">
                                             ...
                                             @if($detail->product->product_refund == '0')
                                             {{-- Show review button regardless of refund status --}}
                                             <button type="button"
                                             ...
                                             {{-- Show refund-related buttons only when product_refund is 0 --}}
                                             ...
                                             @endif
                                             @else
                                             {{-- When product_refund is 1, only show review button --}}
                                             <button type="button"
                                                class="btn btn-sm rounded btn-warning"
                                                data-toggle="modal"
                                                data-target="#submitReviewModal{{$detail->id}}">
                  ...
                  <div class="bg-white border rounded p-3">
                     ...
                     <div class="d-flex justify-content-end flex-wrap gap-2 mt-2">
                        ...
                        <?php
                           ...
                           $current = \Carbon\Carbon::now();
                           $length = $order_details_date->diffInDays($current);
                           logger('Refund value: ' . $detail->product->product_refund);
                           // dd($detail->product->product_refund);
                           ?>
                        @if($order->order_type == 'default_type')
                        @if($order->order_status=='delivered')
                        @if (isset($detail->product))
