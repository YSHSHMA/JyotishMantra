                    ...
                    <ul class="nav nav-tabs nav--tabs d-flex justify-content-start mt-3 border-top border-bottom py-2"
                        ...
                        <li class="nav-item">
                            <a class="nav-link __inline-27" href="#Event_order" data-toggle="tab" role="tab">
                                ...
                                ({{ \App\Models\EventOrder::where(['user_id' => auth('customer')->id()])->whereIn('transaction_status', ['1', '2', '3'])->count() }})
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link __inline-27" href="#tour_order" data-toggle="tab" role="tab">
                                ...
                                ({{ \App\Models\TourOrder::where(['user_id' => auth('customer')->id()])->whereIn('amount_status', [1, 2, 3])->count() }})
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link __inline-27" href="#paid_kundli_order" data-toggle="tab" role="tab">
                                ...
                                ({{ \App\Models\BirthJournalKundali::withWhereHas('birthJournal', function ($query) {
                                    ...
                                    })->where('user_id', auth('customer')->id())->where('payment_status', 1)->count() }})
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link __inline-27" href="#paid_kundlimilan_order" data-toggle="tab"
                                role="tab">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media-order">
                                                    ...
                                                    <a href="{{ route('account-service-order-details', ['order_id' => $use_oo->order_id]) }}"
                                                        class="d-block position-relative">
                                                        <img alt="{{ translate('shop') }}"
                                                            src="{{ getValidImage(path: 'storage/app/public/pooja/thumbnail/' . $use_oo['services']['thumbnail'], type: 'pooja') }}">
                                                    </a>
                                                    @elseif($use_oo['type'] == 'counselling')
                                                    <a href="{{ route('account-counselling-order-details', ['order_id' => $use_oo->order_id]) }}"
                                                        class="d-block position-relative">
                                                        <img alt="{{ translate('shop') }}"
                                                            src="{{ getValidImage(path: 'storage/app/public/pooja/thumbnail/' . $use_oo['services']['thumbnail'], type: 'pooja') }}">
                                                    </a>
                                                    @elseif($use_oo['type'] == 'offlinepooja')
                                                    <a href="{{ route('account-offlinepooja-order-details', ['order_id' => $use_oo->order_id]) }}"
                                                        class="d-block position-relative">
                                                        <img alt="{{ translate('shop') }}"
                                                            src="{{ getValidImage(path: 'storage/app/public/offlinepooja/thumbnail/' . $use_oo['offlinepooja']['thumbnail'], type: 'pooja') }}">
                                                    </a>
                                                    @elseif($use_oo['type'] == 'vip')
                                                    <a href="{{ route('account-vip-order-details', ['order_id' => $use_oo->order_id]) }}"
                                                        class="d-block position-relative">
                                                        <img alt="{{ translate('shop') }}"
                                                            src="{{ getValidImage(path: 'storage/app/public/pooja/vip/thumbnail/' . $use_oo['vippoojas']['thumbnail'], type: 'vip') }}">
                                                    </a>
                                                    @elseif($use_oo['type'] == 'anushthan')
                                                    <a href="{{ route('account-anushthan-order-details', ['order_id' => $use_oo->order_id]) }}"
                                                        class="d-block position-relative">
                                                        <img alt="{{ translate('shop') }}"
                                                            src="{{ getValidImage(path: 'storage/app/public/pooja/vip/thumbnail/' . $use_oo['vippoojas']['thumbnail'], type: 'anushthan') }}">
                                                    </a>
                                                    @elseif ($use_oo['type'] == 'chadhava')
                                                    <a href="{{ route('account-chadhava-order-details', ['order_id' => $use_oo->order_id]) }}"
                                                        class="d-block position-relative">
                                                        <img alt="{{ translate('shop') }}"
                                                            src="{{ getValidImage(path: 'storage/app/public/chadhava/thumbnail/' . $use_oo['chadhava']['thumbnail'], type: 'chadhava') }}">
                                                    </a>
                                                    ...
                                                    <a href="{{ route('account-order-details', ['id' => $use_oo->id]) }}"
                                                        ...
                                                        <img alt="{{ translate('shop') }}"
                                                            src="{{ getValidImage(path: 'storage/app/public/shop/' . (isset($use_oo['order']->seller->shop) ? $use_oo['order']->seller->shop->image : 'shop'), type: 'shop') }}">
                                                    ...
                                                    <img src="{{ getValidImage(path: 'storage/app/public/donate/trust/' . ($use_oo['getTrust']['theme_image'] ?? ''), type: 'counselling') }}"
                                                        alt="{{ translate('donate') }}">
                                                    @else
                                                    <img src="{{ getValidImage(path: 'storage/app/public/donate/ads/' . ($use_oo['adsTrust']['image'] ?? ''), type: 'counselling') }}"
                                                        alt="{{ translate('donate') }}">
                                                    @endif
                                                    @elseif($use_oo['type'] == 'tour')
                                                    <a class="d-block position-relative">
                                                        <img src="{{ getValidImage(path: 'storage/app/public/tour_and_travels/tour_visit/' . ($use_oo['Tour']['tour_image'] ?? ''), type: 'logo') }}"
                                                            alt="{{ translate('tour') }}">
                                                    </a>
                                                    @elseif($use_oo['type'] == 'kundli' || $use_oo['type'] == 'kundli milan')
                                                    <p class="d-block position-relative">
                                                        <img src="{{ getValidImage(path: 'storage/app/public/birthjournal/image/' . ($use_oo['birthJournal']['image'] ?? ''), type: 'logo') }}"
                                                            alt="{{ translate('tour') }}">
                                                    </p>
                                                    @endif
                                                        ...
                                                        <h6 class="font-weight-bold m-0 mb-1">
                                                            ...
                                                            <div class="small text-start mt-2">
                                                                <span class="font-weight-medium"
                                                                    role="tooltip"
                                                                    data-title="{{ $use_oo['pickup_address'] ?? '' }}"
                                                                    data-toggle="tooltip">
                                                            ...
                                                            <div
                                                                class="text-secondary-50 fs-12 font-semibold mt-1">
                                                                {{ $use_oo['birthJournal']['type'] ?? '' }}
                                                                (P.
                                                                {{ $use_oo['birthJournal']['pages'] ?? '' }})
                                                            </div>
                                                            <div
                                                                class="text-secondary-50 fs-12 font-semibold mt-1">
                                            ...
                                            <td><span
                                                    class="status-badge rounded-pill __badge badge-soft-badge-soft-primary fs-12 font-semibold text-capitalize ">{{ $use_oo['type'] }}</span>
                                            </td>
                                            <td>
                                                @if ($use_oo['type'] == 'pooja')
                                                <span
                                                    class="status-badge rounded-pill __badge badge-soft-badge-soft-{{ $use_oo->order_status == 0
                                                                        ? 'primary'
                                                ...
                                                @elseif($use_oo['type'] == 'counselling')
                                                <span
                                                    class="status-badge rounded-pill __badge badge-soft-badge-soft-{{ $use_oo->status == 0 ? 'primary' : ($use_oo->status == 1 ? 'success' : 'danger') }} fs-12 font-semibold text-capitalize ">{{ $use_oo->status == 0 ? 'Pending' : ($use_oo->status == 1 ? 'Completed' : 'Canceled') }}</span>
                                                @elseif($use_oo['type'] == 'offlinepooja')
                                                <span
                                                    class="status-badge rounded-pill __badge badge-soft-badge-soft-{{ $use_oo->status == 0 ? 'primary' : ($use_oo->status == 1 ? 'success' : 'danger') }} fs-12 font-semibold text-capitalize ">{{ $use_oo->status == 0 ? 'Pending' : ($use_oo->status == 1 ? 'Completed' : 'Canceled') }}</span>
                                                @elseif($use_oo['type'] == 'vip')
                                                ...
                                                @elseif(
                                                $use_oo['order_status'] == 'confirmed' ||
                                                $use_oo['order_status'] == 'processing' ||
                                                $use_oo['order_status'] == 'delivered')
                                                <span
                                                ...
                                                @elseif($use_oo['type'] == 'donate')
                                                <span
                                                    class="status-badge rounded-pill __badge fs-12 font-semibold text-capitalize badge-soft-badge-soft-{{ $use_oo['amount_status'] == 1 ? 'success' : 'danger' }}">{{ $use_oo['amount_status'] == 1 ? 'Success' : 'Pending' }}</span>
                                                @elseif($use_oo['type'] == 'tour')
                                                <?php
                                            ...
                                            <td>
                                                @if (
                                                $use_oo['type'] == 'chadhava' ||
                                                $use_oo['type'] == 'pooja' ||
                                                $use_oo['type'] == 'vip' ||
                                                $use_oo['type'] == 'anushthan')
                                                <a href="{{ ($use_oo['type'] == 'chadhava'
                                                                        ? route('account-chadhava-sankalp', ['order_id' => $use_oo->order_id])
                                                                        : ($use_oo['type'] == 'vip'
                                                                            ? route('account-vip-sankalp', ['order_id' => $use_oo->order_id])
                                                                            : ($use_oo['type'] == 'anushthan'
                                                                                ? route('account-anushthan-sankalp', ['order_id' => $use_oo->order_id]):'#'))) }}"
                                                    class="badge badge-primary"
                                                    title="{{ translate('view_order_details') }}">
                                                    View
                                                </a>
                                                @elseif($use_oo['type'] == 'counselling')
                                                @if ($use_oo->payment_status == 1)
                                                <a href="{{ route('account-counselling-order-user-detail', ['order_id' => $use_oo->order_id])}}"
                                                    class="badge badge-primary"
                                                    title="{{ translate('view_order_details') }}">
                                                    View
                                                </a>
                                                @else
                                                @include('web-views.counselling.partials.pending-order.cl-payment')
                                                @endif
                                                @elseif($use_oo['type'] == 'offlinepooja')
                                                @if ($use_oo->payment_status == 1)
                                                <a href="{{ route('account-offlinepooja-sankalp', ['order_id' => $use_oo->order_id]) }}"
                                                    class="badge badge-primary"
                                                    title="{{ translate('view_order_details') }}">
                                                    View
                                                </a>
                                                @else
                                                @include('web-views.offlinepooja.partials.pending-order.payment')
                                                @endif
                                                @endif
                                                @if ($use_oo['type'] == 'pooja')
                                                <div class="__btn-grp-sm flex-nowrap">
                                                    ...
                                                    <a href="{{ route('generate-invoice-service', ['id' => $use_oo->id]) }}"
                                                ...
                                                <div class="__btn-grp-sm flex-nowrap">
                                                    ...
                                                    <a href="{{ route('generate-invoice-vip', ['id' => $use_oo->id]) }}"
                                                        title="{{ translate('download_invoice') }}"
                                                        class="btn-outline-success text-success __action-btn btn-shadow rounded-full">
                                                        <i class="tio-download-to"></i>
                                                    </a>
                                                ...
                                                <div class="__btn-grp-sm flex-nowrap">
                                                    ...
                                                    <a href="{{ route('generate-invoice-anushthan', ['id' => $use_oo->id]) }}"
                                                        title="{{ translate('download_invoice') }}"
                                                        class="btn-outline-success text-success __action-btn btn-shadow rounded-full">
                                                        <i class="tio-download-to"></i>
                                                    </a>
                                                ...
                                                <div class="__btn-grp-sm flex-nowrap">
                                                    ...
                                                    <a href="{{ route('generate-invoice-chadhava', ['id' => $use_oo->id]) }}"
                                                        title="{{ translate('download_invoice') }}"
                                                        class="btn-outline-success text-success __action-btn btn-shadow rounded-full">
                                                        <i class="tio-download-to"></i>
                                                    </a>
                                                ...
                                                @elseif($use_oo['type'] == 'donate')
                                                <a href="{{ route('donate-order-details', [$use_oo['id']]) }}" title="view" class="btn-outline-success text-success __action-btn btn-shadow rounded-full">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                ...
                                                <a href="{{ url('api/v1/donate/twoal-a-certificate', [$use_oo['id']]) }}"
                                                    title="{{ translate('download_80g_certificate') }}"
                                                    class="btn-outline-info text-info __action-btn btn-shadow rounded-full">
                                                    <i class="tio-file_outlined">file_outlined</i>
                                                </a>
                                                @endif
                                                @elseif($use_oo['type'] == 'tour')
                                                <a href="{{ route('tour.view-details', [$use_oo['id']]) }}"
                                                    title="view"
                                                    class="btn-outline-success text-success __action-btn btn-shadow rounded-full">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="{{ route('tour.tour-pdf-invoice', [$use_oo['id']]) }}"
                                ...
                                <table class="table __table __table-2 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bodytr">
                                                <span
                                                    class="status-badge rounded-pill __badge badge-soft-badge-soft-{{ $serviceorder->order_status == 0
                                                                    ? 'primary'
                                ...
                                <table class="table __table __table-2 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bodytr">
                                                <span
                                                    class="status-badge rounded-pill __badge badge-soft-badge-soft-{{ $viporder->order_status == 0
                                                                    ? 'primary'
                                ...
                                <table class="table __table __table-2 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bodytr">
                                                <div class="__btn-grp-sm flex-nowrap">
                                                    @if ($poojaOrder->payment_status == 1)
                                                    <a href="{{ route('account-offlinepooja-order-details', ['order_id' => $poojaOrder->order_id]) }}"
                                                        class="btn-outline--info text-base __action-btn btn-shadow rounded-full"
                                                        title="{{ translate('view_order_details') }}">
                                                        <i class="fa fa-eye"></i>
                                                    ...
                                                    @else
                                                    @include('web-views.offlinepooja.partials.pending-order.optab-payment')
                                                    @endif
                                                    {{-- <a href="#"
                                ...
                                <table class="table __table __table-2 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bodytr">
                                                <span
                                                    class="status-badge rounded-pill __badge badge-soft-badge-soft-{{ $anushthanorder->order_status == 0
                                                                    ? 'primary'
                                ...
                                <table class="table __table __table-2 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bodytr">
                                                @if ($counsellingorder->payment_status == 1)
                                                ...
                                                @else
                                                @include('web-views.counselling.partials.pending-order.cltab-payment')
                                                @endif
                                            </td>
                                        </tr>
                                        @endif
                                ...
                                <table class="table __table __table-2 text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bodytr">
                                                <span
                                                    class="status-badge rounded-pill __badge badge-soft-badge-soft-{{ $chadhava->order_status == 0
                                                                    ? 'primary'
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url('api/v1/donate/twoal-a-certificate', [$donate['id']]) }}"
                                                    title="{{ translate('download_80g_certificate') }}"
                                                    class="btn-outline-info text-info __action-btn btn-shadow rounded-full">
                                                    <i class="tio-file_outlined">file_outlined</i>
                                                </a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bodytr">
                                                <div class="media-order">
                                                    <p class="d-block position-relative">
                                                        <img src="{{ getValidImage(path: 'storage/app/public/birthjournal/image/' . ($donate['birthJournal']['image'] ?? ''), type: 'logo') }}"
                                                            alt="{{ translate('tour') }}">
                                                    </p>
                                                    <div class="cont text-start">
                                                        <span class="fs-12 font-weight-medium">
                                                        ...
                                                        <div
                                                            class="text-secondary-50 fs-12 font-semibold mt-1">
                                                            {{ $donate['birthJournal']['type'] ?? '' }} (P.
                                                            {{ $donate['birthJournal']['pages'] ?? '' }})
                                                        </div>
                                                        <div
                                                            class="text-secondary-50 fs-12 font-semibold mt-1">
                                            ...
                                            <td>
                                                <div class="cont text-start">
                                                    ...
                                                    <div class="text-secondary-50 fs-12 font-semibold mt-1">
                                                        {{ date('d M,Y', strtotime($donate['bod'] ?? '')) }}
                                                        {{ date('h:i A', strtotime($donate['time'] ?? '')) }}
                                                    </div>
                                                </div>
                                            </td>
                                            <td> <span>{{ webCurrencyConverter(amount: $donate['amount'] ?? 0) }}</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="cont text-start">
                                                    ...
                                                    <div class="text-secondary-50 fs-12 font-semibold mt-1">
                                                        {{ date('d M,Y', strtotime($donate['female_dob'] ?? '')) }}
                                                        {{ date('h:i A', strtotime($donate['female_time'] ?? '')) }}
                                                    </div>
                                                </div>
                                            </td>
                                            <td> <span>{{ webCurrencyConverter(amount: $donate['amount'] ?? 0) }}</span>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                <span
                                                    class="status-badge rounded-pill __badge badge-soft badge-warning fs-12 font-semibold text-capitalize "
                                                    style="padding: 1px 9px;">progress</span>
                                                @endif
                                                <div class="__btn-grp-sm flex-nowrap">
                                                    <a href="{{ route('saved.paid-kundali-milan.show', [$donate['id']]) }}"
                                                        title="{{ translate('View_details') }}"
                ...
                <div class="card-body d-flex flex-column gap-3 customer-profile-orders py-0">
                    ...
                    <div class="d-flex border-lighter rounded p-2 justify-content-between gap-1">
                        ...
                        <div class="__btn-grp-sm">
                            ...
                            @endif
                            @elseif($use_oo['type'] == 'tour')
                            <a href="{{ route('tour.view-details', [$use_oo['id']]) }}" title="view"
                                class="btn-outline-success text-success __action-btn btn-shadow rounded-full">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('tour.tour-pdf-invoice', [$use_oo['id']]) }}"
...
<script>
    $(document).ready(function() {
        @foreach($serviceOrder as $serviceorder)
        $('#shareButton-{{ $serviceorder['
            id '] }}').click(function(e) {
            e.preventDefault();
            $('#shareModal-{{ $serviceorder['
                id '] }}').modal('show');
        });
        @endforeach
    });
...
<script>
    $(document).ready(function() {
        @foreach($anushthanOrder as $anushthanorder)
        $('#shareButton-{{ $anushthanorder['
            id '] }}').click(function(e) {
            e.preventDefault();
            $('#shareModal-{{ $anushthanorder['
                id '] }}').modal('show');
        });
        @endforeach
    });
