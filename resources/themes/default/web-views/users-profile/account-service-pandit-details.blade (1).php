                      ...
                      <td class="order_table_td">
                        <div class="">
                          ...
                          @if(!empty($order['pandit']))
                              ...
                              <div class="fs-12">
                                  <span class="text-muted text-capitalize">{{ translate('pandit_email') }}</span>:<span class="text-primary text-capitalize">{{ $order['pandit']['email'] }}</span>
                              </div>
                              <div class="fs-12">
                        ...
                        <div class="">
                          ...
                          @if(!empty($members))
                              @foreach($members as $member)
                                  <div class="fs-12">
                                      <span class="text-muted text-capitalize">{{ translate('Member Name') }}</span>: <span class="text-primary text-capitalize">{{$member}}</span>
                                  </div>
                              @endforeach
                          @else
                              <div class="fs-12">
