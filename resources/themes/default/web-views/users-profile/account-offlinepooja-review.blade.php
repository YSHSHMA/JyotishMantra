...
@section('title', translate('order_Review'))
@push('css_or_js')
                    ...
                    <div class="card-body">
                        ...
                        <!-- Display existing review comment and rating -->
                            <section class="rating__card">
                                ...
                                <p class="rating__card__bottomText">{{ date('h:i A, d M Y', strtotime($existingReview['created_at'])) }}</p>
                            </section>
                        ...
                        <div class="px-4 lg:px-0 md:bg-[#FAFAFA]">
                            <div class="w-full top-12 md:static">
                                <div class="md:max-w-screen-xl mx-auto flex flex-row items-center">
                                    <h2 class="inline m-0 text-[18px] md:text-[24px] font-bold text-BLACK-90">What devotees
                                        Say about Mahakal .Com Pooja ?</h2>
                                </div>
                            </div>
                            <div class="max-w-screen-xl mx-auto md:mt-3"><span
                                    class="font-normal text-[16px] md:text-[20px] text-[#707070] mt-3">Reviews and Ratings
                                    from our customers who performed Offline Pooja with us.</span></div>
                        </div>
                            <!-- Display review submission form -->
                            <form action="{{ route('submit_offlinepooja_review', $order['order_id']) }}" method="post"
                                ...
                                <input type="hidden" name="astro_id" value="{{ isset($order['pandit']['id']) ? $order['pandit']['id'] : '' }}">
