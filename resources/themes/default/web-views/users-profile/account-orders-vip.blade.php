                ...
                <tr>
                  <td class="bodytr">
                    <div class="media-order">
                      <a href="{{ route('account-vip-order-details', ['order_id' => $viporder->order_id]) }}" class="d-block position-relative">
                      <img alt="{{ translate('shop') }}" src="{{ getValidImage(path: 'storage/app/public/pooja/thumbnail/' . $viporder->thumbnail, type: 'pooja') }}">
                      </a>
                      <div class="cont text-start">
                        <h6 class="font-weight-bold m-0 mb-1">
                          <a href="{{ route('account-vip-order-details', ['order_id' => $viporder->order_id]) }}" class="fs-14 font-semibold">
                          {{ translate('order') }} #{{ $viporder['order_id'] }}
                          </a>
                        </h6>
                  ...
                  <td class="bodytr">
                    <span class="status-badge rounded-pill __badge badge-soft-{{ $viporder->order_status == 0
                      ? 'primary'
      ...
      <div class="bg-white d-lg-none web-direction">
        <div class="card-body d-flex flex-column gap-3 customer-profile-orders py-0">
          ...
          <div class="d-flex border-lighter rounded p-2 justify-content-between gap-1">
            <div class="">
              <div class="media-order">
                <a href="{{ route('account-service-order-details', ['order_id' => $viporder->order_id]) }}" class="d-block position-relative">
                <img alt="{{ translate('shop') }}" src="{{ getValidImage(path: 'storage/app/public/pooja/thumbnail/' . $viporder->thumbnail, type: 'pooja') }}">
                </a>
                <div class="cont text-start">
                  <h6 class="font-weight-bold mb-1 fs-14">
                    <a href="{{ route('account-service-order-details', ['order_id' => $viporder->order_id]) }}" class="fs-14 font-semibold">
                    {{ translate('order') }} #{{ $viporder['order_id'] }}
                    </a>
                  </h6>
                  <span class="fs-12 font-weight-medium">
