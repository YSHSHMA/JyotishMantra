                                        ...
                                        <table class="calculation-table table table-borderless mb-0">
                                            <tbody class="totals">
                                                ...
                                                <tr class="border-top">
                                                    <td>
                                                        <div class="text-start">
                                                            <span class="product-qty">{{ translate('Package_amount') }}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-end">
                                                            ...
                                                            @else
                                                                <span class="fs-15 text-muted">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount:0), currencyCode: getCurrencyCode()) }}</span>
                                                            @endif
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-end">
                                                            <span class="fs-15 font-semibold text-danger">- {{  webCurrencyConverter(amount: $order->transection_amount) }}</span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="border-top">
