...
@section('title', translate('anushthan_pooja_sankalp_page'))
@push('css_or_js')
    <link rel="stylesheet"
            ...
            <section class="col-lg-9">
                ...
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        @if ($order)
                            <form class="needs-validation" id="sankalp_check" action="{{ route('AnushthansanklpUpdate', $order['order_id']) }}" method="post">
                                @csrf
                                ...
                                <h2 class="mt-4 mb-3  text-lg-left mobile-fs-20 fs-18 font-bold">
                                    {{ translate('Name_of_member_participating_in_Anushthan_Puja') }}</h2>
                                <span>{{ translate('Panditji_will_take_these_names_along_with_gotra_during_the_Anushthan_puja') }}</span>
                                ...
                                <span>{{ translate('Gotra_will_be_recited_during_the_Anushthan_puja') }} </span>
                                <div class="row mt-2">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <span>{{ translate('Prasad_of_workship_will_be_sent_within_8_10_days_after_completion_of_Anushthan_puja') }}</span>
                                    </div>
