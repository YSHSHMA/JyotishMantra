                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-0 g-md-3 gap-3 h-100">
                                                ...
                                                <div
                                                    ...
                                                    @if ($addFundsToWallet)
                                                        <div class="mx-3">
                                                            ...
                                                            <button
                                                                class="btn btn-light align-items-center fs-14 font-semi-bold py-2 px-4"
                                                                data-phone="{{ auth('customer')->user()->phone }}"
                                                                onclick="withdrawUserBal(this)">
                                                                {{-- <span><i class="tio-add-circle text-accent"></i></span> --}}
                                                                <span class="text-danger">{{ translate('withdraw') }}</span>
                                                            </button>
                                                        </div>
                                                    @endif
                            ...
                            <div class="modal fade" id="withdraw-modal" tabindex="-1"
                                aria-labelledby="withdrawFundFromWalletModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body px-5">
                                            ...
                                            <form action="{{ route('store-bank-detail') }}" method="post">
                                                @csrf
                                                <div class="pb-2">
                                                    <h4 class="text-center">{{ translate('withdraw_Fund_from_Wallet') }}
                                                    </h4>
                                                    <p class="text-center">
                                                        {{ translate('withdraw_fund_will_take_3_business_days') }}</p>
                                                </div>
                                                ...
                                                <div id="add-fund-list-area">
                                                    <input type="hidden" name="phone"
                                                        ...
                                                        class="form-control">
                                                    <input type="hidden" name="wallet_balance" id="wallet-balance"
                                                        class="form-control">
                                                    <div class="row">
                                                        <div class="col-6 pb-2">
                                                            <label for="holder">Holder Name</label>
                                                            <input type="text" name="holder" id="holder"
                                                                class="form-control" placeholder="Enter holder name"
                                                                required>
                                                        </div>
                                                        <div class="col-6 pb-2">
                                                        ...
                                                        <div class="col-6 pb-2">
                                                            ...
                                                            <input type="text" name="ifsc" id="ifsc"
                                                                class="form-control" placeholder="Enter ifsc" required>
                                                        </div>
                                                        <div class="col-6 pb-2">
                                                            <label for="account_no">Account No.</label>
                                                            <input type="number" name="account_no" id="account-no"
                                                                class="form-control" placeholder="Enter account no"
                                                                required>
                                                        </div>
                                                        <div class="col-6 pb-2">
                                                            <label for="">Confirm Account No.</label>
                                                            <input type="number" name="" id="confirm-account-no"
                                                                class="form-control" placeholder="Re-Enter account no"
                                                                required>
                                                            <p id="account-no-error" class="text-danger d-none"></p>
                                                        </div>
                                                        <div class="col-12 pb-2">
                                                            <label for="request_balance">Withdraw Amount</label>
                                                            <input type="number" name="request_balance"
                                                                id="request-balance" class="form-control"
                                                                placeholder="Enter withdraw amount" required>
                                                            <p id="request-bal-error" class="text-danger d-none"></p>
                                                        </div>
                                                        <div class="row pt-3 w-100">
                                                            <div class="col-12 text-end">
                                                                <button type="submit" id="withdraw-btn"
                                                                    class="btn--primary btn">Withdraw</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="">
                                    <div
                                        class="align-items-start d-flex flex-column flex-md-row gap-8 justify-content-between p-2 align-items-center">
                                                        ...
                                                        <div class="">
                                                            <h6 class="mb-2 d-flex align-items-center gap-8">
                                                                <img src="{{ theme_asset(path: 'public/assets/front-end/img/icons/coin-success.png') }}"
                                                                    width="25" alt="">
                                                                <span>+
                                                                    {{ webCurrencyConverter(amount: $item['admin_bonus']) }}</span>
                                                            </h6>
                                                            <h6
                                    ...
                                    @if ($wallet_transactio_list->count() == 0)
                                        <div class="d-flex flex-column gap-3 align-items-center text-center my-5">
                                            ...
                                            <h6 class="text-muted mt-3">{{ translate('you_do_not_have_any') }}<br>
                                                {{ request('type') != 'all' ? ucwords(translate(request('type'))) : '' }}
                                                {{ translate('transaction_yet') }}</h6>
                                        </div>
                                    @endif
...
@push('script')
    ...
    {{-- withdraw user balance modal --}}
    <script>
        function withdrawUserBal(that) {
            var phone = $(that).data('phone');
            $.ajax({
                type: "get",
                url: "{{ url('get-bank-detail') }}" + '/' + phone,
                success: function(response) {
                    if (response.status) {
                        $('#wallet-balance').val(response.walletBalance);
                        if (response.bankDetail && Object.keys(response.bankDetail).length > 0) {
                            $('#holder').val(response.bankDetail.holder);
                            $('#bank').val(response.bankDetail.bank);
                            $('#branch').val(response.bankDetail.branch);
                            $('#ifsc').val(response.bankDetail.ifsc);
                            $('#account-no').val(response.bankDetail.account_no);
                        }
    ...
    {{-- validate account-no --}}
    <script>
        $('#confirm-account-no').blur(function() {
            var accountNo = $('#account-no').val();
            var confirmAccountNo = $(this).val();
            ...
            if (confirmAccountNo !== accountNo) {
                ...
                $('#withdraw-btn').addClass('d-none');
            } else {
                $('#account-no-error').addClass('d-none').text('');
                $('#withdraw-btn').removeClass('d-none');
            }
        });
    </script>

    {{-- validate request bal not greater than wallet bal --}}
    <script>
        $('#request-balance').keyup(function() {
            var requestBal = parseFloat($(this).val()) || 0;
            var walletBal = parseFloat($('#wallet-balance').val()) || 0;

            if (requestBal > walletBal) {
                $('#request-bal-error')
                    .removeClass('d-none')
                    .text('Requested balance exceeds wallet balance.');
                $(this).val('');
            } else {
                $('#request-bal-error')
                    .addClass('d-none');
