...
@section('title', translate('Anushthan_order_list'))
@section('content')
      ...
      <div class="card __card d-none d-lg-flex web-direction customer-profile-orders">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between gap-2 mb-0 mb-md-3">
            <h5 class="font-bold mb-0 fs-16">{{ translate('Anushthan_order_list') }}</h5>
          </div>
                ...
                <tr>
                  <td class="bodytr">
                    <div class="media-order">
                      <a href="{{ route('account-vip-order-details', ['order_id' => $anushthanorder->order_id]) }}" class="d-block position-relative">
                      <img alt="{{ translate('shop') }}" src="{{ getValidImage(path: 'storage/app/public/pooja/thumbnail/' . $anushthanorder->thumbnail, type: 'pooja') }}">
                      </a>
                      <div class="cont text-start">
                        <h6 class="font-weight-bold m-0 mb-1">
                          <a href="{{ route('account-vip-order-details', ['order_id' => $anushthanorder->order_id]) }}" class="fs-14 font-semibold">
                          {{ translate('order') }} #{{ $anushthanorder['order_id'] }}
                          </a>
                        </h6>
                  ...
                  <td class="bodytr">
                    ...
                    <a href="{{ route('account-vip-sankalp', ['order_id' => $anushthanorder->order_id]) }}"
                  ...
                  <td class="bodytr">
                    <span class="status-badge rounded-pill __badge badge-soft-{{ $anushthanorder->order_status == 0
                      ? 'primary'
                  ...
                  <td class="bodytr">
                    <div class="__btn-grp-sm flex-nowrap">
                      ...
                      @endif
                      <a href="{{ route('account-vip-order-details', ['order_id' => $anushthanorder->order_id]) }}"
                        class="btn-outline--info text-base __action-btn btn-shadow rounded-full"
                        title="{{ translate('view_order_details') }}">
                      <i class="fa fa-eye"></i>
                      </a>
                      <a href="{{ route('generate-invoice-vip', ['id' =>$anushthanorder->id]) }}" title="{{ translate('download_invoice') }}"
          ...
          <div class="text-center pt-5 text-capitalize">
            <img src="{{ theme_asset(path: 'public/assets/front-end/img/sorry.svg') }}"
              alt="" width="70">
            <h5 class="mt-1 fs-14">{{ translate('no_anushthan_order_found') }}!</h5>
          </div>
          @endif
