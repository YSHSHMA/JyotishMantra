                                ...
                                <tr>
                                    <td class="bodytr">
                                        <div class="media-order">
                                            <a href="{{ route('account-service-order-details', ['order_id' => $serviceorder->order_id]) }}" class="d-block position-relative">
                                                <img alt="{{ translate('shop') }}" src="{{ getValidImage(path: 'storage/app/public/pooja/thumbnail/' . $serviceorder->thumbnail, type: 'pooja') }}">
                                            </a>
                                            <div class="cont text-start">
                                                <h6 class="font-weight-bold m-0 mb-1">
                                                    <a href="{{ route('account-service-order-details', ['order_id' => $serviceorder->order_id]) }}" class="fs-14 font-semibold">
                                                        {{ translate('order') }} #{{ $serviceorder['order_id'] }}
                                                    </a>
                                                </h6>
                                    ...
                                    <td class="bodytr">
                                        <span class="status-badge rounded-pill __badge badge-soft-{{ $serviceorder->order_status == 0
                                                            ? 'primary'
