...
<div class="container py-3" dir="{{Session::get('direction')}}">
    <div class="search-page-header">
        <div class="col-6">
                <input type="text" class="form-control search_by_locations" placeholder="{{ translate('please_enter_a_location') }}">
        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12  p-2">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('self-vehicle-details',[($val['slug']??'')])}}" class="text-white animated-button mt-2">
