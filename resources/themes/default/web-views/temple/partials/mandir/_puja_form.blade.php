<div class="row">
    ...
    <div class="col-lg-6">
        <div class="row g-3">
            ...
            <div class="col-12">
                <label class="f-label">{{ translate('Select_Puja_Date') }}</label>
            ...
            <div class="col-12">
                <label
                    class="f-label">{{ translate('Already_Assigned_by_the_Temple') }}</label>
                <select class="form-select" name="pandit_id">
                    <option value="">
                        {{ translate('Already_Assigned_by_the_Temple') }}
                    </option>
            ...
            {{-- <div class="col-12">
                <label class="f-label">Total Customer</label>
                <select class="form-select" name="total_customer" id="total-customer">
