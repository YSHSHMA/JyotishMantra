<div class="row" id="darshan-section">
    <input type="hidden" name="service_id" value="{{ $package->id }}" id="darshan-package-id">
    ...
    <div class="col-lg-6">
        <div class="row g-3">
            ...
            <div class="col-12">
                <label class="f-label">{{ translate('Select_Darshan_Date') }}</label>
                <input type="date" class="form-control darshan-date-select" name="booking_date"
                    min="{{ date('Y-m-d') }}"
            ...
            <div class="col-12">
                ...
                <input type="hidden" name="timeslot_id" class="darshan-timeslot-id" id="timeSlotSelect">
            </div>
            <div class="col-12">
