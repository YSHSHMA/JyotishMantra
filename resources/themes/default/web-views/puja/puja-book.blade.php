...
<body>
    ...
    <main class="" style="margin-top:100px;">
        ...
        $folder = 'pooja/vip/';
        } elseif ($puja->product_type == 'pooja') {
        $folder = 'pooja/';
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex items-center space-x-1 pt-2">
                        <div class="d-flex">
                            ...
                            <p class="pooja-calendar" style="font-weight:600;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @endforeach
                    @endif
                    <ul class="list-group list-group-flush text-dark" id="confirmDetails">
                        <li class="list-group-item">{{ translate('Name') }}: <strong id="cName">—</strong>
                        </li>
                        <li class="list-group-item">{{ translate('Phone') }}: <strong id="cMobile">—</strong>
                        </li>
                        <li class="list-group-item">{{ translate('Booking Date') }}: <strong
                                id="cDate">—</strong></li>
                        <li class="list-group-item">{{ translate('Package') }}: <strong id="cPackage">—</strong>
                        </li>
                        <li class="list-group-item">{{ translate('Amount') }}: <strong id="cAmount">—</strong>
                        </li>
                    </ul>
                    <div class="modal-footer">
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (Array.isArray(d.products) && d.products.length > 0) {
                            productListHtml =
                                `<li class="list-group-item product-list">{{ translate('Products') }}:<ul>`;
                            d.products.forEach(p => {
                                productListHtml += `<li>${p.name} (₹${p.price}) x ${p.qty}</li>`;
                            });
                            productListHtml += "</ul></li>";
                        }
                        let modalList = $("#confirmModal .modal-body ul");
                        modalList.find(".product-list").remove();
                        if (productListHtml) modalList.append(productListHtml);
    ...
    <!-- reset prodcut after cancel details and confirm model -->
    <script>
        function fullReset() {
            selectedProducts = {};
            $('#add_product_id').val('');
