...
<body>
    ...
    <script>
        ...
        function updateFooter() {
            ...
            // Item count
            document.getElementById("footerItemCount").innerHTML =
                totalItems > 0 ? `${totalItems} item${totalItems > 1 ? "s" : ""}` : "Select Your Chadhava Product";
            ...
            // Item list
            document.getElementById("footerItemList").innerHTML = listHtml;

            // Hidden fields
            $("#add_product_id").val(JSON.stringify(products));
            $("#total_amount").val(total);

            // Proceed button enable/disable
            document.getElementById("btnEditInfo").disabled = (totalItems === 0);
        }
