                            ...
                            <div class="details __h-100">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-2 pro">
                                    <div class="star-rating me-2">
                                        <?php $overallRating[0] = (((int)$overallRating[0] == 0)? 5 : (int)$overallRating[0]); ?>
                                        @for($inc=1;$inc<=5;$inc++)
                                ...
                                <div class="row no-gutters flex-start d-flex">
                                    <div class="col-12">
                                        @if($product->product_refund == 1)
                                            <h6 class="text-danger">{{translate('non refundable item')}}</h6>
                                        @endif
                                    </div>
                                </div>
                                <div class="mb-3">
