        ...
        <div class="d-flex flex-wrap justify-content-between seller-details">
            <div class="d-flex align-items-center p-2 flex-grow-1">
                ...
                <div class="__w-100px flex-grow-1 {{Session::get('direction') === "rtl" ? ' pr-2 pr-sm-4' : ' pl-2 pl-sm-4'}}">
                    ...
                    @if(isset($shop['vacation_start_date']) && isset($shop['vacation_end_date']))
                    <div class="font-weight-bolder text-nowrap fs-19 font-semibold" style="display: {{ $shop->vacation_status == 1 ? 'block' : 'none' }};">
                        <span class="text-dark">On Vacation: </span>
                        <span class="text-danger">{{ $shop->vacation_start_date }} - {{ $shop->vacation_end_date }}</span>
                    </div>
                    @endif
