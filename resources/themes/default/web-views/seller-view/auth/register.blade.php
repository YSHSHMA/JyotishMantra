                            ...
                            <div class="new_title_hidden d-none">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mt-2">
                                        <input type="text" class="form-control form-control-user" id="shop_building_no"
                                            name="shop_building_no" placeholder="{{ translate('shop_building_no') }}"
                                            value="{{ old('shop_building_no') }}" required>
                                    </div>
