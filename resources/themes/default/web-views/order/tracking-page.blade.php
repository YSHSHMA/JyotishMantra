                ...
                <div class="mw-1000 mx-auto">
                    ...
                    <form action="{{ route('track-order.result') }}" type="submit" method="post" class="p-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <input class="form-control form-control-sm prepended-form-control" name="phone_number" type="tel"
                                    value="{{auth('customer')->check()?auth('customer')->user()->phone:'your_phone_number'}}" required>
                            </div>
                            <div class="col-md-4">
