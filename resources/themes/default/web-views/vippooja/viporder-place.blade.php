...
@section('title', translate('VIP |Order Place'))
                    ...
                    @if (auth('customer')->check() || session('guest_id'))
                        <div class="card-body">
                            ...
                            <h6 class="font-black fw-bold text-center">
                                {{ translate('vip_Successfully_Requested') }}!
                            </h6>
                            <h6 class="font-black fw-bold text-center">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-center">
                                    <a href="{{ auth('customer')->check() ? route('account-service-order-details', ['order_id' => $orderId]) : route('customer.auth.login') }}"
