...
@media screen and (max-width: 768px) {
    .float-action-button .main-button {
        display: none;
    }
}
...
<div class="__inline-9 rtl">
            ...
            <div class="container text-center __pb-13px">
                ...
                <div class="row mt-3 pb-3 ">
                    <div class="col-md-3 footer-web-logo text-center text-md-start ">
                        ...
                        <div class="text-center pr-lg-4 mb-2 d-none d-sm-flex justify-content-center">
                            ...
                            <div class="col-sm-4 col-6 footer-padding-bottom text-start">
                                ...
                                @else
                                    <ul class="widget-list __pb-10px">
                                        ...
                                        @endif
                                        <li class="widget-list-item">
                                            <a class="widget-list-link" href="{{ url('/blog') }}">{{ translate('blogs') }}</a>
                                        </li>
                                    </ul>
                                @endif
                            </div>
  ...
  <!-- Button Container -->
<div class="mobile-button-wrapper" id="openAppContainer" style="display: none;">
    <button class="mobile-button" onclick="openStoreLink()">Open App</button>
    <button class="close-btn11" onclick="closeAppPopup()">×</button>
</div>
<!-- JavaScript -->
<script>
    ...
    window.addEventListener('DOMContentLoaded', function () {
        ...
        const alreadyClosed = sessionStorage.getItem('openAppClosed');

        if (isMobile && !alreadyClosed) {
    ...
    function closeAppPopup() {
        ...
        sessionStorage.setItem('openAppClosed', '1');
    }
