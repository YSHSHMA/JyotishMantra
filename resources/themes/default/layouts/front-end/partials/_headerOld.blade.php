...
<header class="rtl __inline-10">
    ...
    <div class="navbar-sticky bg-light mobile-head">
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container ">
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    <a class="navbar-tool navbar-stuck-toggler show" href="#">
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu show">
                ...
                <div class="collapse navbar-collapse text-align-direction" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown {{request()->is('all-puja')?'active':''}}">
                            <a class="nav-link" href="{{route('all-puja')}}">{{ translate('pooja')}}</a>
                        </li>
                        <li class="nav-item dropdown {{request()->is('shop')?'active':''}}">
                            <a class="nav-link" href="{{route('shop')}}">{{ translate('shop')}}</a>
                        </li>
                        ...
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                                <a class="nav-link text-uppercase"
                                   href="{{route('kundali-pdf.view')}}">{{ translate('Kundali pdf')}}</a>
                            </li>
                    </ul>
                    @if(auth('customer')->check())
