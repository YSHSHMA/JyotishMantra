            ...
            <div class="modal-body d-flex flex-column gap-3">
                ...
                <div class="border rounded bg-white">
                    <div class="p-3 fs-12 d-flex flex-column gap-2">
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            ...
                            <div> {{ webCurrencyConverter(amount: json_decode($order_details->product_details,true)['shipping_cost']) }}</div>
                        </div>
                        <?php
                        ...
                        $refund_amount = $subtotal - $coupon_discount + json_decode($order_details->product_details,true)['shipping_cost'];
                        ?>
                        <div class="d-flex justify-content-between gap-2">
                ...
                <form action="{{route('refund-store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="collapse" id="collapseExample">
                        ...
                        <input type="hidden" name="reason_data" value="" id="reason-data">
                        <div class="mt-2">
                            <select name="reason_name" id="reason_name" class="form-control mb-2" onchange="reasonGet()" required>
                        ...
                        <textarea rows="4" class="form-control" name="refund_reason" placeholder="{{translate('write_here')}}..."></textarea>
                    </div>
                                ...
                                <div class="d-flex flex-wrap upload_images_area">
                                    ...
                                    <label class="py-0 d-flex align-items-center m-0 cursor-pointer">
                                        ...
                                        <input type="file" class="msgfilesValue h-100 position-absolute w-100 " hidden
                                               multiple accept=".jpg, .png, .jpeg, .gif, .bmp, .webp |image/*" required>
                                    </label>
