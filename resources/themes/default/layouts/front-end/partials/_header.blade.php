    ...
    <div class="navbar-sticky bg-light mobile-head">
            ...
            <div class="container ">
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    <div
                        ...
                        <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="{{route('same-day-delivery')}}">
                            {{-- <span class="navbar-tool-label">
                                <span class="countWishlist">
                                    {{ session()->has('wish_list') ? count(session('wish_list')) : 0 }}
                                </span>
                            </span> --}}
                            <img src="{{asset('public/assets/front-end/img/same-day-delivery.png')}}" alt="">
                        </a>
                    </div>
                ...
                <div class="collapse navbar-collapse text-align-direction" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown {{ request()->is('tour') ? 'active' : '' }}">
                            <a class="nav-link"
                                href="{{ route('tour.index') }}">{{ translate('yatra') }}</a>
                        </li>
                        ...
                        <?php if (getDefaultLanguage() == 'in') { ?>

                            <li class="nav-item dropdown {{ request()->is('pooja') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ route('kundali-pdf.view') }}">{{ translate('kundali') }}</a>
                            </li>

                            <li class="nav-item dropdown {{ request()->is('darshan') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ route('darshan') }}">{{ translate('darshan') }}</a>
                            </li>
        ...
        <a class="nav-link"
            href="{{ route('vendors') }}">{{ translate('all_vendors') }}</a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link"
                                    href="{{ route('ram-shalaka') }}">{{ translate('ram_shalaka') }}</a>
                            </li>

                            <li class="nav-item dropdown">
                                <a class="nav-link"
                                    href="{{ url('/blog') }}">{{ translate('blogs') }}</a>
                            </li>
