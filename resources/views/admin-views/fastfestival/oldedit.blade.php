      ...
      <div class="col-md-12">
         <div class="card mb-3">
            <div class="card-body text-start">
               <form action="{{ route('admin.fastfestival.update', $fastfestival->id) }}" method="post"
                  ...
                  <div class="row">
                     <div class="col-md-8">
                        <div class="form-group">
                           ...
                           <textarea name="en_description" class="form-control ckeditor"
                              id="en_description"
                              placeholder="{{ translate('ex') }} : {{ translate('Description') }}"
                              required>{{ old('en_description', $fastfestival->en_description) }}</textarea>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-8">
                           <div class="form-group">
                              ...
                              <textarea name="hi_description" class="form-control ckeditor"
                                 id="hi_description"
                                 placeholder="{{ translate('ex') }} : {{ translate('Description') }}"
                                 required>{{ old('hi_description', $fastfestival->hi_description) }}</textarea>
                           </div>
                        </div>
                        <div class="col-md-4 mb-4">
                           <div class="text-center mb-3">
                              <img class="upload-img-view" id="viewer"
                                 src="{{ $fastfestival->fastfestival_image ? asset('storage/' . $fastfestival->fastfestival_image) : dynamicAsset('public/assets/back-end/img/400x400/img2.jpg') }}"
                                 alt="">
                           </div>
                           <div class="form-group">
