                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                                ...
                                <tr>
                                    ...
                                    <th>{{ translate('event_name_hi') }}</th>
                                    <th>{{ translate('event_type') }}</th>
                                    <th>{{ translate('en_description') }}</th>
                                    <th>{{ translate('hi_description') }}</th>
                                    <th>{{ translate('image') }}</th>
                                    @if (Helpers::modules_permission_check('Fast Festival', 'Fast Festival List', 'edit'))
                                ...
                                @foreach($fastfestivals as $key => $fastfestival)
                                    <tr>
                                        ...
                                        <td>{{ $fastfestival->event_name_hi }}</td>
                                        <td>{{ $fastfestival->event_type }}</td>
                                        <td>{!! Str::limit($fastfestival->en_description ,20) !!}</td>
                                        <td>{!! Str::limit($fastfestival->hi_description,20) !!}</td>
