...
<div class="content container-fluid">
   ...
   <div class="row">
      ...
      @if (Helpers::modules_permission_check('Event', 'Category', 'add'))
                  ...
                  <table id="datatable"
                     ...
                     <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                           ...
                           @if (Helpers::modules_permission_check('Event', 'Category', 'status'))
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex justify-content-center gap-2">
                                 @if (Helpers::modules_permission_check('Event', 'Category', 'edit'))
                                 ...
                                 @endif
                                 @if (Helpers::modules_permission_check('Event', 'Category', 'delete'))
