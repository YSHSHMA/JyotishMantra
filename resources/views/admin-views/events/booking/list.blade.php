                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center gap-2">
                                                                @if (Helpers::modules_permission_check('Event', 'Booking', 'detail'))
                                                                ...
                                                                @endif
                                                                @if (Helpers::modules_permission_check('Event', 'Booking', 'download'))
                                                                ...
                                                                @endif
                                                                @if (Helpers::modules_permission_check('Event', 'Booking', 'share'))
                                                                <a class="btn btn-outline-info btn-sm square-btn"
