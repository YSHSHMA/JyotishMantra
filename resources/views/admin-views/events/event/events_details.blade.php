      ...
      <div class="card w-100">
         <div class="card-body">
            <ul class="nav nav-tabs w-fit-content mb-4">
               ...
               <li class="nav-item text-capitalize">
                  <a class="nav-link" id="transaction-withdrowal-tab" data-toggle="tab" href="#transaction-withdrowal-content">
                     {{ translate('withdrawal_transaction') }}
                  </a>
               </li>
               @endif
               @if($view_type == 2)
            ...
            <div class="tab-content">
               ...
               <div class="tab-pane fade" id="transaction-withdrowal-content">
                  <div class="row">
