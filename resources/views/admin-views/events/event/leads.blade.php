                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <div class="d-flex justify-content-center gap-2">
                                                            ...
                                                            @if (Helpers::modules_permission_check('Event', 'Lead', 'delete'))
                                                            <a href="{{ route('admin.event-managment.leads.lead-delete', [$lead['id']]) }}"
                                                                ...
                                                                @endif
                                                                @if (Helpers::modules_permission_check('Event', 'Lead', 'follow-up'))
                                                        ...
                                                        <div class="d-flex justify-content-center gap-2 pt-2">
                                                            @if (Helpers::modules_permission_check('Event', 'Lead', 'follow-up-history'))
                                                            <a href="javascript:0"
                                                                ...
                                                                data-bs-original-title="Follow Up History"><i
                                                                    ...
                                                                    @endif
                                                                    @if (Helpers::modules_permission_check('Event', 'Lead', 'call'))
