                        ...
                        <table id="datatable" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100">
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    @if (Helpers::modules_permission_check('Event', 'List', 'status') ||
                                        Helpers::modules_permission_check('Event', 'Pending', 'status') ||
                                        Helpers::modules_permission_check('Event', 'Upcoming', 'status') ||
                                        Helpers::modules_permission_check('Event', 'Booking', 'status') ||
                                        Helpers::modules_permission_check('Event', 'Completed', 'status') ||
                                        Helpers::modules_permission_check('Event', 'Canceled', 'status'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            @if (Helpers::modules_permission_check('Event', 'List', 'detail') ||
                                                Helpers::modules_permission_check('Event', 'Pending', 'detail') ||
                                                Helpers::modules_permission_check('Event', 'Upcoming', 'detail') ||
                                                Helpers::modules_permission_check('Event', 'Booking', 'detail') ||
                                                Helpers::modules_permission_check('Event', 'Completed', 'detail') ||
                                                Helpers::modules_permission_check('Event', 'Canceled', 'detail'))
                                            ...
                                            @endif
                                            @if (Helpers::modules_permission_check('Event', 'List', 'edit') ||
                                                Helpers::modules_permission_check('Event', 'Pending', 'edit') ||
                                                Helpers::modules_permission_check('Event', 'Upcoming', 'edit') ||
                                                Helpers::modules_permission_check('Event', 'Booking', 'edit') ||
                                                Helpers::modules_permission_check('Event', 'Completed', 'edit') ||
                                                Helpers::modules_permission_check('Event', 'Canceled', 'edit'))
                                            ...
                                            @endif
                                            @if (Helpers::modules_permission_check('Event', 'List', 'delete') ||
                                                Helpers::modules_permission_check('Event', 'Pending', 'delete') ||
                                                Helpers::modules_permission_check('Event', 'Upcoming', 'delete') ||
                                                Helpers::modules_permission_check('Event', 'Booking', 'delete') ||
                                                Helpers::modules_permission_check('Event', 'Completed', 'delete') ||
                                                Helpers::modules_permission_check('Event', 'Canceled', 'delete'))
