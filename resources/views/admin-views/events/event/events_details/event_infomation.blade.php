                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group col-6">
                            ...
                            <div class='row'>
                                ...
                                <div class='col-3'>{{ ($pa['seats_no'] * $pa['price_no']) }} <button class='btn btn-primary btn-sm float-end' onclick='showDetailsButton(this)' data-point='{{ $loop->index}}'>show</button></div>
                                <div class='col-12 available-sold-row{{ $loop->index}} g-2 mt-2 text-primary d-none'>
                                        <span>available: </span><span>{{$pa['available']}}</span>
                                        <span>sold: </span><span>{{$pa['sold']}}</span>
                                    </div>
                                @if($loop->last == '')
                                     <div class='col-12'><hr></div>
                                @endif
