                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <select class="form-control" id="coupon_type" name="coupon_type" required>
                                        ...
                                        <option value="discount_on_purchase"
                                            {{ $coupon['coupon_type'] == 'discount_on_purchase' ? 'selected' : '' }}>
                                            {{ translate('discount_on_Purchase') }}</option>
                                        <option value="free_delivery"
                                            {{ $coupon['coupon_type'] == 'free_delivery' ? 'selected' : '' }}>
                                            {{ translate('free_Delivery') }}</option>
                                        <option value="first_order"
                                            {{ $coupon['coupon_type'] == 'first_order' ? 'selected' : '' }}>
                                            {{ translate('first_Order') }}</option>
                                        <option value="pooja" {{ $coupon['coupon_type'] == 'pooja' ? 'selected' : '' }}>
                                            {{ translate('pooja') }}</option>
                                        <option value="vippooja"
                                            {{ $coupon['coupon_type'] == 'vippooja' ? 'selected' : '' }}>
                                            {{ translate('vip_pooja') }}</option>
                                        <option value="anushthan"
                                            {{ $coupon['coupon_type'] == 'anushthan' ? 'selected' : '' }}>
                                            {{ translate('anushthan') }}</option>

                                        <option value="offlinepooja"
                                            {{ $coupon['coupon_type'] == 'offlinepooja' ? 'selected' : '' }}>
                                            {{ translate('offlinepooja') }}
                                        </option>
                                        <option value="counselling"
                                            {{ $coupon['coupon_type'] == 'counselling' ? 'selected' : '' }}>
                                            {{ translate('counselling') }}</option>
                                        <option value="event_order"
                                            {{ $coupon['coupon_type'] == 'event_order' ? 'selected' : '' }}>
                                            {{ translate('event_order') }}</option>
                                        <option value="tour_order"
                                            {{ $coupon['coupon_type'] == 'tour_order' ? 'selected' : '' }}>
                                            {{ translate('tour_order') }}</option>
                                    </select>
                                </div>
                                <div class="col-md-6 col-lg-4 form-group">
                                    <label for="name"
                                    ...
                                    <input type="text" name="title" class="form-control" id="title"
                                        value="{{ $coupon['title'] }}" placeholder="{{ translate('title') }}" required>
                                </div>
                                <div class="col-md-6 col-lg-4 form-group">
                                    <label for="name"
                                ...
                                <div class="col-md-6 col-lg-4 form-group first_order">
                                    ...
                                    <select class="form-control" name="coupon_bearer" id="coupon_bearer">
                                        ...
                                        <option value="seller"
                                            {{ $coupon['coupon_bearer'] == 'seller' ? 'selected' : '' }}>
                                            {{ translate('vendor') }}</option>
                                        <option value="inhouse"
                                            {{ $coupon['coupon_bearer'] == 'inhouse' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 col-lg-4 form-group coupon_by first_order">
                                    ...
                                    <select class="js-example-basic-multiple js-states js-example-responsive form-control"
                                        ...
                                        <option value="0" {{ $coupon['seller_id'] == '0' ? 'selected' : '' }}>
                                            {{ translate('all_Vendor') }}</option>
                                        @if ($coupon['coupon_bearer'] == 'inhouse')
                                            <option value="inhouse" {{ is_null($coupon['seller_id']) ? 'selected' : '' }}>
                                                {{ translate('inhouse') }}</option>
                                        @endif
                                        @foreach ($sellers as $seller)
                                            <option value="{{ $seller->id }}"
                                                {{ $coupon['seller_id'] == $seller->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 col-lg-4 form-group coupon_type first_order">
                                    ...
                                    <select class="js-example-basic-multiple js-states js-example-responsive form-control"
                                        ...
                                        <option value="0" {{ $coupon['customer_id'] == '0' ? 'selected' : '' }}>
                                            {{ translate('all_customer') }}</option>
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                {{ $coupon['customer_id'] == $customer->id ? 'selected' : '' }}>
                                ...
                                <input type="hidden" name="limit" min="0" value="1" id="coupon_limit"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" max="1000000" step=".01"
                                        name="min_purchase" class="form-control" id="minimum purchase"
                                ...
                                <div class="col-md-6 col-lg-4 form-group free_delivery" ids="max-discount">
                                    ...
                                    <input type="number" min="0" max="1000000" step=".01"
                                        name="max_discount" class="form-control" id="maximum discount"
