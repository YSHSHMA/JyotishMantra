...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            @if (Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'add'))
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-4 form-group">
                                        ...
                                        <select class="form-control" id="coupon_type" name="coupon_type" required>
                                            ...
                                            <option value="discount_on_purchase">{{ translate('discount_on_Purchase') }}
                                            </option>
                                            ...
                                            <option value="vippooja">{{ translate('vip_pooja') }}</option>
                                            <option value="anushthan">{{ translate('anushthan') }}</option>

                                            <option value="offlinepooja">{{ translate('offlinepooja') }}</option>
                                            <option value="counselling">{{ translate('counselling') }}</option>
                                            <option value="event_order">{{ translate('event_order') }}</option>
                                            <option value="tour_order">{{ translate('tour_order') }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 col-lg-4 form-group">
                                        <label for="name"
                                    ...
                                    <div class="col-md-6 col-lg-4 form-group">
                                        ...
                                        <input type="text" name="code" value="" class="form-control"
                                            id="code" placeholder="{{ translate('ex') }}: EID100" required>
                                    </div>
                                    ...
                                    <input type="hidden" name="limit" value="1" min="0" id="coupon_limit"
                                        class="form-control" placeholder="{{ translate('ex') }}: 10">
                                    {{-- </div> --}}
                                    <div class="col-md-6 form-group free_delivery">
                                        <label for="name"
                                    ...
                                    <div class="col-md-6 col-lg-4 form-group free_delivery" ids="max-discount">
                                        <label for="name"
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    @if (Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'status'))
                                        <th>{{ translate('status') }}</th>
                                    @endif
                                    @if (Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'detail') ||
                                            Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'edit') ||
                                            Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'delete'))
                                ...
                                @foreach ($coupons as $key => $coupon)
                                    <tr>
                                        ...
                                        <td class="text-capitalize">
                                            {{ translate(str_replace('_', ' ', $coupon['coupon_type'])) }}</td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <span class="ml-1">{{ translate('used') }}:
                                                @if ($coupon['coupon_type'] == 'pooja')
                                                    <strong>{{ $coupon['service_order_count'] }}</strong>
                                                @elseif($coupon['coupon_type'] == 'counselling')
                                                    <strong>{{ $coupon['service_order_count'] }}</strong>
                                                @elseif($coupon['coupon_type'] == 'special_pooja')
                                                    <strong>{{ $coupon['service_order_count'] }}</strong>
                                                ...
                                                @elseif($coupon['coupon_type'] == 'offlinepooja')
                                                    <strong>{{ $coupon['offlinepoojaorder_count'] }}</strong>
                                                @elseif($coupon['coupon_type'] == 'tour_order')
                                                    <strong>{{ $coupon['tourorder_count'] }}</strong>
                                                @elseif($coupon['coupon_type'] == 'event_order')
                                                    <strong>{{ $coupon['eventorder_count'] }}</strong>
                                                @else
                                                    <strong>{{ $coupon['order_count'] }}</strong>
                                                @endif
                                            </span>
                                        </td>
                                        <td>{{ $coupon['coupon_bearer'] == 'inhouse' ? 'admin' : $coupon['coupon_bearer'] }}
                                        </td>
                                        @if (Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'status'))
                                            <td>
                                                <form
                                                    ...
                                                    <label class="switcher">
                                                        <input type="checkbox"
                                                            ...
                                                            id="coupon_status{{ $coupon['id'] }}" name="status"
                                        ...
                                        @if (Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'detail') ||
                                            ...
                                            <td>
                                                <div class="d-flex gap-10 justify-content-center">
                                                    @if (Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'detail'))
                                                        <button
                                                            class="btn btn-outline--primary square-btn btn-sm mr-1 get-quick-view"
                                                            data-id="{{ $coupon['id'] }}">
                                                    ...
                                                    @if (Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'edit'))
                                                    ...
                                                    @if (Helpers::modules_permission_check('Offers & Setup', 'Coupon Setup', 'delete'))
