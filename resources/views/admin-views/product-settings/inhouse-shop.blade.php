...
@section('content')
    <div class="content container-fluid">
        ...
        @if (Helpers::modules_permission_check('Business Setup', 'In-House Shop', 'temporary-close'))
        <div class="card mb-3">
            <div class="card-body">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-3 justify-content-between mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        @if (Helpers::modules_permission_check('Business Setup', 'In-House Shop', 'vacation-mode'))
                        <button class="btn btn-outline--primary" data-toggle="modal" data-target="#vacation_mode_modal">
                            {{ translate('go_to_Vacation_Mode') }}
                        </button>
                        @endif
                        @if (Helpers::modules_permission_check('Business Setup', 'In-House Shop', 'edit'))
                ...
                @if ($minimumOrderAmountStatus || $free_delivery_status)
                    <div class="mt-5">
                        <form action="{{ route('admin.product-settings.inhouse-shop') }}" method="POST"
                            ...
                            @if (Helpers::modules_permission_check('Business Setup', 'In-House Shop', 'add'))
