...
<div class="content container-fluid">
    ...
    <div class="row">
        @if($getissues)
        @foreach($getissues as $v_type)
        <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
            <a class="order-stats order-stats_confirmed">
                <div class="order-stats__content">
                    <i class="tio-all_done">all_done</i>
                    <h6 class="order-stats__subtitle">{{ ucwords($v_type['issue_name']??'')}}</h6>
                </div>
                <span class="order-stats__title">{{ \App\Models\SupportTicket::where('ticket_issue_id',$v_type['id'])->count()}} </span>
            </a>
        </div>
        @endforeach
        @endif
                            ...
                            <div class="media gap-3">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 align-items-center">
                                        ...
                                        <h6 class="mb-0">{{ \App\Models\SupportIssue::where('id',($ticket->ticket_issue_id??''))->first()['issue_name']??"" }}</h6>
                                    </div>
