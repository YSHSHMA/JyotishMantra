...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.jaap.update', [$jaap['id']]) }}"
                        ...
                        <ul class="nav nav-tabs w-fit-content mb-4">
                          ...
                          <div class="row mb-3">
                            <div class="col-md-8">
                                 @foreach ($language as $lang)
                                        <?php
                                        if (count($jaap['translations'])) {
                                            $translate = [];
                                            foreach ($jaap['translations'] as $translations) {
                                                if ($translations->locale == $lang && $translations->key == 'name') {
                                                    $translate[$lang]['name'] = $translations->value;
                                                }

                                                if ($translations->locale == $lang && $translations->key == 'mantra') {
                                                    $translate[$lang]['mantra'] = $translations->value;
                                                }
                                ...
                                <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                                    <div class="form-group">
                                        ...
                                        value="{{ $lang == $defaultLanguage ? $jaap['name'] : $translate[$lang]['name'] ?? '' }}"
                                    ...
                                    <div class="form-group">
                                        <label class="title-color" for="mantra">{{ translate('Mantra') }} ({{strtoupper($lang)}})</label>
                                        <input type="text" name="mantra[]"
                                        value="{{ $lang == $defaultLanguage ? $jaap['mantra'] : $translate[$lang]['mantra'] ?? '' }}"
                                        class="form-control" id="mantra"
                                        placeholder="{{ translate('ex') }} : {{ translate('Mantra') }}"
                                        {{ $lang == $defaultLanguage ? 'required' : '' }}>
