                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Pooja Managment', 'VIP Pooja', 'edit') ||
                                                ...
                                                Helpers::modules_permission_check('Pooja Managment', 'VIP Pooja', 'prashad') ||
                                                Helpers::modules_permission_check('Pooja Managment', 'VIP Pooja', 'whatsapp'))
                                            ...
                                            @if (Helpers::modules_permission_check('Pooja Managment', 'VIP Pooja', 'edit') ||
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        @if (Helpers::modules_permission_check('Pooja Managment', 'VIP Pooja', 'prashad'))
                                                        ...
                                                        @if (Helpers::modules_permission_check('Pooja Managment', 'VIP Pooja', 'whatsapp'))
