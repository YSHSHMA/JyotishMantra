                            ...
                            <table id="myTable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja', 'status'))
                                        <th class="text-center">{{ translate('status') }}</th>
                                        @endif
                                        @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja', 'whatsapp') || Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja', 'edit') || Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja', 'delete'))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja', 'edit'))
                                                    ...
                                                    @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja', 'delete'))
                                                    ...
                                                    @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja', 'whatsapp'))
