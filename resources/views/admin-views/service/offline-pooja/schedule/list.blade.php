...
@section('content')
    <div class="content container-fluid">
        ...
        @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja Schedule', 'add'))
        <div class="row mt-20">
            <div class="col-md-12">
                            ...
                            <table id="myTable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja Schedule', 'status'))
                                        <th class="text-center">{{ translate('status') }}</th>
                                        @endif
                                        @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja Schedule', 'edit') || Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja Schedule', 'delete'))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja Schedule', 'edit'))
                                                    ...
                                                    @if (Helpers::modules_permission_check('Pooja Managment', 'Offline Pooja Schedule', 'delete'))
