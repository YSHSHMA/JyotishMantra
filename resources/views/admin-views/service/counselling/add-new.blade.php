...
@section('title', translate('Counsultation|auspicious_moment'))

@push('css_or_js')
    <link href="{{ dynamicAsset(path: 'public/assets/back-end/css/tags-input.min.css') }}" rel="stylesheet">
    <link href="{{ dynamicAsset(path: 'public/assets/select2/css/select2.min.counselling.css') }}" rel="stylesheet">
    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{ translate('add_new_counsultation_/_auspicious_moment') }}
            </h2>
        </div>

        <form class="product-form text-start" action="{{ route('admin.service.counselling.add-new') }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="product_type" placeholder="Product Type" value="counselling">
            <div class="card">
                <div class="px-4 pt-3">
                        ...
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label
                                        class="title-color"for="{{ $lang }}_name">{{ translate('counsultation / auspicious') }}
                                        ({{ strtoupper($lang) }})
                                    </label>
                                    <input type="text" {{ $lang == $defaultLanguage ? 'required' : 'required' }} name="name[]"
                                        id="{{ $lang }}_name" class="form-control" placeholder="{{ translate('counsultation / auspicious') }}">
                                </div>
                            </div>
                            <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="about-counselling-{{ $lang }}-tab"
                                        data-toggle="pill" data-target="#about-counselling-{{ $lang }}"
                                        type="button" role="tab" aria-controls="about-counselling-{{ $lang }}"
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="about-counselling-{{ $lang }}"
                                    role="tabpanel" aria-labelledby="about-counselling-{{ $lang }}-tab">
                                    <label class="title-color"
                                        for="{{ $lang }}_description">{{ translate('about') }}
                                        ({{ strtoupper($lang) }})</label>
                                    <textarea class="ckeditor" id="editor{{ $lang }}" name="description[]" {{ $lang == $defaultLanguage ? 'required' : 'required' }}>{{ old('details') }}</textarea>
                                </div>
                                ...
                                <div class="tab-pane fade" id="process-{{ $lang }}" role="tabpanel"
                                    ...
                                    <label class="title-color"
                                        ...
                                        ({{ strtoupper($lang) }})</label>
                                    <textarea class="ckeditor" id="editor{{ $lang }}" name="process[]" {{ $lang == $defaultLanguage ? 'required' : 'required' }}></textarea>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="counselling_main_price" id="main-price" class="form-control"
                                    placeholder="Main Price" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color">{{ translate('selling_price') }}</label>
                        ...
                        {{-- <div class="col-md-6" id="digital_file_ready_show">
                            <div class="form-group">
                                ...
                                <div class="mt-2" style="font-size: 13px;">{{ translate('file_type') }}:
                                    {{ 'jpg, jpeg, png, gif, zip, pdf' }}</div>
                            </div>
                        </div> --}}
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control action-get-request-onchange"
                                    name="product_id[]" data-element-id="sub-category-select" data-element-type="select" multiple>
                                    <option value="" disabled>Select Product</option>
                                    @foreach ($productes as $product)
                                        @if ($product->category_id == 37)
