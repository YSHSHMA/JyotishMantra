            ...
            <div class="card-body">
                <form action="{{ route('admin.business-settings.shipping-method.update-shipping-responsibility') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        @if (Helpers::modules_permission_check('Business Setup', 'Business Setting', 'shipping-save'))
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <form action="{{route('admin.business-settings.shipping-method.index')}}" method="post">
                        ...
                        @if (Helpers::modules_permission_check('Business Setup', 'Business Setting', 'order-wise-shipping-save'))
                        <div class="d-flex justify-content-end gap-10">
                ...
                <div class="table-responsive pb-3">
                    <table
                        ...
                        <tr>
                            ...
                            @if (Helpers::modules_permission_check('Business Setup', 'Business Setting', 'order-wise-status'))
                            <th class="text-center">{{translate('status')}}</th>
                            @endif
                            @if (Helpers::modules_permission_check('Business Setup', 'Business Setting', 'order-wise-shipping-edit') || Helpers::modules_permission_check('Business Setup', 'Business Setting', 'order-wise-shipping-delete'))
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-wrap justify-content-center gap-10">
                                        @if (Helpers::modules_permission_check('Business Setup', 'Business Setting', 'order-wise-shipping-edit'))
                                        ...
                                        @endif
                                        @if (Helpers::modules_permission_check('Business Setup', 'Business Setting', 'order-wise-shipping-delete'))
