...
@section('title', translate('rashi_Add'))
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.rashi.add-new') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="title-color">
                                            {{ translate('rashi_Logo') }}<span class="text-danger">*</span>
                                        </label>
