...
@section('title', translate('VIP_Anushthan_template_create'))
@push('css_or_js')
@endpush
@section('content')
                ...
                <div class="mb-3">
                    <h2 class="h1 mb-0 d-flex gap-2">
                        <img width="20" src="{{ dynamicAsset(path: 'public/assets/back-end/img/whatsapp.png') }}"
                            alt="">
                        {{ translate('VIP_Anushthan_create_templates') }}
                    </h2>
                </div>
            </div>
        </div>
                ...
                <div class="card" style="min-height: 350px">
                    <div class="card-header d-flex justify-content-between">
                        <div class="card-title mb-0">
                            <h5 class="mb-0">{{ translate('VIP_Anushthan_Order_Management') }}</h5>
                        </div>
                    </div>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        @foreach ($whatsapp as $key => $whats)
                            <div class="tab-pane fade show @if ($key == 0) {{ 'active' }} @endif"
                                ...
                                <form method="post" action="{{ route('admin.whatsapp.vip-anushthan-template-update', $whats['id']) }}"
