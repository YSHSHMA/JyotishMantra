...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            @if (Helpers::modules_permission_check('Offers & Setup', 'Deal Of The Day', 'add'))
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                            ...
                            <tr>
                                ...
                                @if (Helpers::modules_permission_check('Offers & Setup', 'Deal Of The Day', 'status'))
                                <th>{{ translate('status')}}</th>
                                @endif
                                @if (Helpers::modules_permission_check('Offers & Setup', 'Deal Of The Day', 'edit') || Helpers::modules_permission_check('Offers & Setup', 'Deal Of The Day', 'delete'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-10">
                                            @if (Helpers::modules_permission_check('Offers & Setup', 'Deal Of The Day', 'edit'))
                                            <a title="{{ trans ('edit')}}"
                                            ...
                                            @endif
                                            @if (Helpers::modules_permission_check('Offers & Setup', 'Deal Of The Day', 'delete'))
