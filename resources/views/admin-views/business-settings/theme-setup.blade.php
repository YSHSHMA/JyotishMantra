...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="card-body pl-md-10">
                ...
                <form enctype="multipart/form-data" id="theme-form">
                    ...
                    <div class="row g-3">
                        ...
                        @if (Helpers::modules_permission_check('System Setup', 'Themes & Addons', 'theme-save'))
        ...
        <div class="card mb-5 p-xl-4">
            ...
            @if (Helpers::modules_permission_check('System Setup', 'Themes & Addons', 'theme-select'))
                                                        ...
                                                        <div class="modal-body px-4 px-sm-5 text-center">
                                                            ...
                                                            <div class="d-flex justify-content-center gap-3 mb-3">
                                                                ...
                                                                <button type="button" class="fs-16 btn btn--primary px-sm-5 theme-publish"
                                                                        data-dismiss="modal" data-key="{{ $key }}">{{ translate('yes') }}
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <span id="get-theme-install-route" data-action="{{route('admin.business-settings.web-config.theme.install')}}"></span>
    <span id="get-theme-publish-route" data-action="{{route('admin.business-settings.web-config.theme.publish')}}"></span>
