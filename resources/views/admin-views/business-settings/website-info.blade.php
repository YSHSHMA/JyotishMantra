                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{translate('company_GST')}}</label>
                                <input class="form-control" type="text" name="company_gst"
                                       value="{{ $businessSetting['company_gst'] }}"
                                       placeholder="{{translate('new_business')}}">
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{translate('company_PAN')}}</label>
                                <input class="form-control" type="text" name="company_pan"
                                       value="{{ $businessSetting['company_pan'] }}"
                                       placeholder="{{translate('new_business')}}">
                            </div>
                        </div>
                        <div class="col-12">
