        ...
        <div class="card overflow-hidden">
            <form action="{{route('admin.social-media-chat.update',['whatsapp'])}}" method="post">
                ...
                <div class="card-header mb-3">
                    ...
                    @if (Helpers::modules_permission_check('3rd Party', 'Other Configuration', 'social-media-chat-active'))
                ...
                <div class="card-body text-start">
                    @if($whatsapp)
                        ...
                        @if (Helpers::modules_permission_check('3rd Party', 'Other Configuration', 'social-media-chat-save'))
