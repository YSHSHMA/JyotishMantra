                ...
                <div class="card">
                    <div class="px-3 py-4">
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            ...
                            @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'language-add'))
                    ...
                    <div class="table-responsive pb-3">
                        <table
                            ...
                            <tr>
                                ...
                                @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'language-status'))
                                <th class="text-center">{{translate('status')}}</th>
                                @endif
                                @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'language-default-status'))
                                <th class="text-center">{{translate('default_status')}}</th>
                                @endif
                                @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'language-edit') || Helpers::modules_permission_check('System Setup', 'System Setting', 'language-delete') || Helpers::modules_permission_check('System Setup', 'System Setting', 'language-translate'))
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                @if($data['code']!='en')
                                                @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'language-edit'))
                                                    <a class="dropdown-item" data-toggle="modal"
                                                       data-target="#lang-modal-update-{{$data['code']}}">{{translate('update')}}</a>
                                                       @endif
                                                       @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'language-delete'))
                                                    @if ($data['default'] === true)
                                                        <a class="dropdown-item default-language-delete-alert"
                                                           ...
                                                           @endif
                                                @endif
                                                @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'language-translate'))
