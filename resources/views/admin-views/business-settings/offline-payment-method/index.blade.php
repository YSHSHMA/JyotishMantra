...
@php use App\Utils\Helpers; @endphp@extends('layouts.back-end.app')
                ...
                <div class="card">
                    <div class="px-3 py-4">
                        <div class="row g-2 flex-grow-1">
                            ...
                            @if (Helpers::modules_permission_check('3rd Party', 'Payment Method', 'offline-payment-add'))
                            ...
                            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100">
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('3rd Party', 'Payment Method', 'offline-payment-status'))
                                        <th class="text-center">{{ translate('status') }}</th>
                                        @endif
                                        @if (Helpers::modules_permission_check('3rd Party', 'Payment Method', 'offline-payment-edit') || Helpers::modules_permission_check('3rd Party', 'Payment Method', 'offline-payment-delete'))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    @if (Helpers::modules_permission_check('3rd Party', 'Payment Method', 'offline-payment-edit'))
                                                    ...
                                                    @endif
                                                    @if (Helpers::modules_permission_check('3rd Party', 'Payment Method', 'offline-payment-delete'))
