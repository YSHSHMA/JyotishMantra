                            ...
                            <form action="{{route('admin.business-settings.mail.update')}}" method="post">
                                ...
                                @if(isset($data_smtp))
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if (Helpers::modules_permission_check('3rd Party', 'Other Configuration', 'mail-config-save'))
                            ...
                            <div class="row">
                                <div class="col-xl-8 col-lg-10">
                                    <div class="d-flex align-items-end gap-2 gap-sm-3">
                                        ...
                                        @if (Helpers::modules_permission_check('3rd Party', 'Other Configuration', 'mail-config-send'))
