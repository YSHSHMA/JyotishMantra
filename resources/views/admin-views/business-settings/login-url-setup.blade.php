            ...
            <form action="{{route('admin.business-settings.web-config.login-url-setup')}}" method="post">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body"
                        ...
                        @if (Helpers::modules_permission_check('System Setup', 'Logging Setting', 'admin-url-save'))
            ...
            <form action="{{route('admin.business-settings.web-config.login-url-setup')}}" method="post">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body"
                        ...
                        @if (Helpers::modules_permission_check('System Setup', 'Logging Setting', 'employee-url-save'))
                        <div class="d-flex justify-content-end">
                            <button type="submit" id="submit"
                                class="btn btn--primary px-4">{{translate('submit')}}</button>
                        </div>
