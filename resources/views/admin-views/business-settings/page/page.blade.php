                    ...
                    <form action="{{route('admin.business-settings.page-update', [$page])}}" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <textarea class="form-control summernote ckeditor" id="editor"
                                    name="value">{{ $page_data['content'] }}</textarea>
                            </div>
                            @if (Helpers::modules_permission_check('Page & Media', 'Business Pages', 'refund-policy-save') || Helpers::modules_permission_check('Page & Media', 'Business Pages', 'return-policy-save') || Helpers::modules_permission_check('Page & Media', 'Business Pages', 'cancellation-policy-save'))
                            <div class="form-group">
