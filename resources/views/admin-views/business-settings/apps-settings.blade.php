            ...
            <div class="card-body">
                <form action="{{ route('admin.business-settings.web-config.app-settings') }}" method="post">
                    ...
                    <div class="row g-2">
                        ...
                        @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'user-app-save'))
                        <div class="col-12">
            ...
            <div class="card-body">
                <form action="{{ route('admin.business-settings.web-config.app-settings') }}" method="post">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12">
                            @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'vendor-app-save'))
                            <div class="d-flex flex-wrap justify-content-end gap-3">
                                <button type="reset" class="btn btn-secondary px-5">{{translate('reset')}}</button>
                                <button type="submit" class="btn btn--primary px-5">{{translate('save')}}</button>
                            </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.business-settings.web-config.app-settings') }}" method="post">
                    ...
                    <div class="row g-2">
                        ...
                        @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'delivery-man-app-save'))
                        <div class="col-12">
                            <div class="d-flex flex-wrap justify-content-end gap-3">
                                <button type="reset" class="btn btn-secondary px-5">{{translate('reset')}}</button>
                                <button type="submit" class="btn btn--primary px-5">{{translate('save')}}</button>
