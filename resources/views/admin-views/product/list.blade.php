                    ...
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                @if($type == 'in_house')
                                @if (Helpers::modules_permission_check('In-House Product', 'Product', 'limited-stock'))
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                @if (Helpers::modules_permission_check('In-House Product', 'Product', 'featured-status'))
                                <th class="text-center">{{ translate('show_as_featured') }}</th>
                                @endif
                                @if (Helpers::modules_permission_check('In-House Product', 'Product', 'status'))
                                <th class="text-center">{{ translate('active_status') }}</th>
                                @endif
                                @if (Helpers::modules_permission_check('In-House Product', 'Product', 'bar-code') || Helpers::modules_permission_check('In-House Product', 'Product', 'edit') || Helpers::modules_permission_check('In-House Product', 'Product', 'delete') || Helpers::modules_permission_check('In-House Product', 'Product', 'detail'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            @if (Helpers::modules_permission_check('In-House Product', 'Product', 'bar-code'))
                                            ...
                                            @endif
                                            @if (Helpers::modules_permission_check('In-House Product', 'Product', 'detail'))
                                            ...
                                            @endif
                                            @if (Helpers::modules_permission_check('In-House Product', 'Product', 'edit'))
                                            ...
                                            @endif
                                            @if (Helpers::modules_permission_check('In-House Product', 'Product', 'delete'))
