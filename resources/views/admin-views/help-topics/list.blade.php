            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if (Helpers::modules_permission_check('Page & Media', 'Business Pages', 'faq-add'))
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tr>
                                    ...
                                    @if (Helpers::modules_permission_check('Page & Media', 'Business Pages', 'faq-status'))
                                    <th class="text-center">{{translate('status')}} </th>
                                    @endif
                                    @if (Helpers::modules_permission_check('Page & Media', 'Business Pages', 'faq-edit') || Helpers::modules_permission_check('Page & Media', 'Business Pages', 'faq-delete'))
                                    ...
                                    <tr id="data-{{$help->id}}">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-10">
                                                @if (Helpers::modules_permission_check('Page & Media', 'Business Pages', 'faq-edit'))
                                                ...
                                                @endif
                                                @if (Helpers::modules_permission_check('Page & Media', 'Business Pages', 'faq-delete'))
