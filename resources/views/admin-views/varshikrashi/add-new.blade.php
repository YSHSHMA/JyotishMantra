      ...
      <div class="col-md-12">
         <div class="card mb-3">
            <div class="card-body text-start">
               <form action="{{ route('admin.varshikrashi.add-new') }}" method="post" enctype="multipart/form-data">
                  @csrf
