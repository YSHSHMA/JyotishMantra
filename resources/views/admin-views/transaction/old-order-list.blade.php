            ...
            <div class="table-responsive">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{translate('vendor_income')}}</th>
                        <th>{{translate('shipping_refund')}}</th>
                    ...
                    @php
                        $refund = \App\Models\RefundRequest::where('order_id', $transaction->order_id)->first();
                    @endphp
                        @if($transaction->order)
                            <tr>
                                ...
                                <td>{{ \App\Models\OrderDetail::where('order_id', $transaction['order_id'])->value('tax_model') }}</td>
                                ...
                                <td>{{ $refund ? $refund->delivery_charge : '-' }}</td>
                               <td>
                                    {{ setCurrencySymbol(
                                        usdToDefaultCurrency(
                                            $seller_net_income - $seller_shipping_discount - ($refund->delivery_charge ?? 0)
                                        ),
                                        getCurrencyCode()
                                    ) }}
                                </td>
