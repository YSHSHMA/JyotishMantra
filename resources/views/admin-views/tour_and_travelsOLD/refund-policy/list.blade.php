                        ...
                        <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                           ...
                           <div class="col-md-4">
                                 ...
                                 <select name="type" class="form-control tour_type" onchange="$('.tour_type').val(this.value)" {{$lang == $defaultLanguage? 'required':''}}>
                                    ...
                                    <option value="cities_tour" {{ (( old('type') == 'cities_tour' )?'selected':'' )}}> cities tour</option>
                                    <option value="special_tour" {{ (( old('type') == 'special_tour' )?'selected':'' )}}>special tour</option>
                                 </select>
                              </div>
                              <div class="col-md-4">
                              ...
                              <input type="text" name="day" class="form-control days_refund" onkeyup="$('.days_refund').val(this.value)" value="{{ old('day')}}" placeholder="{{ translate('Enter_Refund_day') }}" {{$lang == $defaultLanguage? 'required':''}}>
                             </div>
                              <div class="col-md-12">
         ...
         if (result.value) {
            ...
            $.ajax({
               ...
               success: function (response) {
                  ...
                  toastr.success("{{translate('Tour_refund_policy_deleted_successfully')}}", '', { positionClass: 'toast-bottom-left' });
                  // Reload the page
                  location.reload();
               },
