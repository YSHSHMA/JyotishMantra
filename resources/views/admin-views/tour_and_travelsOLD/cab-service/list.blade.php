                  ...
                  <div class="row">
                     <div class="col-md-8">
                        ...
                        <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form"
                           ...
                           <input type="text" name="name[]" class="form-control" placeholder="{{ translate('enter_cab_name') }}" {{$lang == $defaultLanguage? 'required':''}}>
         ...
         if (result.value) {
            ...
            $.ajax({
               ...
               success: function (response) {
                  ...
                  toastr.success('Tour Package deleted successfully', '', { positionClass: 'toast-bottom-left' });
                  // Reload the page
                  location.reload();
               },
