...
<div class="content container-fluid">
    <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
        <h2 class="h1 mb-0 d-flex gap-2">
            ...
            {{ translate('add_temple_category') }}
        </h2>
    </div>

    <form class="product-form text-start" action="{{ route('admin.temple.category.add') }}" method="POST" enctype="multipart/form-data" id="services_form">
        @csrf
        <div class="card">
            <div class="px-4 pt-3">
                            ...
                            <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form" id="{{ $lang }}-form">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" {{ $lang == $defaultLanguage ? 'required' : '' }} name="name[]" id="{{ $lang }}_name" class="form-control" placeholder="{{ translate('temple_category_name') }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
