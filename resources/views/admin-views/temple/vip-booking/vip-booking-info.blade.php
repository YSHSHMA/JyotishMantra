                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $val['phone']??"-//-" }}</td>
                                            <td>{{ $val['aadhar']??'' }}</td>
                                            <td>{{ (($val['verify']==0)?'Not Available':'Available') }}</td>
                                            <td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-6">Name</div><div class="col-6"><span class="user_full_name"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">phone</div><div class="col-6"><span class="user_phone_number"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">Aadhar Number</div><div class="col-6"><span class="user_aadhar_number"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">Date Of Brith</div><div class="col-6"><span class="user_bod"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">Gender</div><div class="col-6"><span class="user_gender"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">Country</div><div class="col-6"><span class="user_country"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">State</div><div class="col-6"><span class="user_state"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">City</div><div class="col-6"><span class="user_city"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">village</div><div class="col-6"><span class="user_village"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">landmark</div><div class="col-6"><span class="user_landmark"></span></div>
                    <div class="col-12"><hr></div>
                    <div class="col-6">zip code</div><div class="col-6"><span class="user_zip_code"></span></div>
                </div>
            </div>
