...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.temple.hotel.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <!-- Language tabs -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="row {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                                <div class='col-md-6 form-group'>
                                    ...
                                    <input type="text" name="hotel_name[]" class="form-control getAddress_google" id="{{$lang}}_hotel_name" autocomplete="off" placeholder="{{ translate('Hotel_name') }}" required="{{ $lang == $defaultLanguage? 'required':''}}" data-option='{{$key}}'>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="cities_id" class="js-select2-custom form-control City_select_geolocation">
                                        ...
                                        <option value="{{$va->id}}">{{ $va->city}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="title-color" for="name">{{ translate('zipcode') }}<span class="text-danger">*</span>
                                        ({{ strtoupper($lang) }})</label>
                                    <input type="text" name="zipcode" class="form-control zipcode" id="{{$lang}}_zipcode" placeholder="{{ translate('Zipcode') }}" autocomplete="off" required="{{$lang == $defaultLanguage? 'required':''}}">
                                </div>

                                <div class="col-md-6 form-group">
                                    <label class="title-color" for="phone_number">{{ translate('phone_number') }}<span class="text-danger">*</span>
                                        ({{ strtoupper($lang) }})</label>
                                    <input type="text" name="phone_no" class="form-control showallData" data-point='1' id="{{$lang}}_phone_number" placeholder="{{ translate('phone_number') }}" autocomplete="off" required="{{$lang == $defaultLanguage? 'required':''}}"  oninput="this.value = this.value.replace(/\D/g, '').slice(0, 12)">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="title-color" for="email">{{ translate('email_id') }}<span class="text-danger">*</span>
                                        ({{ strtoupper($lang) }})</label>
                                    <input type="email" name="email_id" class="form-control showallData" data-point='2' id="{{$lang}}_email" placeholder="{{ translate('email_id') }}" autocomplete="off" required="{{$lang == $defaultLanguage? 'required':''}}">
                                    <input type="hidden" name="lang[]" value="{{$lang}}" id="lang">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="title-color" for="email">{{ translate('Website_link') }}<span class="text-danger">*</span>
                                        ({{ strtoupper($lang) }})</label>
                                    <input type="text" name="website_link" class="form-control showallData" data-point='3' id="{{$lang}}Website_link" placeholder="{{ translate('Website_link') }}" autocomplete="off" required="{{$lang == $defaultLanguage? 'required':''}}">
