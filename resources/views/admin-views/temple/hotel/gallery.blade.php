...
@section('title', translate('Hotel_gallery'))
@section('content')
                                            ...
                                            <div class="coba-area">
                                                ...
                                                <div class="col-sm-12 col-md-4">
                                                        <div
                                                            ...
                                                            <input type="file" name="images[]" onchange="filesManager(this)"
                                                        ...
                                                        @foreach (json_decode($getData['images']) as $unique_id => $photo)
                                                            ...
                                                            <div class="col-sm-12 col-md-4">
                                                                <div class="custom_upload_input custom-upload-input-file-area position-relative border-dashed-2">
                                                                    ...
                                                                    <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn" href="{{ route('admin.temple.hotel.delete-image', ['id' => $getData['id'], 'name' => $photo]) }}">
                                                                        <i class="tio-delete"></i>
                                                                    </a>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img id="additional_Image_{{ $unique_id }}"  alt="" class="h-auto aspect-1 bg-white onerror-add-class-d-none"
                                                                            src="{{ getValidImage(path: 'storage/app/public/temple/hotel/' . $photo, type: 'backend-product') }}">
                                                                    </div>
                                                                    <div
                                                                        class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                                        <div
...
function filesManager(that){
        ...
        $.ajax({
                url:'{{ route("admin.temple.hotel.gallery_add",[$hotel_id])}}',
