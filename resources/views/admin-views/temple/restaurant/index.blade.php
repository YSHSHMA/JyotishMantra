...
@section('title', translate('add_Restaurant'))
@push('css_or_js')
...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.temple.restaurants.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <!-- Language tabs -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="row {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                                <div class='col-md-6 form-group'>
                                    ...
                                    <input type="text" name="restaurant_name[]" class="form-control getAddress_google" id="{{$lang}}_restaurant_name" autocomplete="off" placeholder="{{ translate('restaurant_name') }}" required="{{ $lang == $defaultLanguage? 'required':''}}" data-option='{{$key}}'>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type='text' class="form-control opentime" readonly name="open_time">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="title-color" for="name">{{ translate('close_time') }}<span class="text-danger">*</span></label>
                                    <input type='text' class="form-control closetime" readonly name="close_time">
                                </div>

                                <div class="col-md-12 form-group">
                                    <label class="title-color" for="name">{{ translate('youtube_video') }}<span class="text-danger">*</span></label>
                                    <input class="form-control showallData" name="youtube_video" data-point='4'  placeholder="{{ translate('youtube_video') }}" require>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <textarea class="ckeditor form-control" name="menu_highlights[]" ></textarea>
                                </div>
                                <div class="col-md-12 form-group">
                                    <label class="title-color" for="name">{{ translate('more_details') }}<span class="text-danger">*</span> ({{ strtoupper($lang) }})</label>
                                    <textarea class="ckeditor form-control" name="more_details[]"></textarea>
                                </div>
                            </div>
                            @endforeach
                        </div>
