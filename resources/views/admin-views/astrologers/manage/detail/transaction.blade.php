                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $companyReceived = $trans['total_amount'] - $adminCommission - $govtTax - $trans['total_pandit_amount'];

                                                            $totalOrderAmt += (float) $trans['total_amount'];
                                                            $totalCommissionAmt +=
                                                                (float) $adminCommission;
                                                            $totalTaxAmt += (float) $govtTax;
                                                            $totalPanditAmt += (float) $trans['total_pandit_amount'];
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> {{ $govtTax }}</td>
                                                            <td>{{ $trans['total_pandit_amount'] }}</td>
