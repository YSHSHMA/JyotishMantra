...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.self-driving-management.self-driving-update',[$getData['id']]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <!-- Language tabs -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="traveller_id" class="form-control traveller_ids" onchange="$('.traveller_ids').val(this.value)" required>
                                                ...
                                                <option value="{{ $va['id'] }}" {{ ((old('traveller_id',$getData['traveller_id']) == $va['id'])?'selected':'')}}>{{ $va['company_name'] }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
