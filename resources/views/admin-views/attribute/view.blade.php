...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            @if (Helpers::modules_permission_check('Attribute Setup', 'Attribute Setup', 'add'))
                            ...
                            <table id="datatable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Attribute Setup', 'Attribute Setup', 'edit') ||
                                                Helpers::modules_permission_check('Attribute Setup', 'Attribute Setup', 'delete'))
                                ...
                                <tbody>
                                    @foreach ($attributes as $key => $attribute)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ Str::limit($attribute['defaultname'], 20) }}</td>
                                            @if (Helpers::modules_permission_check('Attribute Setup', 'Attribute Setup', 'edit') ||
                                                    Helpers::modules_permission_check('Attribute Setup', 'Attribute Setup', 'delete'))
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        ...
                                                        @if (Helpers::modules_permission_check('Attribute Setup', 'Attribute Setup', 'delete'))
