...
@section('content')
    <div class="content container-fluid">
        ...
        @if (Helpers::modules_permission_check('Category Setup', 'Sub Sub Category', 'add'))
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                            ...
                            <tr>
                                ...
                                @if (Helpers::modules_permission_check('Category Setup', 'Sub Sub Category', 'edit') || Helpers::modules_permission_check('Category Setup', 'Sub Sub Category', 'delete'))
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            @if (Helpers::modules_permission_check('Category Setup', 'Sub Sub Category', 'edit'))
                                            ...
                                            @if (Helpers::modules_permission_check('Category Setup', 'Sub Sub Category', 'delete'))
