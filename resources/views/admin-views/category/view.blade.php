...
@section('content')
    <div class="content container-fluid">
        ...
        @if (Helpers::modules_permission_check('Category Setup', 'Category', 'add'))
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                ...
                                @if (Helpers::modules_permission_check('Category Setup', 'Category', 'status'))
                                <th class="text-center">{{ translate('home_category_status') }}</th>
                                @endif

                                @if (Helpers::modules_permission_check('Category Setup', 'Category', 'edit') || Helpers::modules_permission_check('Category Setup', 'Category', 'delete'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-10">
                                            @if (Helpers::modules_permission_check('Category Setup', 'Category', 'edit'))
                                            ...
                                            @if (Helpers::modules_permission_check('Category Setup', 'Category', 'delete'))
