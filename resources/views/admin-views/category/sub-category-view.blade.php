...
@section('content')
    <div class="content container-fluid">
        ...
        @if (Helpers::modules_permission_check('Category Setup', 'Sub Category', 'add'))
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                ...
                                @if (Helpers::modules_permission_check('Category Setup', 'Sub Category', 'edit') || Helpers::modules_permission_check('Category Setup', 'Sub Category', 'delete'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            @if (Helpers::modules_permission_check('Category Setup', 'Sub Category', 'edit'))
                                            ...
                                            @if (Helpers::modules_permission_check('Category Setup', 'Sub Category', 'delete'))
