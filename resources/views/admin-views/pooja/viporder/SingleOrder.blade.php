                                    ...
                                    <table id="myTable"
                                        ...
                                        <thead class="thead-light thead-50 text-capitalize">
                                            <tr>
                                                ...
                                                @if (Helpers::modules_permission_check('Vip Order', 'Order By VIP List', 'detail') || Helpers::modules_permission_check('Vip Order', 'Order By VIP List', 'share'))
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">
                                                            @if (Helpers::modules_permission_check('Vip Order', 'Order By VIP List', 'detail'))
                                                            ...
                                                            @endif
                                                            @if (Helpers::modules_permission_check('Vip Order', 'Order By VIP List', 'share'))
                ...
                <div class="row mt-20">
                    <div class="col-md-12">
                        ...
                        <div class="row align-items-center py-2">
                            ...
                            @if (Helpers::modules_permission_check('Vip Order', 'Order By VIP List', 'download-pdf'))
