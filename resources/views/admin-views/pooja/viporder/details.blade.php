...
@section('content')
                    ...
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        @if (!empty($details['pooja_certificate']))
                                <div class="text-center position-relative d-inline-block vip-container">
                                    ...
                                    {{-- EDIT BADGE --}}
                                    @if (Helpers::modules_permission_check('Vip Order', 'Vip Order', 'detail-edit'))
                                        <button
                                            class="btn btn-primary btn-sm vip-edit-badge"
                                            data-toggle="modal"
                                            data-target="#change-vip-certificate-model"
                                    ...
                                    <img src="{{ asset('public/' . $details['pooja_certificate']) }}"
                                        ...
                                        data-toggle="modal"
                                        data-target="#viewVipCertificate"
                                        style="cursor:pointer;">
                                </div>

                                {{-- VIEW IMAGE MODAL --}}
                                <div class="modal fade" id="viewVipCertificate" tabindex="-1" role="dialog">
    ...
    {{-- VIP CERTIFICATE UPDATE MODAL --}}
    <div class="modal fade" id="change-vip-certificate-model" tabindex="-1" role="dialog"
        aria-hidden="true" data-keyboard="false" data-backdrop="static">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title">VIP Pooja Certificate Update</h5>
                        <p style="font-size:14px;color:#555;">
                            You can update the VIP Pooja certificate image here.
                        </p>
                    </div>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.vippooja.order.update-certificate') }}"
                        method="post"
