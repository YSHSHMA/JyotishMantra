            ...
            <div class="col-lg-4 d-flex flex-column gap-3">
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        @if (Helpers::modules_permission_check('Vip Order', 'Order By VIP Detail', 'assign-pandit'))
                ...
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        @if ($details['status'] == 0)
                        @if (Helpers::modules_permission_check('Vip Order', 'Order By VIP Detail', 'order-status'))
                            <div class="">
                                <label
