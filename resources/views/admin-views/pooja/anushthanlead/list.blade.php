                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Anushthan Order', 'Lead', 'delete') ||
                                                ...
                                                Helpers::modules_permission_check('Anushthan Order', 'Lead', 'whatsapp') ||
                                                Helpers::modules_permission_check('Anushthan Order', 'Lead', 'template'))
                                        ...
                                        <tr>
                                            ...
                                            @if (Helpers::modules_permission_check('Anushthan Order', 'Lead', 'delete') ||
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex justify-content-center gap-2 pt-2 w-50">
                                                        @if (Helpers::modules_permission_check('Anushthan Order', 'Lead', 'whatsapp'))
                                                    ...
                                                    @endif
                                                    @if (Helpers::modules_permission_check('Anushthan Order', 'Lead', 'template'))
