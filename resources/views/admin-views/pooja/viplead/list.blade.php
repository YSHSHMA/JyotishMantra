            ...
            <table
              ...
              <thead class="thead-light thead-50 text-capitalize">
                <tr>
                  ...
                  Helpers::modules_permission_check('Vip order', 'Lead', 'whatsapp') ||
                  Helpers::modules_permission_check('Vip order', 'Lead', 'template'))
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="d-flex justify-content-center gap-2 pt-2">
                      @if (Helpers::modules_permission_check('Vip Order', 'Lead', 'whatsapp'))
                      ...
                      @endif
                      @if (Helpers::modules_permission_check('Vip Order', 'Lead', 'template'))
