                            ...
                            <table
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Pooja Order', 'Lead', 'delete') || Helpers::modules_permission_check('Pooja Order', 'Lead', 'follow-up') || Helpers::modules_permission_check('Pooja Order', 'Lead', 'follow-up-history') || Helpers::modules_permission_check('Pooja Order', 'Lead', 'call') || Helpers::modules_permission_check('Pooja Order', 'Lead', 'whatsapp') || Helpers::modules_permission_check('Pooja Order', 'Lead', 'template'))
                                ...
                                <tbody>
                                    @foreach ($leads as $key => $lead)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $lead['leadno'] }}/{{ $lead['order_id'] }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    <!-- <div class="dropdown-menufollow" style="display: none;" id="LeadFollowList-{{ $lead['id'] }}"> -->
                                                        @if (Helpers::modules_permission_check('Pooja Order', 'Lead', 'delete'))
                                                    <a href="{{ route('admin.pooja.orders.lead-delete', ['id' => $lead['id']]) }}"
                                                        ...
                                                        data-bs-original-title="Delete" title="Delete"><i
                                                            ...
                                                            @endif
                                                            @if (Helpers::modules_permission_check('Pooja Order', 'Lead', 'follow-up'))
                                                ...
                                                <div class="d-flex justify-content-center gap-2 pt-2">
                                                    @if (Helpers::modules_permission_check('Pooja Order', 'Lead', 'follow-up-history'))
                                                    <a href="javascript:0"
                                                        ...
                                                        @endif
                                                        @if (Helpers::modules_permission_check('Pooja Order', 'Lead', 'call'))
                                                ...
                                                <div class="d-flex justify-content-center gap-2 pt-2">
                                                    @if (Helpers::modules_permission_check('Pooja Order', 'Lead', 'whatsapp'))
                                                    ...
                                                    @endif
                                                    @if (Helpers::modules_permission_check('Pooja Order', 'Lead', 'template'))
