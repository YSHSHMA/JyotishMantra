    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{ translate('Astro_/_Pandit_Puja_Order') }}
        ...
        <div class="card mb-3 remove-card-shadow">
            <div class="card-body">
                <div class="row g-2" id="order_stats">
                    <div class="col-lg-12">
                        @php
                            $totalPaymentSuccess = \App\Models\Service_order::where('type', 'panditpooja')
                                ->where('status', 0)->where('is_block', '!=', 9)
                                ->where('payment_status', 1)
                                ->sum('pay_amount');
                            $totalPaymentPending = \App\Models\Service_order::where('type', 'panditpooja')
                                ->where('status', 0)->where('is_block', '!=', 9)
                                ->where('status', 0)
                                ->where('payment_status', 0)
                                ->sum('pay_amount');
                            $totalPaymentFaild = \App\Models\Service_order::where('type', 'panditpooja')
                                ->where('status', 0)
                                ->where('status', 0)->where('is_block', '!=', 9)
                                        ...
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-info">
                                                    {{ \App\Models\Service_order::where('type', 'panditpooja')->where('is_block', '!=', 9)->count() }}
                                                </h3>
                                ...
                                <a href="{{ route('admin.pooja.orders.list', 1) }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-success">
                                                    {{ \App\Models\Service_order::where('type', 'panditpooja')->where('is_block', '!=', 9)->where('is_completed', 1)->where('status', 1)->where('payment_status', 1)->count() }}
                                                </h3>
                                        ...
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-primary">
                                                    {{ \App\Models\Service_order::where('type', 'panditpooja')->where('is_block', '!=', 9)->where('status', 0)->where('is_completed', 0)->where('payment_status', 1)->count() }}
                                                </h3>
                                ...
                                <a href="{{ route('admin.pooja.orders.list', 6) }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-danger">
                                                    {{ \App\Models\Service_order::where('type', 'panditpooja')->where('is_block', '!=', 9)->where('status', 6)->where('order_status', 6)->count() }}
                                                </h3>
                                                        ...
                                                        <div class="d-flex justify-content-center gap-2">
                                                            ...
                                                            @if (Helpers::modules_permission_check('Pooja Order', 'All', 'detail') || Helpers::modules_permission_check('Pooja Order', 'Pending', 'detail') || Helpers::modules_permission_check('Pooja Order', 'Completed', 'detail') || Helpers::modules_permission_check('Pooja Order', 'Canceled', 'detail'))
                                                                <a class="btn btn-outline-primary btn-sm square-btn"
                                                                    ...
                                                                    href="{{ route('admin.pandit.orders.details', [$order['id']]) }}">
                                                                ...
                                                                <a class="btn btn-outline-info btn-sm square-btn"
                                                                    target="_blank"
                                                                    href="{{ route('admin.pandit.orders.generate.invoice', $order['id']) }}">
