            ...
            <div class="px-3 py-4">
               <div class="row g-2 flex-grow-1">
                  <div class="col-lg-12 d-flex justify-content-end">
                    @if (
                        Helpers::modules_permission_check('Anushthan Order', 'All', 'block') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Pending', 'block') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Completed', 'block') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Canceled', 'block') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Rejected', 'block')
                    )
           ...
           columns: [
               ...
               },
               {
                ...
                render: (data, type, row) => {
                    ...
                    @if (
                        Helpers::modules_permission_check('Anushthan Order', 'All', 'pandit-assign') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Pending', 'pandit-assign') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Completed', 'pandit-assign') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Canceled', 'pandit-assign') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Rejected', 'pandit-assign')
                    )
                    ...
                    if (row.payment_status == 0){
                        @if (
                        Helpers::modules_permission_check('Anushthan Order', 'All', 'pay') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Pending', 'pay') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Completed', 'pay') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Canceled', 'pay') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Rejected', 'pay')
                    )
