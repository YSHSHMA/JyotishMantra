                            ...
                            <table id="myTable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'detail') ||
                                                Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'download') ||
                                                Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'assign-pandit') ||
                                                Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'schedule'))
                                            ...
                                            @if (Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'detail') ||
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        @if (Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'assign-pandit'))
                                                        ...
                                                        @if (Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'schedule'))
                                                        ...
                                                        @if (Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'detail'))
                                                            ...
                                                            @if (Helpers::modules_permission_check('Anushthan Order', 'Instance Order', 'download'))
