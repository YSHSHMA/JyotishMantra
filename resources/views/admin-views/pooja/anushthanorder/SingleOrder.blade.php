                                    ...
                                    <table id="myTable"
                                        ...
                                        <thead class="thead-light thead-50 text-capitalize">
                                            <tr>
                                                ...
                                                @if (Helpers::modules_permission_check('Anushthan Order', 'Order By Anushthan List', 'detail') || Helpers::modules_permission_check('Anushthan Order', 'Order By Anushthan List', 'share'))
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">
                                                            @if (Helpers::modules_permission_check('Anushthan Order', 'Order By Anushthan List', 'detail'))
                                                            ...
                                                            @if (Helpers::modules_permission_check('Anushthan Order', 'Order By Anushthan List', 'share'))
                ...
                <div class="row mt-20">
                    <div class="col-md-12">
                        <div class="row align-items-center py-2">
                            ...
                            @if (Helpers::modules_permission_check('Anushthan Order', 'Order By Anushthan List', 'download-pdf'))
