            ...
            <div class="col-lg-4 d-flex flex-column gap-3">
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        @if (Helpers::modules_permission_check('Anushthan Order', 'Order By Anushthan Detail', 'assign-pandit'))
                ...
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        @if ($details['status'] == 0)
                        @if (Helpers::modules_permission_check('Anushthan Order', 'Order By Anushthan Detail', 'order-status'))
                            <div class="">
