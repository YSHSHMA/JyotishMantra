                            ...
                            <table
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Offline Pooja', 'Lead', 'delete') || Helpers::modules_permission_check('Offline Pooja', 'Lead', 'follow-up') || Helpers::modules_permission_check('Offline Pooja', 'Lead', 'follow-up-history') || Helpers::modules_permission_check('Offline Pooja', 'Lead', 'call') || Helpers::modules_permission_check('Offline Pooja', 'Lead', 'whatsapp') || Helpers::modules_permission_check('Offline Pooja', 'Lead', 'template'))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    @if (Helpers::modules_permission_check('Offline Pooja', 'Lead', 'delete'))
                                                    ...
                                                    @endif
                                                    @if (Helpers::modules_permission_check('Offline Pooja', 'Lead', 'follow-up'))
                                                ...
                                                <div class="d-flex justify-content-center gap-2 pt-2">
                                                    @if (Helpers::modules_permission_check('Offline Pooja', 'Lead', 'follow-up-history'))
                                                    <a href="javascript:0"
                                                    ...
                                                    @endif
                                                    @if (Helpers::modules_permission_check('Offline Pooja', 'Lead', 'call'))
                                                ...
                                                <div class="d-flex justify-content-center gap-2 pt-2">
                                                    @if (Helpers::modules_permission_check('Offline Pooja', 'Lead', 'whatsapp'))
                                                    ...
                                                    @endif
                                                    @if (Helpers::modules_permission_check('Offline Pooja', 'Lead', 'template'))
