                                    ...
                                    <table id="myTable"
                                        ...
                                        <thead class="thead-light thead-50 text-capitalize">
                                            <tr>
                                                ...
                                                @if (Helpers::modules_permission_check('Pooja Order', 'Order By Pooja', 'single-view') || Helpers::modules_permission_check('Pooja Order', 'Order By Pooja', 'single-share'))
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">
                                                            @if (Helpers::modules_permission_check('Pooja Order', 'Order By Pooja', 'single-view'))
                                                            ...
                                                            @endif
                                                            @if (Helpers::modules_permission_check('Pooja Order', 'Order By Pooja', 'single-share'))
                ...
                <div class="row mt-20">
                    <div class="col-md-12">
                        <div class="row align-items-center py-2">
                            ...
                            @if (Helpers::modules_permission_check('Pooja Order', 'Order By Pooja', 'download-pdf'))
                                            ...
                                            @foreach ($orders as $key => $order)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{ $order->leads->addProducts()->pluck('name')->join(', ') }}
                                                        @else
                                                        No Product
                                                        @endif
                                                    </td>
