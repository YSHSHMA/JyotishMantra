...
@section('title', 'OfflinePooja ORDER | LIST')
@push('css_or_js')
        ...
        <div class="card mb-3 remove-card-shadow">
            <div class="card-body">
                <div class="row g-2" id="order_stats">
                    <div class="col-lg-12">
                        @php
                            $totalPaymentSuccess = \App\Models\OfflinePoojaOrder::where('status', 0)
                                ->where('is_block', '!=', 9)
                                ->where('payment_status', 1)
                                ->sum('pay_amount');
                            $totalPaymentPending = \App\Models\OfflinePoojaOrder::where('status', 0)
                                ->where('is_block', '!=', 9)
                                ->where('payment_status', 0)
                                ->sum('pay_amount');
                            $totalPaymentFaild = \App\Models\OfflinePoojaOrder::where('status', 0)
                                ->where('is_block', '!=', 9)
                        ...
                        <div class="row g-2">
                            <div class="col-md-4">
                                <a href="{{ route('admin.offlinepooja.order.list', 'all') }}" class="text-decoration-none">
                                        ...
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-info">
                                                    {{ \App\Models\OfflinePoojaOrder::where('is_block', '!=', 9)->count() }}
                                                </h3>
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.offlinepooja.order.list', 0) }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-primary">
                                                    {{ \App\Models\OfflinePoojaOrder::where('is_block', '!=', 9)->where('status', 0)->count() }}
                                                </h3>
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.offlinepooja.order.list', 1) }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-success">
                                                    {{ \App\Models\OfflinePoojaOrder::where('is_block', '!=', 9)->where('status', 1)->count() }}
                                                </h3>
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.offlinepooja.order.list', 2) }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-primary">
                                                    {{ \App\Models\OfflinePoojaOrder::where('is_block', '!=', 9)->where('status', 2)->count() }}
                                                </h3>
                ...
                <div class="card mb-3">
                    <div class="px-3 py-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="mb-0">Filter the Offlinepooja Service Orders</h4>
                            @if (Helpers::modules_permission_check('OfflinePooja Order', 'All', 'block') || Helpers::modules_permission_check('OfflinePooja Order', 'Pending', 'block') || Helpers::modules_permission_check('OfflinePooja Order', 'Pandit Assigned', 'block') || Helpers::modules_permission_check('OfflinePooja Order', 'Completed', 'block') || Helpers::modules_permission_check('OfflinePooja Order', 'Canceled', 'block'))
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <form method="GET" action="{{ url()->current() }}" id="filterForm" class="row mb-3">
                                    ...
                                    <div
                                        ...
                                        @php
                                            $uniqueServices = $orders->pluck('offlinePooja')->filter()->unique('id');
                                        @endphp
                                    ...
                                    @if (str_contains(url()->current(), 'list/all'))
                                        <div
                                            class="{{ str_contains(url()->current(), 'list/all') ? 'col-md-3' : 'col-md-4' }}">
                                            <label for="status" class="font-weight-bold">OfflinePooja Status</label>
                                            @php
                                                $orderStatusOptions = [
                                                    0 => 'Pending',
                                                    1 => 'Complete',
                                        ...
                                        <tbody>
                                            @foreach ($orders as $key => $order)
                                                <tr>
                                                    ...
                                                    <td><b>
                                                            <a href="javascript:0"
                                                                ...
                                                                <span class="media-body title-color hover-c1">
                                                                    <strong>{{ Str::limit($order['offlinePooja']['name'], 40) }}
                                                                    </strong>
                                                                </span>
                                                            </a>
                                                        </b>
                                                    ...
                                                    <td>
                                                        <div>
                                                            {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $order->package_main_price), currencyCode: getCurrencyCode()) }}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">
                                                            @if (Helpers::modules_permission_check('OfflinePooja Order', 'All', 'detail') || Helpers::modules_permission_check('OfflinePooja Order', 'Pending', 'detail') || Helpers::modules_permission_check('OfflinePooja Order', 'Pandit Assigned', 'detail') || Helpers::modules_permission_check('OfflinePooja Order', 'Completed', 'detail') || Helpers::modules_permission_check('OfflinePooja Order', 'Canceled', 'detail'))
                                                            ...
                                                            @if (Helpers::modules_permission_check('OfflinePooja Order', 'All', 'pay') || Helpers::modules_permission_check('OfflinePooja Order', 'Pending', 'pay') || Helpers::modules_permission_check('OfflinePooja Order', 'Pandit Assigned', 'pay') || Helpers::modules_permission_check('OfflinePooja Order', 'Completed', 'pay') || Helpers::modules_permission_check('OfflinePooja Order', 'Canceled', 'pay'))
                                                            <a class="btn btn-outline-info btn-sm square-btn"
                                                                ...
                                                                @endif
                                                            @else
                                                            @if (Helpers::modules_permission_check('OfflinePooja Order', 'All', 'download-invoice') || Helpers::modules_permission_check('OfflinePooja Order', 'Pending', 'download-invoice') || Helpers::modules_permission_check('OfflinePooja Order', 'Pandit Assigned', 'download-invoice') || Helpers::modules_permission_check('OfflinePooja Order', 'Completed', 'download-invoice') || Helpers::modules_permission_check('OfflinePooja Order', 'Canceled', 'download-invoice'))
                                                                <a class="btn btn-outline-info btn-sm square-btn"
                                                                    target="_blank"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#customer_id').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route('admin.offlinepooja.order.get-customer-orders') }}",
                    type: "GET",
                    data: {
            ...
            $('#blockOrdersBtn').click(function() {
                ...
                $.ajax({
                    url: "{{ route('admin.offlinepooja.order.block-orders') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
