...
@section('title', translate('calculator_Add'))
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.calculator.add-new') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                            ...
                                            id="{{ $lang }}-form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description[]" class="form-control ckeditor" id="description" value=""
                                                        placeholder="{{ translate('ex') }} : {{ translate('description') }}" {{ $lang == $defaultLanguage ? 'required' : '' }}></textarea>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="url" id="url" name="url" class="form-control" placeholder="{{ translate('ex') }} : {{ translate('url') }}">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-group">
                                        <label for="logo" class="title-color">
                                            {{ translate('calculator_Logo') }}<span class="text-danger">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label for="detail_image" class="title-color">
                                            {{ translate('detail_Image') }}<span class="text-danger">*</span>
                                        </label>
                                        <span class="ml-1 text-info">
                                            {{ THEME_RATIO[theme_root_path()]['Brand Image'] }}
                                        </span>
