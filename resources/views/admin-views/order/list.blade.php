                        ...
                        <table
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ translate('Delivery_patner') }}</th>
                                    @if ($status == 'all')
                                ...
                                @foreach ($orders as $key => $order)
                                    ...
                                    <tr class="status-{{ $order['order_status'] }} class-all">
                                        ...
                                        <td class="text-capitalize">
                                            {{ str_replace('_', ' ', $order['delivery_partner']) }}
                                        </td>
                                        @if ($status == 'all')
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                @if (Helpers::modules_permission_check('Product Order', 'All', 'detail') ||
                                                        Helpers::modules_permission_check('Product Order', 'Pending', 'detail') ||
                                                        Helpers::modules_permission_check('Product Order', 'Confirmed', 'detail') ||
                                                        Helpers::modules_permission_check('Product Order', 'Packaging', 'detail') ||
                                                        Helpers::modules_permission_check('Product Order', 'Out for Delivery', 'detail') ||
                                                        Helpers::modules_permission_check('Product Order', 'Delivered', 'detail') ||
                                                        Helpers::modules_permission_check('Product Order', 'Returned', 'detail') ||
                                                        Helpers::modules_permission_check('Product Order', 'Failed to Delivered', 'detail') ||
                                                        Helpers::modules_permission_check('Product Order', 'Canceled', 'detail'))
                                                ...
                                                @if (Helpers::modules_permission_check('Product Order', 'All', 'download-invoice') ||
                                                        Helpers::modules_permission_check('Product Order', 'Pending', 'download-invoice') ||
                                                        Helpers::modules_permission_check('Product Order', 'Confirmed', 'download-invoice') ||
                                                        Helpers::modules_permission_check('Product Order', 'Packaging', 'download-invoice') ||
                                                        Helpers::modules_permission_check('Product Order', 'Out for Delivery', 'download-invoice') ||
                                                        Helpers::modules_permission_check('Product Order', 'Delivered', 'download-invoice') ||
                                                        Helpers::modules_permission_check('Product Order', 'Returned', 'download-invoice') ||
                                                        Helpers::modules_permission_check('Product Order', 'Failed to Delivered', 'download-invoice') ||
                                                        Helpers::modules_permission_check('Product Order', 'Canceled', 'download-invoice'))
