        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body text-start">
                    <form action="{{ route('admin.vendor-support-ticket.issue-store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control" required>
                                        ...
                                        <option value="{{ $v_data}}">{{ $v_data}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="message" class="form-control" placeholder="{{ translate('ticket_issue_name') }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table
                        ...
                        <thead class="thead-light thead-50 text-capitalize">
                            <tr>
                                ...
                                <th class="text-center">{{ translate('created_by') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ ($package['created_by']??"") }}</td>
                                <td class="text-center">{{ $package['type'] }}</td>
                                <td class="text-center">{{ $package['message'] }}</td>
                                <td class="text-center">
                                    <form action="{{route('admin.vendor-support-ticket.status-update-issue') }}" method="post" id="brand-status{{$package['id']}}-form">
                                        @csrf
                                    ...
                                    <div class="d-flex justify-content-center gap-10">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a class="btn btn-outline-info btn-sm square-btn"
                                                ...
                                                href="{{ route('admin.vendor-support-ticket.issue-update', [$package['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
                                        ...
                                        <form action="{{ route('admin.vendor-support-ticket.delete-type-issue', [$package['id']]) }}"
