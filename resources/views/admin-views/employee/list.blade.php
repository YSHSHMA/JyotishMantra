                ...
                <div class="px-sm-3 py-4 flex-grow-1">
                    <div class="d-flex justify-content-between gap-3 flex-wrap align-items-center">
                        ...
                        <div
                            ...
                            @if (Helpers::modules_permission_check('Employee', 'Employee', 'add'))
                                <div class="">
                    ...
                    <table id="datatable" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                        ...
                        <thead class="thead-light thead-50 text-capitalize table-nowrap">
                            <tr>
                                ...
                                @if (Helpers::modules_permission_check('Employee', 'Employee', 'status'))
                                    <th>{{ translate('status') }}</th>
                                @endif
                                @if (Helpers::modules_permission_check('Employee', 'Employee', 'edit') ||
                                        Helpers::modules_permission_check('Employee', 'Employee', 'delete'))
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <form action="{{ route('admin.employee.status') }}" method="post"
                                                    id="employee-id-{{ $employee['id'] }}-form" class="employee_id_form">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{ $employee['id'] }}">
                                                    <label class="switcher">
                                                        <input type="checkbox" class="switcher_input toggle-switch-message"
                                                            value="1" id="employee-id-{{ $employee['id'] }}"
                                                            name="status" {{ $employee->status ? 'checked' : '' }}
                                        ...
                                        <td class="text-center">
                                            ...
                                            @else
                                                <div class="d-flex gap-10 justify-content-center">
                                                    ...
                                                    @endif
                                                    @if (Helpers::modules_permission_check('Employee', 'Employee', 'delete'))
