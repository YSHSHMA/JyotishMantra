...
@section('title', translate('pending_pandit'))
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                    @foreach ($pendingPandit as $key => $value)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start gap-2">
                                                    <span class="btn btn-outline-success btn-sm square-btn verify-pandit"
                                                        title="{{ translate('verify_pandit') }}"
