                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                                ...
                                <tr>
                                    ...
                                    @if (Helpers::modules_permission_check('Brand', 'Brand', 'status'))
                                    <th class="text-center">{{ translate('status') }}</th>
                                    @endif
                                    @if (Helpers::modules_permission_check('Brand', 'Brand', 'edit') || Helpers::modules_permission_check('Brand', 'Brand', 'delete'))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                @if (Helpers::modules_permission_check('Brand', 'Brand', 'edit'))
                                                ...
                                                @if (Helpers::modules_permission_check('Brand', 'Brand', 'delete'))
