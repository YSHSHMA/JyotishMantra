            ...
            <div class="col-12 mb-3">
                <div class="card">
                    <div class="card-body py-5">
                        <div class="d-flex justify-content-between gap-3 flex-wrap mb-5">
                            ...
                            <div>
                                <select name="for_customer" id="for_customer"
                                    ...
                                    <option value="puja">{{translate('for_puja')}}</option>
                                    <option value="counselling">{{translate('for_counselling')}}</option>
                                    <option value="offlinepuja">{{translate('for_offlinepuja')}}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="puja_view  d-none">
                            <form action="{{route('admin.push-notification.update',['type'=>'puja'])}}"
                                  class="text-start" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    @foreach ($pujaMessages as $key=>$value )
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <div
                                                    class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-10">
                                                    <label for="puja{{$value['key']}}" class="switcher_content">
                                                        {{ translate($value['key'] == 'out_for_delivery_message' ? 'order_out_for_delivery_message' : ($value['key'] == 'order_canceled' ? 'order_canceled_message' : $value['key'])) }}
                                                    </label>
                                                    <label class="switcher" for="puja{{$value['key']}}">
                                                        <input type="checkbox" class="switcher_input toggle-switch-message"
                                                               name="status{{$value['id']}}"
                                                               id="puja{{$value['key']}}" value="1"
                                                               {{$value['status']==1?'checked':''}}
                                                               data-modal-id = "toggle-modal"
                                                               data-toggle-id = "puja{{$value['key']}}"
                                                               data-on-image = "notification-on.png"
                                                               data-off-image = "notification-off.png"
                                                               data-on-title = "{{translate('Want_to_Turn_ON_Push_Notification')}}"
                                                               data-off-title = "{{translate('Want_to_Turn_OFF_Push_Notification')}}"
                        ...
                        <div class="counselling_view  d-none">
                            <form action="{{route('admin.push-notification.update',['type'=>'counselling'])}}"
                                  class="text-start" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    @foreach ($counsellingMessages as $key=>$value )
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <div
                                                    class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-10">
                                                    <label for="counselling{{$value['key']}}" class="switcher_content">
                                                        {{ translate($value['key'] == 'out_for_delivery_message' ? 'order_out_for_delivery_message' : ($value['key'] == 'order_canceled' ? 'order_canceled_message' : $value['key'])) }}
                                                    </label>
                                                    <label class="switcher" for="counselling{{$value['key']}}">
                                                        <input type="checkbox" class="switcher_input toggle-switch-message"
                                                               name="status{{$value['id']}}"
                                                               id="counselling{{$value['key']}}" value="1"
                                                               {{$value['status']==1?'checked':''}}
                                                               data-modal-id = "toggle-modal"
                                                               data-toggle-id = "counselling{{$value['key']}}"
                                                               data-on-image = "notification-on.png"
                                                               data-off-image = "notification-off.png"
                                                               data-on-title = "{{translate('Want_to_Turn_ON_Push_Notification')}}"
                                                               data-off-title = "{{translate('Want_to_Turn_OFF_Push_Notification')}}"
                        ...
                        <div class="offlinepuja_view  d-none">
                            <form action="{{route('admin.push-notification.update',['type'=>'offlinepuja'])}}"
                                  class="text-start" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    @foreach ($offlinepujagMessages as $key=>$value )
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <div
                                                    class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-10">
                                                    <label for="offlinepuja{{$value['key']}}" class="switcher_content">
                                                        {{ translate($value['key'] == 'out_for_delivery_message' ? 'order_out_for_delivery_message' : ($value['key'] == 'order_canceled' ? 'order_canceled_message' : $value['key'])) }}
                                                    </label>
                                                    <label class="switcher" for="offlinepuja{{$value['key']}}">
                                                        <input type="checkbox" class="switcher_input toggle-switch-message"
                                                               name="status{{$value['id']}}"
                                                               id="offlinepuja{{$value['key']}}" value="1"
                                                               {{$value['status']==1?'checked':''}}
                                                               data-modal-id = "toggle-modal"
                                                               data-toggle-id = "offlinepuja{{$value['key']}}"
                                                               data-on-image = "notification-on.png"
                                                               data-off-image = "notification-off.png"
                                                               data-on-title = "{{translate('Want_to_Turn_ON_Push_Notification')}}"
                                                               data-off-title = "{{translate('Want_to_Turn_OFF_Push_Notification')}}"
