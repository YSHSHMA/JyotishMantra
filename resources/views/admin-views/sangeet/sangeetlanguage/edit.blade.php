...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.sangeetlanguage.update', [$sangeetlanguage['id']]) }}"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                @foreach($language as $lang)
                                <?php
                                $translation = $sangeetlanguage->translations->where('locale', $lang)->first();
                                ?>
                                <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form"
                                    id="{{$lang}}-form">
                                    <label class="title-color" for="name">{{ translate('language_Name') }}
                                        ({{strtoupper($lang)}})</label>
                                    <input type="text" name="name[]"
                                        value="{{ $lang == $defaultLanguage ? $sangeetlanguage->name : ($translation ? $translation->value : '') }}"
