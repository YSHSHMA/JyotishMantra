...
@section('title', translate('Donate_Edit_category'))
...
<div class="content container-fluid">
   <div class="mb-3">
      <h2 class="h1 mb-0 d-flex gap-2">
         ...
         {{ translate('Donate_Edit_category') }}
      </h2>
   </div>
   <div class="row">
      <!-- Form for adding new donate_Edit_category -->
      <div class="col-md-12 mb-3">
         <div class="card">
            <div class="card-body">
               <form action="{{ route('admin.donate_management.category.updatestore') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <!-- Language tabs -->
                     ...
                     <div class="col-md-4 mb-4">
                        <div class="text-center">
                           <img class="upload-img-view" id="detail-viewer"
                              src="{{ getValidImage(path: 'storage/app/public/donate/category/'.$old_data['image'], type: 'backend-product')  }}"
                              alt="">
                        </div>
