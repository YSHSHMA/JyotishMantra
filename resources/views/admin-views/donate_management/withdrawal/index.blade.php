                        ...
                        <table id="datatable"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ ucwords($withdrawRequest['type']) }}</td>
                                    <td>
                                        <div>
                                            @if($withdrawRequest['type'] == 'purohit')
                                            <span>{{ $withdrawRequest['PanditEmp']['name']??"" }}</span><br>
                                            <span>{{ $withdrawRequest['PanditEmp']['phone']??"" }}</span><br>
                                            <span>{{ $withdrawRequest['PanditEmp']['email']??"" }}</span>
                                            @else
