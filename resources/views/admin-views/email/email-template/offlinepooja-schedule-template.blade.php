            ...
            <td style="padding: 10px; text-align: center; background-color: #f0f0f0;">
                ...
                @if ($bookingDetails)
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        ...
                        {{ date('h:i A', strtotime($bookingDetails['time_schedule'])) }} par schedule ki gayi hai.
                        😊
                    </p>
                @else
                ...
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🏛️ Puja Sthal:</strong> {{ $bookingDetails['pooja_venue_type']=='address'?$bookingDetails['venue_address']:$bookingDetails->temple->name }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>⏰ Puja Time:</strong>
                            {{ date('h:i A', strtotime($bookingDetails['time_schedule'])) }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
