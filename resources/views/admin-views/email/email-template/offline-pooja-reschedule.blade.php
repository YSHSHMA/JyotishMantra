    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center"
        ...
        <tr>
            <td style="padding: 10px; text-align: center; background-color: #f0f0f0;">
                ...
                <p style="font-size: 16px; color: #555; margin: 5px 0;">
                    Aapki {{ $service_name['name'] }} safaltapurvak reschedule ho gayi hai. 😊
                </p>
            </td>
        </tr>
        <!-- Content Section -->
        <tr>
            <td style="padding:5px; background-color: #f9f9f9;">
                <h2 style="font-size: 20px; color: #333;">Reschedule Details:</h2>
                ...
                <p style="font-size: 16px; color: #555; margin:5px;">
                    <strong>💰 Reschedule Rashi:</strong> {{ webCurrencyConverter($bookingDetails['schedule_amount']) }}
                </p>
                <p style="font-size: 16px; color: #555; margin:5px;">
                    <strong>🆔 Order ID:</strong> {{ $bookingDetails['schedule_amount'] }}
                </p>
            </td>
        </tr>
