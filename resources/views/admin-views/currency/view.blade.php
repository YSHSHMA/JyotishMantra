        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-inline_ text-start" action="{{route('admin.currency.system-currency-update')}}" method="post">
                    ...
                    @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'default-currency'))
                ...
                <form action="{{route('admin.currency.store')}}" method="post">
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            @endif
                            @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'currency-add'))
                            <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                ...
                                @endif
                                @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'currency-status'))
                                <th>{{translate('status')}}</th>
                                @endif
                                @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'currency-edit') || Helpers::modules_permission_check('System Setup', 'System Setting', 'currency-delete'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            ...
                                            @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'currency-edit'))
                                                ...
                                                @endif
                                                @if (Helpers::modules_permission_check('System Setup', 'System Setting', 'currency-delete'))
