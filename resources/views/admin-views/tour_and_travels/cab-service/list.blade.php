            ...
            <div class="card-body">
               <form action="{{ route('admin.tour_cab_service.store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="d-flex flex-wrap gap-2 justify-content-end">
                     @if (Helpers::modules_permission_check('Tour', 'Tour Vehicle Setting', 'add'))
                  ...
                  <table id="datatable"
                     ...
                     <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                           ...
                           @if (Helpers::modules_permission_check('Tour', 'Tour Vehicle Setting', 'status'))
                           <th>{{ translate('status') }}</th>
                           @endif
                           @if (Helpers::modules_permission_check('Tour', 'Tour Vehicle Setting', 'edit') || Helpers::modules_permission_check('Tour', 'Tour Vehicle Setting', 'delete'))
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ \App\Models\TourVehicleCetagory::find($items['vehicle_category'])['type']??"" }}</td>
                           <td>{{ \App\Models\TourVehicleCetagory::find($items['vehicle_category'])['brand_name']??"" }}</td>
                           <td>{{ $items['name'] }}</td>
                           <td>{{ $items['seats'] }}</td>
                           <td>
