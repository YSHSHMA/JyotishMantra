                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span>{{ date('d M,Y h:i A', strtotime($items['created_at'])) }}</span><br>
                                                        ...
                                                        <div class="col-12">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @if($items['use_date'] == 0 || ($p_info['type'] == 'cab' && $items['use_date'] == 1) || ($p_info['type'] != 'ex_distance' && $items['use_date'] == 2) || ($items['type'] != 'ex_distance' && $items['use_date'] == 3) || ($p_info['type'] != 'ex_distance' && $items['use_date'] == 4))
                                                                    <tr>
                                                                        <td>
                                                                            @if($p_info['type'] == 'cab')
                                ...
                                <td>
                                    ...
                                    @endif
                                    <span> {{ date('d M,Y', strtotime($items['pickup_date'] ?? '')) }} {{ $items['pickup_time'] ?? '' }}</span><br>
                                    <small class="btn btn-sm btn-warning text-white">{{ (($items['part_payment'] == 'full')? $items['part_payment'] : 'partially') }}</small>
                                </td>
