...
<div class="content container-fluid">
    ...
    <form class="product-form text-start" action="{{ route('admin.tour_and_travels.edit', [$getData['id']]) }}"
        method="POST" enctype="multipart/form-data" id="services_form">
        @csrf
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" required name="owner_name"
                                    class="form-control @error('owner_name') is-invalid @enderror"
                                    value="{{ old('owner_name', $getData['owner_name'] ?? '') }}"
                                    placeholder="{{ translate('Owner_name') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" required name="company_name"
                                    ...
                                    value="{{ old('company_name', $getData['company_name'] ?? '') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="phone-group">
                                ...
                                <input class="form-control text-align-direction phone-input-with-country-picker  @error('phone_no') is-invalid @enderror onfillup" type="tel" required id="person-number" placeholder="{{ translate('enter_phone_number') }}" value="{{ old('phone_no', $getData['phone_no'] ?? '') }}" oninput="this.value=this.value.slice(0,10)" data-point='1'>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" required name="email"
                                    class="form-control @error('email') is-invalid @enderror onfillup"
                                    value="{{ old('email', $getData['email'] ?? '') }}"
                                    placeholder="{{ translate('email_id') }}" data-point="2">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color" for="">{{ translate('city') }} </label>
                                <input type="text" required name="city" autocomplete="off" class="form-control @error('city') is-invalid @enderror getAddress_google city_event" value="{{ old('city', $getData['city'] ?? '') }}" placeholder="{{ translate('city') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color" for="">{{ translate('state') }} </label>
                                <input type="text" required name="state" autocomplete="off" class="form-control @error('state') is-invalid @enderror state_event" readonly value="{{ old('state', $getData['state'] ?? '') }}" placeholder="{{ translate('state') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" required name="address"
                                    ...
                                    value="{{ old('address', $getData['address'] ?? '') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="web_site_link"
                                    class="form-control @error('web_site_link') is-invalid @enderror onfillup"
                                    value="{{ old('web_site_link', $getData['web_site_link'] ?? '') }}"
                                    placeholder="{{ translate('Web_site_link') }}" data-point="3">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color" for="">{{ translate('Number_of_Experience') }} </label>
                                <input type="text" name="experience" class="form-control @error('experience') is-invalid @enderror onfillup" value="{{ old('experience', $getData['experience'] ?? '') }}" placeholder="{{ translate('Enter_Number_of_Experience') }}" data-point="14">
                            </div>
                        </div>
                    </div>
                    <div class="card-header pt-0">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea required name="services" id="_services"
                                    class="form-control ckeditor @error('services') is-invalid @enderror">{{ old('services', $getData['services'] ?? '') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color" for="_expect_details">{{ translate('Area_of_Operation') }}
                                </label>
                                <textarea required name="area_of_operation" id="_area_of_operation "
                                    class="form-control ckeditor @error('area_of_operation') is-invalid @enderror">{{ old('area_of_operation', $getData['area_of_operation'] ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card-header pt-0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="person_name"
                                    ...
                                    value="{{ old('person_name', $getData['person_name'] ?? '') }}"
                                    placeholder="{{ translate('person_name') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="person_phone"
                                    class="form-control  @error('person_phone') is-invalid @enderror onfillup"
                                    value="{{ old('person_phone', $getData['person_phone'] ?? '') }}"
                                    placeholder="{{ translate('person_phone') }}" data-point="4">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="person_email"
                                    class="form-control  @error('person_email') is-invalid @enderror onfillup"
                                    value="{{ old('person_email', $getData['person_email'] ?? '') }}"
                                    placeholder="{{ translate('person_email') }}" data-point="5">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="person_address"
                                    class="form-control  @error('person_address') is-invalid @enderror"
                                    value="{{ old('person_address', $getData['person_address'] ?? '') }}"
                                    placeholder="{{ translate('person_address') }}">
                            </div>
                        </div>
                    </div>
                    <div class="card-header pt-0">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_holder_name"
                                    class="form-control  @error('bank_holder_name') is-invalid @enderror onfillup"
                                    value="{{ old('bank_holder_name', $getData['bank_holder_name'] ?? '') }}"
                                    placeholder="{{ translate('Holder’s Name') }}" data-point="6">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_name"
                                    class="form-control  @error('bank_name') is-invalid @enderror onfillup"
                                    value="{{ old('bank_name', $getData['bank_name'] ?? '') }}"
                                    placeholder="{{ translate('Bank_Name') }}" data-point="7">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_branch"
                                    class="form-control  @error('bank_branch') is-invalid @enderror onfillup"
                                    value="{{ old('bank_branch', $getData['bank_branch'] ?? '') }}"
                                    placeholder="{{ translate('Branch_name') }}" data-point="8">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ifsc_code"
                                    class="form-control  @error('ifsc_code') is-invalid @enderror onfillup"
                                    value="{{ old('ifsc_code', $getData['ifsc_code'] ?? '') }}"
                                    placeholder="{{ translate('IFSC_code') }}" data-point="9" onkeyup="$('.bank-verified-status').val(0);">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="account_number" name="account_number"
                                    class="form-control  @error('account_number') is-invalid @enderror onfillup"
                                    value="{{ old('account_number', $getData['account_number'] ?? '') }}"
                                    placeholder="{{ translate('Account_number') }}" data-point="10" onkeyup="$('.bank-verified-status').val(0);">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color" for="">{{ translate('Confirm_Account_number') }}
                                </label>
                                <input type="text" id="confirm_account_number" class="form-control"
                                    placeholder="{{ translate('Account_number') }}"
                                    value="{{ old('account_number', $getData['account_number'] ?? '') }}"
                                    onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );"
                                    onblur="validateAccountNumber();" required>
                        ...
                        <div class="col-md-12">
                            @if (Helpers::modules_permission_check('Tour', 'Travel Agent', 'edit'))
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                    <div>
                                        <label for="name"
                                            class="title-color text-capitalize font-weight-bold mb-0">{{ translate('GST_certificate') }}</label>
                                        <span
                                            class="badge badge-soft-info">{{ THEME_RATIO[theme_root_path()]['Product Image'] }}</span>
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                            title="{{ translate('add_your_GST_certificate') }} JPG, PNG or JPEG {{ translate('format_within') }} 2MB">
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        <input type="file" name="gst_image"
                                            ...
                                            data-imgpreview="pre_gst_img_viewer"
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_gst_img_viewer"
                                                class="h-auto aspect-1 bg-white  {{ $getData['gst_image'] ? '' : 'd-none' }}"
                                                src="{{ getValidImage(path: 'storage/app/public/tour_and_travels/doc/' . $getData['gst_image'], type: 'backend-product') }}"
                                                alt="">
                                        </div>
                                        <div
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                    <div>
                                        <label for="name"
                                            class="title-color text-capitalize font-weight-bold mb-0">{{ translate('Pan_card') }}</label>
                                        <span
                                            class="badge badge-soft-info">{{ THEME_RATIO[theme_root_path()]['Product Image'] }}</span>
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        <input type="file" name="pan_card_image"
                                            class="custom-upload-input-file action-upload-color-image" id=""
                                            data-imgpreview="pre_pan_card_img_viewer"
                                            accept=".jpg, .webp, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <span
                                            class="delete_file_input btn btn-outline-danger btn-sm square-btn d--none">
                                            <i class="tio-delete"></i>
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_pan_card_img_viewer"
                                                class="h-auto aspect-1 bg-white  {{ $getData['pan_card_image'] ? '' : 'd-none' }}"
                                                src="{{ getValidImage(path: 'storage/app/public/tour_and_travels/doc/' . $getData['pan_card_image'], type: 'backend-product') }}"
                                                alt="">
                                        </div>
                                        <div
                                            class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                    <div>
                                        <label for="name"
                                            class="title-color text-capitalize font-weight-bold mb-0">{{ translate('aadhaar_card') }}</label>
                                        <span
                                            class="badge badge-soft-info">{{ THEME_RATIO[theme_root_path()]['Product Image'] }}</span>
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                            title="{{ translate('add_your_aadhaar_card') }} JPG, PNG or JPEG {{ translate('format_within') }} 2MB">
                                            <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                                alt="">
                                        </span>
                                    </div>
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        <input type="file" name="aadhaar_card_image"
                                            class="custom-upload-input-file action-upload-color-image" id=""
                                            data-imgpreview="pre_aadhaar_card_img_viewer"
                                            accept=".jpg, .webp, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <span
                                            class="delete_file_input btn btn-outline-danger btn-sm square-btn d--none">
                                            <i class="tio-delete"></i>
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_aadhaar_card_img_viewer"
                                                class="h-auto aspect-1 bg-white  {{ $getData['aadhaar_card_image'] ? '' : 'd-none' }}"
                                                src="{{ getValidImage(path: 'storage/app/public/tour_and_travels/doc/' . $getData['aadhaar_card_image'], type: 'backend-product') }}"
                                                alt="">
                                        </div>
                                        <div
                                            class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                    <div>
                                        <label for="name"
                                            class="title-color text-capitalize font-weight-bold mb-0">{{ translate('Address_Proof') }}</label>
                                        <span
                                            class="badge badge-soft-info">{{ THEME_RATIO[theme_root_path()]['Product Image'] }}</span>
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                            title="{{ translate('add_your_service’s_thumbnail_in') }} JPG, PNG or JPEG {{ translate('format_within') }} 2MB">
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        <input type="file" name="address_proof_image"
                                            class="custom-upload-input-file action-upload-color-image" id=""
                                            data-imgpreview="pre_address_proof_img_viewer"
                                            accept=".jpg, .webp, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <span
                                            class="delete_file_input btn btn-outline-danger btn-sm square-btn d--none">
                                            <i class="tio-delete"></i>
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_address_proof_img_viewer"
                                                class="h-auto aspect-1 bg-white  {{ $getData['address_proof_image'] ? '' : 'd-none' }}"
                                                src="{{ getValidImage(path: 'storage/app/public/tour_and_travels/doc/' . $getData['address_proof_image'], type: 'backend-product') }}"
                                                alt="">
                                        </div>
                                        <div
                                            class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                    <div>
                                        <label for="name"
                                            class="title-color text-capitalize font-weight-bold mb-0">{{ translate('Company_image') }}</label>
                                        <span
                                            class="badge badge-soft-info">{{ THEME_RATIO[theme_root_path()]['Product Image'] }}</span>
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                            title="{{ translate('add_your_Company_thumbnail_in') }} JPG, PNG or JPEG {{ translate('format_within') }} 2MB">
                                            <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                                alt="">
                                        </span>
                                    </div>
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        <input type="file" name="image"
                                            class="custom-upload-input-file action-upload-color-image" id=""
                                            data-imgpreview="pre_Company_img_viewer"
                                            accept=".jpg, .webp, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <span
                                            class="delete_file_input btn btn-outline-danger btn-sm square-btn d--none">
                                            <i class="tio-delete"></i>
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_Company_img_viewer"
                                                class="h-auto aspect-1 bg-white  {{ $getData['image'] ? '' : 'd-none' }}"
                                                src="{{ getValidImage(path: 'storage/app/public/tour_and_travels/doc/' . $getData['image'], type: 'backend-product') }}"
                                                alt="">
                                        </div>
                                        <div
                                            class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
