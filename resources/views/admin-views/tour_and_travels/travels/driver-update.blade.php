...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.tour_and_travels.driver.driver-edit') }}" method="post" enctype="multipart/form-data" id="services_form">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input class="form-control form-control-user phone-input-with-country-picker  @error('phone') is-invalid @enderror onfillup" type="tel" id="exampleInputPhone" value="{{ old('phone',$getData['phone']) }}" placeholder="{{ translate('enter_phone_number') }}" required oninput="validatePhone(this)">
                                <div class="">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control " name="license_number" id="license_number_id" value="{{old('license_number',$getData['license_number'])}}" autocomplete="off" placeholder="{{ translate('enter_driving_license_number') }}" onkeyup="$('.license_verify_status_check').val(0);" required>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control " name="pan_number" id="pan_card" value="{{old('pan_number',$getData['pan_number']) }}" autocomplete="off" placeholder="Enter PanCard Number" onkeyup="validatePAN(this);$('.pancard_verify_status_check').val(0);">
