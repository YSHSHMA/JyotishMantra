            ...
            <div class="card-body">
               <form action="{{ route('admin.tour_type.store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="d-flex flex-wrap gap-2 justify-content-end">
                     @if (Helpers::modules_permission_check('Tour', 'Tour Category', 'add'))
                  ...
                  <table id="datatable"
                     ...
                     <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                           ...
                           @if (Helpers::modules_permission_check('Tour', 'Tour Category', 'status'))
                           <th>{{ translate('status') }}</th>
                           @endif
                           @if (Helpers::modules_permission_check('Tour', 'Tour Category', 'edit') || Helpers::modules_permission_check('Tour', 'Tour Category', 'delete'))
