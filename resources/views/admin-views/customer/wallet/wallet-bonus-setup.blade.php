...
@section('content')
    <div class="content container-fluid">
        ...
        @if (Helpers::modules_permission_check('Customers', 'Customer Wallet Bonus', 'add'))
        <div class="card">
            <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                    ...
                    <tr>
                        ...
                        @if (Helpers::modules_permission_check('Customers', 'Customer Wallet Bonus', 'status'))
                        <th>{{translate('status')}}</th>
                        @endif
                        @if (Helpers::modules_permission_check('Customers', 'Customer Wallet Bonus', 'edit') || Helpers::modules_permission_check('Customers', 'Customer Wallet Bonus', 'delete'))
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-10 justify-content-center">
                                    @if (Helpers::modules_permission_check('Customers', 'Customer Wallet Bonus', 'edit'))
                                    ...
                                    @endif
                                    @if (Helpers::modules_permission_check('Customers', 'Customer Wallet Bonus', 'delete'))
