                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                @if (Helpers::modules_permission_check('Vendor', 'Withdraw Method', 'active-status'))
                                <th class="text-center">{{translate('active_status')}}</th>
                                @endif
                                @if (Helpers::modules_permission_check('Vendor', 'Withdraw Method', 'default-method'))
                                <th class="text-center">{{translate('default_method')}}</th>
                                @endif
                                @if (Helpers::modules_permission_check('Vendor', 'Withdraw Method', 'edit') || Helpers::modules_permission_check('Vendor', 'Withdraw Method', 'delete'))
                            ...
                            @foreach($withdrawalMethods as $key => $withdrawalMethod)
                                <tr>
                                    ...
                                    @if (Helpers::modules_permission_check('Vendor', 'Withdraw Method', 'active-status'))
                                    <td>
                                        <form action="{{route('admin.sellers.withdraw-method.status-update')}}" method="post" id="withdrawal-method-status{{$withdrawalMethod['id']}}-form" data-from="withdraw-method-status">
                                            @csrf
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            @if (Helpers::modules_permission_check('Vendor', 'Withdraw Method', 'edit'))
                                            <a href="{{route('admin.sellers.withdraw-method.edit',[$withdrawalMethod->id])}}"
                                               class="btn btn-outline--primary btn-sm square-btn">
                                                <i class="tio-edit"></i>
                                            </a>
                                            @endif
                                            @if (Helpers::modules_permission_check('Vendor', 'Withdraw Method', 'delete'))
