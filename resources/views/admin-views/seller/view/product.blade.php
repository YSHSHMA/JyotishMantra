        ...
        <div class="page-header">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                <ul class="nav nav-tabs flex-wrap page-header-tabs">
                    @if (Helpers::modules_permission_check('Vendor', 'Vendor', 'overview-info'))
                    <li class="nav-item">
                        <a class="nav-link "
                            ...
                            <div class="table-responsive datatable-custom">
                                <table id="columnSearchDatatable"
                                    ...
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Vendor', 'Vendor', 'product-feature-status'))
                                        <th class="text-center">{{translate('featured')}}</th>
                                        @endif
                                        @if (Helpers::modules_permission_check('Vendor', 'Vendor', 'product-status'))
                                        <th class="text-center">{{translate('active_status')}}</th>
                                        @endif
                                        @if (Helpers::modules_permission_check('Vendor', 'Vendor', 'product-edit') || Helpers::modules_permission_check('Vendor', 'Vendor', 'delete'))
                                    ...
                                    @foreach($products as $k=>$product)
                                        <tr>
                                            ...
                                            @endif
                                            @if (Helpers::modules_permission_check('Vendor', 'Vendor', 'edit') || Helpers::modules_permission_check('Vendor', 'Vendor', 'delete'))
                                            <td>
                                                <div class="d-flex justify-content-center gap-10">
                                                    @if (Helpers::modules_permission_check('Vendor', 'Vendor', 'edit'))
                                                    <a class="btn btn-outline--primary btn-sm square-btn"
                                                       href="{{route('admin.products.update',[$product['id']])}}">
                                                        <i class="tio-edit"></i>
                                                    </a>
                                                    @endif
                                                    @if (Helpers::modules_permission_check('Vendor', 'Vendor', 'delete'))
