...
<div class="content container-fluid">
    ...
    <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
        <h2 class="h1 mb-0">
            <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/app.png') }}" class="mb-1 mr-1"
                alt="">
            {{ translate('update_valmiki_ramayan') }}
        </h2>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.valmikiramayan.update', [$valmikiramayan['id']]) }}"
                        ...
                        <ul class="nav nav-tabs w-fit-content mb-4">
                          ...
                          <div class="row mb-3">
                            <div class="col-md-8">
                                 @foreach ($language as $lang)
                                        <?php
                                        if (count($valmikiramayan['translations'])) {
                                            $translate = [];
                                            foreach ($valmikiramayan['translations'] as $translations) {
                                ...
                                <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                                    <div class="form-group">
                                        ...
                                        value="{{ $lang == $defaultLanguage ? $valmikiramayan['name'] : $translate[$lang]['name'] ?? '' }}"
