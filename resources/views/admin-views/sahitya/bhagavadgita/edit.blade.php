...
@section('title', translate('bhagavad_gita_Update'))
    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0 align-items-center d-flex gap-2">
                ...
                {{ translate('bhagavad_Gita_Update') }}
            </h2>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.bhagavadgita.update', [$bhagavadgita['id']]) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    @foreach($language as $lang)
                                            <?php
                                            if (count($bhagavadgita['translations'])) {
                                                $translate = [];
                                                foreach ($bhagavadgita['translations'] as $translations) {
                                        ...
                                        <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form"
                                            ...
                                            <input type="text" name="name[]"
                                                   value="{{$lang == $defaultLanguage ? $bhagavadgita['name']:($translate[$lang]['name']??'') }}"
                                    ...
                                    <div class="form-group">
                                        <label class="title-color" for="bhagavadgita">
                                            {{ translate('Image') }}
                                        </label>
