...
@section('title', 'PANDIT COUNSELLING ORDER | LIST')
@push('css_or_js')
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{ translate('pandit_counselling_Order_List') }}
        ...
        <div class="card mb-3 remove-card-shadow">
            <div class="card-body">
                <div class="row g-2" id="order_stats">
                    <div class="col-lg-12">
                        @php
                            $totalPaymentSuccess = \App\Models\Service_order::where('type', 'panditcounselling')
                                ->where('status', 0)
                                ->where('is_block', '!=', 9)
                                ->where('payment_status', 1)
                                ->sum('pay_amount');
                            $totalPaymentPending = \App\Models\Service_order::where('type', 'panditcounselling')
                                ->where('status', 0)
                                ->where('is_block', '!=', 9)
                                ->where('payment_status', 0)
                                ->sum('pay_amount');
                            $totalPaymentFaild = \App\Models\Service_order::where('type', 'panditcounselling')
                                ->where('status', 0)
                                ->where('is_block', '!=', 9)
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('admin.pandit.counselling.order.list', 'all') }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                        ...
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-info">
                                                    {{ \App\Models\Service_order::where('type', 'panditcounselling')->where('is_block', '!=', 9)->count() }}
                                                </h3>
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.pandit.counselling.order.list', 0) }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-primary">
                                                    {{ \App\Models\Service_order::where('type', 'panditcounselling')->where('is_block', '!=', 9)->where('status', 0)->count() }}
                                                </h3>
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.pandit.counselling.order.list', 1) }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-success">
                                                    {{ \App\Models\Service_order::where('type', 'panditcounselling')->where('is_block', '!=', 9)->where('status', 1)->count() }}
                                                </h3>
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.pandit.counselling.order.list', 2) }}" class="text-decoration-none">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            <div class="d-flex flex-column align-items-start">
                                                <h3 class="mb-1 fz-24 text-primary">
                                                    {{ \App\Models\Service_order::where('type', 'panditcounselling')->where('is_block', '!=', 9)->where('status', 2)->count() }}
                                                </h3>
                ...
                <div class="card mb-3">
                    <div class="px-3 py-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="mb-0">Filter the Pandit Counselling Service Orders</h4>
                        ...
                        <div class="row g-2 flex-grow-1">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <form method="GET" action="{{ url()->current() }}" id="filterForm" class="row mb-3">
                                    ...
                                    <div
                                        class="{{ str_contains(url()->current(), 'list/all') ? 'col-md-3' : 'col-md-4' }}">
                                        <label for="status" class="font-weight-bold">Pandit Counselling Status</label>
                                        @php
                                            $orderStatusOptions = [
                                                0 => 'Pending',
                                                // 4 => 'Live/Shared Video',
                        ...
                        <div class="row g-2 flex-grow-1">
                            <div class="col-md-12">
                                <div style="overflow: auto;">
                                    @include('admin-views.counselling.pandit.order.partial.payment')
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-2">
                                                            ...
                                                            <a class="btn btn-outline-primary btn-sm square-btn"
                                                                ...
                                                                href="{{ route('admin.pandit.counselling.order.details', [$order['id']]) }}">
                                                            ...
                                                            <a class="btn btn-outline-info btn-sm square-btn"
                                                                target="_blank"
                                                                href="{{ route('admin.pandit.counselling.order.generate.invoice', $order['id']) }}">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#customer_id').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route('admin.pandit.counselling.order.get-customer-orders') }}",
                    type: "GET",
                    data: {
            ...
            $('#blockOrdersBtn').click(function() {
                ...
                $.ajax({
                    url: "{{ route('admin.pandit.counselling.order.block-orders') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
