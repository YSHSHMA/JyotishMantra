...
@section('title', translate('pandit_Counselling_Lead_List'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{ translate('pandit_Counselling_Lead_List') }}
                            ...
                            <table
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        {{-- @if (Helpers::modules_permission_check('Consultation Order', 'Lead', 'delete') || Helpers::modules_permission_check('Consultation Order', 'Lead', 'follow-up') || Helpers::modules_permission_check('Consultation Order', 'Lead', 'follow-up-history') || Helpers::modules_permission_check('Consultation Order', 'Lead', 'call') || Helpers::modules_permission_check('Consultation Order', 'Lead', 'whatsapp') || Helpers::modules_permission_check('Consultation Order', 'Lead', 'template')) --}}
                                    ...
                                    @foreach ($leads as $key => $lead)
                                        <tr>
                                            ...
                                            {{-- @if (Helpers::modules_permission_check('Consultation Order', 'Lead', 'delete') ||
                                                    ...
                                                    Helpers::modules_permission_check('Consultation Order', 'Lead', 'whatsapp') ||
                                                    Helpers::modules_permission_check('Consultation Order', 'Lead', 'template')) --}}
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        ...
                                                        {{-- @if (Helpers::modules_permission_check('Consultation Order', 'Lead', 'delete')) --}}
                                                        <a href="{{ route('admin.pandit.counselling.order.lead-delete', ['id' => $lead['id']]) }}"
                                                    ...
                                                    <div class="d-flex justify-content-center gap-2 pt-2">
                                                        {{-- @if (Helpers::modules_permission_check('Consultation Order', 'Lead', 'whatsapp')) --}}
                                                        <a href="{{ route('admin.pandit.counselling.order.orders.send-whatsapp-leads', ['id' => $lead['id']]) }}"
                                                            class="btn btn-icon bg-label-success waves-effect waves-light myactionbtn"
                                                        ...
                                                        {{-- @endif --}}
                                                        {{-- @if (Helpers::modules_permission_check('Consultation Order', 'Lead', 'template')) --}}
                                                        <a href="{{ route('admin.whatsapp.counsltancy-template') }}"
                                                            ...
                                                            data-bs-original-title="customise message"><i
                                                                class="tio-message" title="customise message"></i>
                                                        </a>
                                                        {{-- @endif --}}
                                                    </div>
                                                    {{-- </div> --}}
    ...
    <div class="modal fade" id="followUpModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.pandit.counselling.order.lead-follow-up') }}" method="POST">
                    @csrf
                    @php
                        if (auth('admin')->check()) {
...
@push('script')
    ...
    <script>
        function followHistory(that) {
            ...
            var row = "";
            $.ajax({
                url: "{{ url('admin/pandit/counselling/order/get-follows-list') }}/" + leadId,
                method: 'GET',
                //   data:{id:leadId},
