        ...
        <div class="card-header flex-wrap gap-3">
            <div class="media d-flex gap-3">
                <img class="rounded-circle avatar"
                    src="{{ getValidImage(path: 'storage/app/public/seller/'.(isset($supportTicket['seller']['image'])?$supportTicket['seller']['image']:''), type: 'backend-basic') }}" alt="" />
                <div class="media-body">
                    <h6 class="font-size-md mb-1">{{isset($supportTicket['seller']['f_name'])?$supportTicket['seller']['f_name'].' '.($supportTicket['seller']['l_name']??''):translate('not_found')}}</h6>
        ...
        <div class="card-footer border-0">
            <div class="type_msg">
                <div class="input_msg_write">
                    <form class="needs-validation" href="{{route('vendor.support-ticket.vendor.replay',['id'=>$supportTicket['id']])}}" method="post" enctype="multipart/form-data">
                        @csrf
