...
@section('title', translate('prasaadam_information'))
@push('css_or_js')
            ...
            <div class="col-lg-6 d-flex flex-column gap-3">
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        <div class="media align-items-center gap-10">
                            <img class="avatar avatar-60 rounded"
                                src="{{ getValidImage(path: 'storage/app/public/product/thumbnail/' . $serviceDetails['products']['thumbnail'], type: 'backend-product') }}"
                                alt="{{ translate('image_Description') }}">
                            <div>
                                                ...
                                                <div class="">
                                                    @if (empty($prashad->awb))
                                                        <form id="delivery-form"
                                                            action="{{ route('vendor.orders.prashad.shipwaydelivery', $prashad['order_id']) }}"
                                                            method="post">
                                                            @csrf
                                                    ...
                                                    @else
                                                        <form id="delivery-cancel-form"
                                                            action="{{ route('vendor.orders.prashad.shipwayCancel', $prashad['order_id']) }}"
                                                            method="POST">
                                                            @csrf
