                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light thead-50 text-capitalize">
                            <tr>
                                ...
                                <th class="text-capitalize">{{ translate('same_day_delivery') }}</th>
                                @if ($status == 'all')
                            ...
                            @foreach ($orders as $key => $order)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($shop->city_name == $order['billing_address_data']->city)
                                            <h5 class="text-success">{{ translate('yes') }}</h5>
                                        @else
                                            <h5 class="text-danger">{{ translate('no') }}</h5>
                                        @endif
                                    </td>                                   
                                    @if ($status == 'all')
