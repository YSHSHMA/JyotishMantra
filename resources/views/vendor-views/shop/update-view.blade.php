                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <input type="number" class="form-control"  name="pincode" value="{{ $shop->pincode }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <input type="number" class="form-control"  name="fassai_no" value="{{ $shop->fassai_no}}">
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <div class="custom-file text-left">
                              <input type="file" name="fassai_image" id="fassai-upload" class="custom-file-input image-input"
                        ...
                        <div class="text-center">
                           <img class="upload-img-view" id="fassai-preview"
                              src="{{getValidImage(path: 'storage/app/public/shop/fassai/'.$shop->fassai_image, type: 'backend-fassai')}}"
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="custom-file text-left">
                              <input type="file" name="gumasta" id="gumasta-upload" class="custom-file-input image-input"
                        ...
                        <div class="text-center">
                           <img class="upload-img-view" id="gumasta-preview"
                              src="{{getValidImage(path: 'storage/app/public/shop/gumasta/'.$shop->gumasta, type: 'backend-gumasta')}}"
