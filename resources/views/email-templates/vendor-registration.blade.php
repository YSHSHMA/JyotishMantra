            ...
            <tr>
                <td class="main-table-td">
                    ...
                    <h2 id="mail-title" class="mt-2 text-center">{{ $data['title'] }}</h2>
                     <h3 class="mb-1" id="mail-body">{{ translate('Hi').' '.$data['f_name'] . ' ' . $data['l_name'].',' }}</h3>
                    <div class="mb-1">
                        <!-- {{ $data['message'] }} -->Congratulation!Your registration request has been send to admin
                        successfully!Please wait until admin reviewal.

                    </div>
                    @if ($data['status'] == 'pending')
                        <div class="mb-1">
                            {{ translate('meanwhile_click_here_to_visit_') . $companyName . translate('_website') }}.</div>
            ...
            <tr>
                <td>
                    ...
                    <span class="privacy">
                        ...
                        <a href="{{ route('contacts') }}" target="_blank" id="contact-check"><span
