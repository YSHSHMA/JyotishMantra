                    ...
                    <div class="col-md-3">
                        @php
                            $totalPaymentAmount = \App\Models\Chadhava_orders::where('type', 'chadhava')
                                ->where('status', 0)->where('pandit_assign',$vendor->id)
                            ...
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="text-info mb-1">
                                        {{ \App\Models\Chadhava_orders::where('type', 'chadhava')->where('order_status', 3)->where('pandit_assign',$vendor->id)->count() }}
                                    </h4>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 shadow-sm border-success border-1">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="text-success mb-1">
                                        {{ \App\Models\Chadhava_orders::where('type', 'chadhava')->where('order_status', 4)->where('pandit_assign',$vendor->id)->count() }}
                                    </h4>
                            ...
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="text-primary mb-1">
                                        {{ \App\Models\Chadhava_orders::where('type', 'chadhava')->where('order_status', 5)->where('pandit_assign',$vendor->id)->count() }}
                                    </h4>
