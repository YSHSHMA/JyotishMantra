...
<head>
    ...
    <title>{{ translate('Guruji_Login') }}</title>
                    ...
                    <div class="card card-lg mb-5">
                        <div class="card-body">
                            <form action="{{ route('vendor.auth.login') }}" method="post" id="vendor-login-form">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">
                                                {{ translate('welcome_back_to_guruji_login') }}</h1>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @if (in_array($host, ['mahakal.com', 'www.mahakal.com','http://localhost/maha_kal/mahakal']))
