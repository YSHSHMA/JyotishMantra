                                                                                        ...
                                                                                        <div class="col-sm-12 col-md-4">
                                                                                            <div
                                                                                                ...
                                                                                                <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn"
                                                                                                    ...
                                                                                                    data-action="{{ route('guruji.services.gallery.delete-gallery', ['id' => $gallery['id'], 'key' => $key]) }}">
                                                                                                    <i class="tio-delete"></i>
                                                                                                </a>
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <img id="additional_Image_{{ $unique_id }}"
                                                                                                        ...
                                                                                                        class="h-auto aspect-1 bg-white onerror-add-class-d-none"
                                                                                                        src="{{ getValidImage(
                                                                                                            path: 'storage/app/public/astrologers/gallery/' . $photo->image_name,
...
@push('script')
    ...
    <script>
        ...
        function filesManager(that) {
            ...
            $.ajax({
                url: '{{ route('guruji.services.gallery.add-gallery', [$vendor["id"]]) }}',
