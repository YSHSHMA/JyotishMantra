                        ...
                        <form action="{{route('vendor.auth.login')}}" method="post" id="vendor-login-form">
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4 d-none hidden_title show_title_event">{{translate('welcome_back_to_Event_login')}}</h1>
                                        <h1 class="h4 text-gray-900 mb-4 d-none hidden_title show_title_tour">{{translate('welcome_back_to_Tour_login')}}</h1>
                                        <h1 class="h4 text-gray-900 mb-4 d-none hidden_title show_title_trast">{{translate('welcome_back_to_Trast_login')}}</h1>
                                    </div>
                                </div>
                            </div>
