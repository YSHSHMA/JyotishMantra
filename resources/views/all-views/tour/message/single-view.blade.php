        ...
        <div class="card-header flex-wrap gap-3">
            <div class="media d-flex gap-3">
                <img class="rounded-circle avatar"
                    src="{{ getValidImage(path: 'storage/app/public/tour_and_travels/doc/'.(isset($supportTicket['Tour']['image'])?$supportTicket['Tour']['image']:''), type: 'backend-basic') }}" alt="" />
        ...
        <div class="card-footer border-0">
            <div class="type_msg">
                <div class="input_msg_write">
                    <form class="needs-validation" href="{{route('tour-vendor.messages.replay',['id'=>$supportTicket['id']])}}" method="post" enctype="multipart/form-data">
                        @csrf
