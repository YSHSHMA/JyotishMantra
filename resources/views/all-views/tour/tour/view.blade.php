        ...
        <div class="col-lg-12">
            ...
            <div class="step active" id="step1">
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="button" class="btn btn-primary btn-action" id="nextToStep2">Next <i class="fas fa-arrow-right ms-2"></i></button>
                </div>
            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group  {{((old('use_date',$getData['use_date']) == 0)?'d-none':'' )}} {{((old('use_date',$getData['use_date']) == 2)?'d-none':'' )}}  {{((old('use_date',$getData['use_date']) == 4)?'d-none':'' )}}  {{((old('use_date',$getData['use_date']) == 3)?'d-none':'' )}} use_interested_and_not daily_tour_full_comman">
                                    ...
                                    <input type="text" class="form-control all_select_data start_date_end_date" data-point='8' value="{{ old('startandend_date',($getData['startandend_date']??''))}}" name='startandend_date' placeholder="{{ translate('enter_start_to_end_date') }}" disabled>
                                </div>
                                <div class="col-md-3 form-group  {{((old('use_date',$getData['use_date']) == 0)?'d-none':'' )}} {{((old('use_date',$getData['use_date']) == 2)?'d-none':'' )}}  {{((old('use_date',$getData['use_date']) == 4)?'d-none':'' )}}  {{((old('use_date',$getData['use_date']) == 3)?'d-none':'' )}} use_interested_and_not daily_tour_full_comman">
                                ...
                                <div class="col-md-12">
                                    <div class="card mt-1 rest-part">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div id="pdfPreviewContainer" class="mt-3" style="{{ (($getData['itineraryupload']??'')? '' : 'display:none;')}}">
