...
<script>
    ...
    function saveStepData(step) {
        ...
        fetch("{{ route('tour-vendor.tour_visits.tour-edit') }}", {
                method: 'POST',
                body: formData,
                headers: {
    ...
    function add_new_package_html() {
        ...
        <div class="row mt-2">
            ...
            <div class="col-1 p-0 pr-1">
                    ...
                    <div class="col-4 p-0 pr-1">
                <input type='text' class="form-control   point_trigger49${totalRows}" readonly name="pprice[${totalRows}]" value="" onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );select_value(this)" data-point='point_trigger49${totalRows}' placeholder="{{ translate('enter_Price') }}">
            </div>
            <div class="col-1 p-0">
                <a class='btn btn-danger btn-sm p-1 mt-2' onclick="remove_html(this)"><i class='tio-remove'></i></a>
            </div>
