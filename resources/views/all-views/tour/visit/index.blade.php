...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('tour-vendor.tour_visits.visit_place_store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <table id="datatable"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-soft-{{ $items['status'] == 1 ? 'success' : 'danger' }}">{{ $items['status'] == 1 ? 'Active' : 'In-Active' }}</span> </td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a class="btn btn-outline-info btn-sm square-btn" title="{{ translate('edit') }}" href="{{route('tour-vendor.tour_visits.tour-visit-update',[$items['id']])}}">
                                                <i class="tio-edit"></i>
                                            </a>
...
<span id="route-admin-tour_package-delete" data-url="{{ route('tour-vendor.tour_visits.delete-place') }}"></span>
