...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('tour-vendor.self-driving.self-driving-store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <!-- Language tabs -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 d-none">
                                            ...
                                            <select name="traveller_id" class="form-control traveller_ids" onchange="$('.traveller_ids').val(this.value)" required>
                                                @if($travelar_list)
                                                <option value="{{ $travelar_list['id'] }}" selected>{{ $travelar_list['company_name'] }}</option>
                                                @endif
                                            </select>
                                        </div>
                                        <div class="col-md-4">
