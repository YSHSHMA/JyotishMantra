...
<div class="content container-fluid">
    ...
    <form class="product-form text-start" action="{{ route('tour-vendor.lead.tour-lead-save') }}" method="POST" enctype="multipart/form-data" id="services_form">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="">
        ...
        <div class="row justify-content-end gap-3 mt-3 mx-1">
            @if (Helpers::Employee_modules_permission('Tour', 'Tour Lead', 'add'))
