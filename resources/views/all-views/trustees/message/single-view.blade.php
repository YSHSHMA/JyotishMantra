        ...
        <div class="card-header flex-wrap gap-3">
            <div class="media d-flex gap-3">
                <img class="rounded-circle avatar"
                    src="{{ getValidImage(path: 'storage/app/public/donate/trust/'.(isset($supportTicket['Trust']['theme_image'])?$supportTicket['Trust']['theme_image']:''), type: 'backend-basic') }}" alt="" />
                <div class="media-body">
                    <h6 class="font-size-md mb-1">{{isset($supportTicket['Trust']['name'])?$supportTicket['Trust']['name']:translate('not_found')}}</h6>
                    <div class="fz-12">{{isset($supportTicket['Trust']['trust_email'])?$supportTicket['Trust']['trust_email']:''}}</div>
                </div>
            </div>
        ...
        <div class="card-footer border-0">
            <div class="type_msg">
                <div class="input_msg_write">
                    <form class="needs-validation" href="{{route('trustees-vendor.messages.replay',['id'=>$supportTicket['id']])}}" method="post" enctype="multipart/form-data">
                        @csrf
