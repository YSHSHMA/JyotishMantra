                                        ...
                                        <div class="col-md-12 mt-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="set_requirement_amount" class="form-control set_requirement_amount_class" autocomplete="off" value="{{ old('set_requirement_amount')}}" onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );$('.set_requirement_amount_class').val(this.value)">
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="title-color" for="details">{{ translate('Enter Date Rang') }}</label>
                                                    <input type="text" name="set_requirement_date_range" class="form-control dateRangePicker" autocomplete="off" value="{{ old('set_requirement_date_range')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-4">
