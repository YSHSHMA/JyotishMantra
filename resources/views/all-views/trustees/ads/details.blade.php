                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <a href="{{ route('all-donate_trust',['slug'=>$old_data['slug']])}}" class="btn btn-outline--primary px-4 mt-4 font-weight-bolder" target="_blank"><i class="tio-globe"></i>
                                                    View live
                                                </a>
                                                @elseif(\App\Models\DonateAllTransaction::where('type','ad_approval')->where('amount_status',0)->where('ads_id',$old_data['id'])->exists())
                                                <a href="{{ (\App\Models\DonateAllTransaction::where('type','ad_approval')->where('amount_status',0)->where('ads_id',$old_data['id'])->first()['transction_link']??'') }}" class="btn btn-outline--primary px-4 mt-4 font-weight-bolder" target="_blank"><i class="tio-globe"></i>
                                                    Pay Now
                                                </a>
                                                @endif
                                            </div>
