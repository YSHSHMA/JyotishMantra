                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @php
                                            $services = is_string($items['selected_services']) ? json_decode($items['selected_services']??"[]", true) : $items['selected_services'];

                                            $purohitName = isset($purohitsList[$items['purohit_id']]) ? $purohitsList[$items['purohit_id']]->name : 'N/A';
                                        @endphp
                                        <span>Services: {{ implode(', ', ($services ?? [])) }}</span><br>
                                        <span>Temple Name: {{ ucwords((\App\Models\Temple::where('id',$items['temple_id'])->first()['name']??"")) }}</span><br>
                                        <span>Purohit Name: {{ $purohitName }}</span>
                                    </td>
                                    @if (Helpers::Employee_modules_permission('Employee', 'Employee List', 'Status'))
                                    <td>
