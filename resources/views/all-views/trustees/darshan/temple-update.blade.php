...
<div class="content container-fluid">
    ...
    <form class="product-form text-start" action="{{ route('trustees-vendor.vip-darshan.temple-update', $temple['id']) }}" method="post" enctype="multipart/form-data" id="product_form">
        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-multiple js-states js-example-responsive form-control state_select_geolocation action-get-request-onchange " name="state_id" data-option="{{ $temple['state_id'] }}" data-url-prefix="{{ url('/trustees-vendor/vip-darshan/get-cities?id=') }}" data-element-id="sub-cities-select" data-element-type="select">
...
<script>
    ...
    $(document).ready(function() {
        setTimeout(function() {
            ...
            // getRequestFunctionality('{{ route("trustees-vendor.vip-darshan.get-cities") }}?id=' + states + '&cities=' + cities, 'sub-cities-select', 'select');
        }, 100)
    });
</script>
...
<script>
    ...
    function getRequestFunctionality1(id, cities_option = null) {
        $.get({
            url: "<?php echo url('trustees-vendor/vip-darshan/get-cities?id=') ?>" + id,
            dataType: 'json',
            beforeSend: function() {
                $('#loading').fadeIn();
            },
