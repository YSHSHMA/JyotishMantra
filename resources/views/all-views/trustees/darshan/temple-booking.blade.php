                        ...
                        <table
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    @if (Helpers::Employee_modules_permission('VIP Darshan Management', 'Temple Booking', 'price'))
                                    <th>{{ translate('Price') }}</th>
                                    @endif
                                    @if (Helpers::Employee_modules_permission('VIP Darshan Management', 'Temple Booking', 'gst'))
                                    <th>{{ translate('gst') }}</th>
                                    @endif
                                    @if (Helpers::Employee_modules_permission('VIP Darshan Management', 'Temple Booking', 'admin commission'))
                                    <th>{{ translate('admin_commission') }}</th>
                                    @endif
                                    @if (Helpers::Employee_modules_permission('VIP Darshan Management', 'Temple Booking', 'final amount'))
                                    <th>{{ translate('final_amount') }}</th>
                                    @endif
                                    @if (Helpers::Employee_modules_permission('VIP Darshan Management', 'Temple Booking', 'details'))
