...
<div class="content container-fluid">
    ...
    <div class="card card-chat justify-content-between">
        <div class="card-header flex-wrap gap-3">
            <div class="media d-flex gap-3">
                <img class="rounded-circle avatar"
                    src="{{ getValidImage(path: 'storage/app/public/event/organizer/'.(isset($supportTicket['Event']['image'])?$supportTicket['Event']['image']:''), type: 'backend-basic') }}" alt="" />
                <div class="media-body">
                    <h6 class="font-size-md mb-1">{{isset($supportTicket['Event']['organizer_name'])?$supportTicket['Event']['organizer_name']:translate('not_found')}}</h6>
                    <div class="fz-12">{{isset($supportTicket['Event']['contact_number'])?$supportTicket['Event']['contact_number']:''}}</div>
                </div>
            </div>
        ...
        @if($supportTicket['status'] == 'open')
         @if (Helpers::Employee_modules_permission('Support Management', 'From Admin', 'Chat') || Helpers::Employee_modules_permission('Support Management', 'From Vendor', 'Chat'))
        <div class="card-footer border-0">
            <div class="type_msg">
                <div class="input_msg_write">
                    <form class="needs-validation" href="{{route('event-vendor.messages.replay',['id'=>$supportTicket['id']])}}" method="post" enctype="multipart/form-data">
                        @csrf
