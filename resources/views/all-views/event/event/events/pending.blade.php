...
@section('title', translate('pending_List'))
        ...
        <div class="col-md-12 mb-2">
            <div class='row'>
                <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('event-vendor.event-management.event-pending')}}">
                ...
                <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('event-vendor.event-management.event-pending',['status_and_isactive'=>1,'is_approve'=>1])}}">
                        <div class="order-stats__content">
                            <i class="tio-all_done">all_done</i>
                        ...
                        <span class="order-stats__title">
                            @php
                            echo \App\Models\Events::where('event_organizer_id',$relationEmployees)->where('status',0)->where('is_approve',1)->count();
                            @endphp
                        </span>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 col-md-3 mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('event-vendor.event-management.event-pending',['status_and_isactive'=>1,'is_approve'=>0])}}">
                        <div class="order-stats__content">
                            <i class="tio-all_done">all_done</i>
                ...
                <div class="col-sm-6 col-lg-3 col-md-3 mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('event-vendor.event-management.event-pending',['status_and_isactive'=>1,'is_approve'=>2])}}">
                        <div class="order-stats__content">
                            <i class="tio-all_done">all_done</i>
                        ...
                        <span class="order-stats__title">
                            @php
                            echo \App\Models\Events::where('event_organizer_id',$relationEmployees)->where('is_approve',2)->count();
                            @endphp
                        </span>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 col-md-3 mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('event-vendor.event-management.event-pending',['status_and_isactive'=>1,'is_approve'=>4])}}">
                        <div class="order-stats__content">
                            <i class="tio-all_done">all_done</i>
                        ...
                        <span class="order-stats__title">
                            @php
                            echo \App\Models\Events::where('event_organizer_id',$relationEmployees)->where('is_approve',4)->count();
                            @endphp
                        </span>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 col-md-3 mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('event-vendor.event-management.event-pending',['status_and_isactive'=>1,'is_approve'=>3])}}">
                        <div class="order-stats__content">
                            <i class="tio-all_done">all_done</i>
                        ...
                        <span class="order-stats__title">
                            @php
                            echo \App\Models\Events::where('event_organizer_id',$relationEmployees)->where('is_approve',3)->count();
                            @endphp
                        </span>
                    </a>
                </div>
                        ...
                        <table id="datatable" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100">
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    @if (Helpers::Employee_modules_permission('Event Management', 'Pending List', 'Edit'))
