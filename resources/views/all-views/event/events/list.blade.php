                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a class="btn btn-outline-{{ (($items['layout_auditorium'])?'info':'danger')}} btn-sm square-btn" title="{{ translate('add-auditorium') }}" href="{{route('event-vendor.event-management.add-auditorium',[$items['id']])}}">
                                                <i class="tio-add"></i>
                                            </a>
