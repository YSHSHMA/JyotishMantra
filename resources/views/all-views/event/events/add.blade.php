                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select name="sponsor_id[]" class="form-control prefileddata" data-point="15" multiple>
                                                ...
                                                <option value="{{ $va['id'] }}">{{ $va['company_name'] }} - ({{ $va['type'] }})</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class='col-md-4 form-group p-0 mt-2'>
                                                    ...
                                                    <input type="checkbox" name="required_aadhar_status" value="1" {{ old('required_aadhar_status') == "1" ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='col-md-4 form-group'>
...
<script>
    $(document).ready(function() {
        $('.prefileddata[data-point="15"]').on('change', function() {
            var selectedValues = $(this).val(); // array of selected values

            // update all other selects with the same data-point
