                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label class="title-color font-weight-bold" for="Language">{{ translate('select_Event_Sponsor') }}</label>
                                            <?php $getselect = old('sponsor_id', $getData['sponsor_id'] ?? []); ?>
                                            <?php $getselect = is_array($getselect) ? $getselect : [];
                                            ?>
                                            <select name="sponsor_id[]" class="form-control prefileddata" data-point='15' multiple>
                                                <option value="">{{ translate('Select_Event_Sponsor') }}</option>
                                                @if($sponsorlist)
                                                @foreach($sponsorlist as $va)
                                                <option value="{{ $va['id'] }}" {{ in_array($va['id'], $getselect) ? 'selected' : '' }}>{{ $va['company_name'] }} - ({{ $va['type'] }})</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class='col-md-4 form-group p-0 mt-2'>
                                                    <label class="title-color font-weight-bold h3 mt-3" for="Language">Event Required Aadhar-card</label>
                                                    <input type="checkbox" name="required_aadhar_status" value="1" {{ old('required_aadhar_status',$getData['required_aadhar_status'] ) == "1" ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='col-md-4 form-group'>
...
<script>
    $(document).ready(function() {
        $('.prefileddata[data-point="15"]').on('change', function() {
            var selectedValues = $(this).val();
            $('.prefileddata[data-point="15"]').not(this).each(function() {
