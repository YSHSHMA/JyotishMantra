        ...
        <div class="col-md-12 mb-2">
            <div class='row'>
                <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('event-vendor.event-management.event-cancel')}}">
                        ...
                        <span class="order-stats__title">
                            @php
                            if(auth('event')->check()){
                                echo \App\Models\Events::where('event_organizer_id',auth('event')->user()->relation_id)->where('status',2)->count();
                            }else if(auth('event_employee')->check()){
                                echo \App\Models\Events::where('event_organizer_id',auth('event_employee')->user()->relation_id)->where('status',2)->count();
                            }
                            @endphp
                        </span>
                    </a>
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th>{{ translate('Verification_status') }}</th>
                                     @if(Helpers::Employee_modules_permission('Event Management', 'Cancel List', 'Edit'))
