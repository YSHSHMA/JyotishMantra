        ...
        <div class="col-md-12 mb-2">
            <div class='row'>
                <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('event-vendor.event-management.event-running')}}">
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th>{{ translate('Verification_status') }}</th>
                                     @if (Helpers::Employee_modules_permission('Event Management', 'Running List', 'Edit'))
