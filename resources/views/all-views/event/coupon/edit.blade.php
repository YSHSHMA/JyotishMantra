...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('event-vendor.coupon.update-coupon',['id'=>$coupon['id']])}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-lg-4 form-group d-none">
                                ...
                                <select class="form-control" id="coupon_type" name="coupon_type">
                                    <option value="event_order" {{$coupon['coupon_type']=='event_order'?'selected':''}}>{{translate('event_order')}}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 form-group d-none">
                                ...
                                <input type="number" name="limit" min="0" value="{{ $coupon['limit']??1 }}" id="coupon_limit" class="form-control"  placeholder="{{translate('ex')}}: {{translate('10')}}">
                            </div>
