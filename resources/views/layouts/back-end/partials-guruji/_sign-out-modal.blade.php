            ...
            <div class="modal-body px-4 px-sm-5 pt-0 pb-sm-5">
                <div class="d-flex flex-column align-items-center text-center gap-2 mb-2">
                    <div class="toggle-modal-img-box d-flex flex-column justify-content-center align-items-center mb-3 position-relative">
                        <img src="{{dynamicAsset('public/assets/back-end/img/sign-out.png')}}" class="status-icon"  alt="" width="90"/>
                    </div>
                    <h5 class="modal-title mb-2">{{translate('do_you_want_to_sign_out').'?'}} </h5>
                </div>
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('vendor.auth.guruji.logout') }}" class="btn btn--primary min-w-120">{{translate('ok')}}</a>
