                    ...
                    <a class="navbar-brand" href="{{ route('vendor.dashboard.index') }}" aria-label="Front">
                        @if (isset($shop))
                            <img class="navbar-brand-logo-mini for-seller-logo"
                                src="{{ getValidImage(path: 'storage/app/public/shop/' . $shop->image, type: 'backend-logo') }}"
                                alt="{{ translate('logo') }}">
                        @else
                            <img class="navbar-brand-logo-mini for-seller-logo"
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('vendor/orders*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('vendor/orders/' . OrderEnum::LIST[URI] . '/pickup') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('vendor.orders.list', ['pickup']) }}"
                                        title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{ translate('pickup') }}
                                            <span
                                                ...
                                                {{ Order::where(['seller_is' => 'seller'])->where(['seller_id' => $sellerId])->where(['order_status' => 'pickup'])->count() }}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                        ...
                        @if ($seller['id'] == '14')
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('vendor/orders/prashad*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                    <i class="tio-shopping-cart nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('Prasaad_order') }}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('vendor/order*') ? 'block' : 'none' }}">
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/prashad/list') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('vendor.orders.prashad.list', ['all']) }}" title="">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link"
                                            href="{{ route('vendor.orders.prashad.list', 'confirmed') }}"
                                            title="{{ translate('confirmed') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ translate('confirmed') }}
                                                <span class="badge badge-soft-success badge-pill ml-1">
                                                    {{ \App\Models\Prashad_deliverys::where('pooja_status', '1')->where('order_status', 'confirmed')->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/prashad/order/list') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('vendor.orders.prashad.list', 'processing') }}"
                                            title="">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate text-capitalize">
                                                ...
                                                <span
                                                    class="badge badge-soft-warning badge-pill {{ Session::get('direction') === 'rtl' ? 'mr-1' : 'ml-1' }}">
                                                    {{ \App\Models\Prashad_deliverys::where('pooja_status', '1')->where(['order_status' => 'processing'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/prashad/order/list') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('vendor.orders.prashad.list', 'out_for_pickup') }}"
                                            title="">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate text-capitalize">
                                                ...
                                                <span
                                                    class="badge badge-soft-warning badge-pill {{ Session::get('direction') === 'rtl' ? 'mr-1' : 'ml-1' }}">
                                                    {{ \App\Models\Prashad_deliverys::where('pooja_status', '1')->where(['order_status' => 'out_for_pickup'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/prashad/order/list') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('vendor.orders.prashad.list', 'delivered') }}"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/prashad/order/list') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('vendor.orders.prashad.list', 'canceled') }}"
                                    ...
                                    <li class="nav-item {{ Request::is('admin/prashad/orderbyprashad*') ? 'active' : '' }}"
                                        ...
                                        <a class="nav-link "
                                            href="{{ route('vendor.orders.prashad.orderbyprashad') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('order_by_prashad') }}
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('vendor/refund/' . Refund::INDEX[URI] . '/received') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('vendor.refund.index', ['received']) }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{ translate('received') }}
                                            <span class="badge badge-soft-success badge-pill ml-1">
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('vendor/products/' . Product::ADD[URI]) ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('vendor/support-ticket*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('support_Ticket') }}">
                                <i class="tio-chat nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('support_Ticket') }}
                                    @if (\App\Models\VendorSupportTicketConv::where('type', 'seller')->whereIn('created_by', ['vendor', 'admin'])->where('vendor_id', auth('seller')->id())->where('status', 'open')->count() > 0)
                                        <span
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('vendor/support-ticket/vendor*') || Request::is('vendor/support-ticket/admin*') ? 'block' : 'none' }}">
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('vendor/support-ticket/vendor*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('vendor.support-ticket.vendor.index') }}">
                                        <i class="tio-support nav-icon"></i>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ translate('from_vendor') }}
                                            @if (\App\Models\VendorSupportTicketConv::where('type', 'seller')->where('created_by', 'vendor')->where('vendor_id', auth('seller')->id())->where('status', 'open')->count() > 0)
                                                <span
                                                    class="btn-status btn-xs-status btn-status-danger position-absolute top-0 menu-status"></span>
                                            @endif
                                        </span>
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('vendor/support-ticket/admin*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('vendor.support-ticket.admin.index') }}">
                                        <i class="tio-support nav-icon"></i>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ translate('from_admin') }}
                                            @if (\App\Models\VendorSupportTicketConv::where('type', 'seller')->where('created_by', 'admin')->where('vendor_id', auth('seller')->id())->where('status', 'open')->count() > 0)
                                                <span
                                                    class="btn-status btn-xs-status btn-status-danger position-absolute top-0 menu-status"></span>
                                            @endif
                                        </span>
